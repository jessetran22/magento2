...
/**
 * @Title("https://studio.cucumber.io/projects/131313/test-plan/folders/1054245/scenarios/4653671: View image details")
 * @TestCaseId("https://studio.cucumber.io/projects/131313/test-plan/folders/1054245/scenarios/4653671")
 * @Description("User views basic image attributes in Media Gallery<h3>Test files</h3>app/code/Magento/MediaGalleryUi/Test/Mftf/Test/AdminMediaGalleryViewDetailsTest.xml<br>")
 * @group media_gallery_ui
 */
class AdminMediaGalleryViewDetailsTestCest
{
    /**
	...
	public function _after(AcceptanceTester $I)
	{
		...
		$I->waitForElementVisible("//div[contains(@class, 'media-directory-container')]//ul//li//a[normalize-space(text())='assetFolder']", 30); // stepKey: waitBeforeClickOnFolderSelectFolder
		$I->click("//div[contains(@class, 'media-directory-container')]//ul//li//a[normalize-space(text())='assetFolder']"); // stepKey: selectFolderSelectFolder
		...
		$I->dontSeeElement("//div[contains(@class, 'media-directory-container')]//ul//li//a[normalize-space(text())='assetFolder']"); // stepKey: folderDoesNotExistAssertFolderWasDeleted
	 ...
	 * @throws \Exception
	 */
	public function AdminMediaGalleryViewDetailsTest(AcceptanceTester $I)
	{
		$I->comment("Entering Action Group [resetAdminDataGridToDefaultView] ResetAdminDataGridToDefaultViewActionGroup");
		$I->waitForElementVisible("div.admin__data-grid-action-bookmarks button[data-bind='toggleCollapsible']", 30); // stepKey: waitForViewBookmarksResetAdminDataGridToDefaultView
		$I->waitForPageLoad(30); // stepKey: waitForViewBookmarksResetAdminDataGridToDefaultViewWaitForPageLoad
		...
		$I->fillField("[name=folder_name]", "assetFolder"); // stepKey: setFolderNameCreateNewFolder
		...
		$I->waitForElementVisible("//div[contains(@class, 'media-directory-container')]//ul//li//a[normalize-space(text())='assetFolder']", 30); // stepKey: waitForFolderAssertNewFolderCreated
