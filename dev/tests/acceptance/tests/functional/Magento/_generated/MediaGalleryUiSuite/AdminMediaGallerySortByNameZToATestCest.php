...
/**
 * @Title("https://github.com/magento/adobe-stock-integration/issues/1776: User uses Sort by Name Z to A in Standalone Media Gallery")
 * @TestCaseId("https://github.com/magento/adobe-stock-integration/issues/1776")
 * @Description("User uses Sort by Name Z to A in Standalone Media Gallery<h3>Test files</h3>app/code/Magento/MediaGalleryUi/Test/Mftf/Test/AdminMediaGallerySortByNameZToATest.xml<br>")
 * @group media_gallery_ui
 */
class AdminMediaGallerySortByNameZToATestCest
{
    /**
	 ...
	 * @Stories({"User uses Sort by Name Z to A in Standalone Media Gallery"})
	 ...
	 * @throws \Exception
	 */
	public function AdminMediaGallerySortByNameZToATest(AcceptanceTester $I)
	{
		$I->comment("Entering Action Group [openStandaloneMediaGalleryPage] AdminOpenStandaloneMediaGalleryActionGroup");
		$I->amOnPage((getenv("MAGENTO_BACKEND_BASE_URL") ? rtrim(getenv("MAGENTO_BACKEND_BASE_URL"), "/") : "") . "/" . getenv("MAGENTO_BACKEND_NAME") . "/media_gallery/media"); // stepKey: amOnStandaloneMediaGalleryPageOpenStandaloneMediaGalleryPage
		$I->waitForPageLoad(30); // stepKey: waitForPageLoadOpenStandaloneMediaGalleryPage
		...
		$I->comment("Entering Action Group [sortByNameZToA] AdminEnhancedMediaGalleryClickSortActionGroup");
		$I->click("div[class='masonry-image-sortby'] select"); // stepKey: clickOnSortDropdownSortByNameZToA
		$I->click("//div[@class='masonry-image-sortby'] //option[@value='name_za']"); // stepKey: clickOnSortOptionSortByNameZToA
		$I->waitForPageLoad(30); // stepKey: waitForLoadSortByNameZToA
		$I->comment("Exiting Action Group [sortByNameZToA] AdminEnhancedMediaGalleryClickSortActionGroup");
		$I->comment("Entering Action Group [assertImagePositionAfterSortByNameZToA] AssertAdminEnhancedMediaGallerySortByActionGroup");
		$getFirstImageSrcAfterSortAssertImagePositionAfterSortByNameZToA = $I->grabAttributeFrom("div[class='masonry-image-column'][data-repeat-index='0'] img", "src"); // stepKey: getFirstImageSrcAfterSortAssertImagePositionAfterSortByNameZToA
		$getSecondImageSrcAfterSortAssertImagePositionAfterSortByNameZToA = $I->grabAttributeFrom("div[class='masonry-image-column'][data-repeat-index='1'] img", "src"); // stepKey: getSecondImageSrcAfterSortAssertImagePositionAfterSortByNameZToA
		$getThirdImageSrcAfterSortAssertImagePositionAfterSortByNameZToA = $I->grabAttributeFrom("div[class='masonry-image-column'][data-repeat-index='2'] img", "src"); // stepKey: getThirdImageSrcAfterSortAssertImagePositionAfterSortByNameZToA
		$I->assertStringContainsString("magento3.jpg", $getFirstImageSrcAfterSortAssertImagePositionAfterSortByNameZToA); // stepKey: assertFirstImagePositionAfterSortAssertImagePositionAfterSortByNameZToA
		$I->assertStringContainsString("magento2.jpg", $getSecondImageSrcAfterSortAssertImagePositionAfterSortByNameZToA); // stepKey: assertSecondImagePositionAfterSortAssertImagePositionAfterSortByNameZToA
		$I->assertStringContainsString("magento.jpg", $getThirdImageSrcAfterSortAssertImagePositionAfterSortByNameZToA); // stepKey: assertThirdImagePositionAfterSortAssertImagePositionAfterSortByNameZToA
		$I->comment("Exiting Action Group [assertImagePositionAfterSortByNameZToA] AssertAdminEnhancedMediaGallerySortByActionGroup");
	}
}
