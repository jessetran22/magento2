...
/**
 * @Title("https://studio.cucumber.io/projects/131313/test-plan/folders/1320712/scenarios/3961351: Editing an image from standalone view details panel")
 * @TestCaseId("https://studio.cucumber.io/projects/131313/test-plan/folders/1320712/scenarios/3961351")
 * @Description("Editing an image from standalone view details panel<h3>Test files</h3>app/code/Magento/MediaGalleryUi/Test/Mftf/Test/AdminStandaloneMediaGalleryViewDetailsEditTest.xml<br>")
 * @group media_gallery_ui
 */
class AdminStandaloneMediaGalleryViewDetailsEditTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminStandaloneMediaGalleryViewDetailsEditTest(AcceptanceTester $I)
	{
		...
		$I->comment("Entering Action Group [verifyMetadataKeywords] AdminEnhancedMediaGalleryVerifyImageKeywordsActionGroup");
		$grabKeywordsVerifyMetadataKeywords = $I->grabTextFrom("//div[@class='tags-list']"); // stepKey: grabKeywordsVerifyMetadataKeywords
		$I->assertStringContainsString("magento, mediagallerymetadata", $grabKeywordsVerifyMetadataKeywords); // stepKey: verifyKeywordsVerifyMetadataKeywords
		$I->comment("Exiting Action Group [verifyMetadataKeywords] AdminEnhancedMediaGalleryVerifyImageKeywordsActionGroup");
	}
}
