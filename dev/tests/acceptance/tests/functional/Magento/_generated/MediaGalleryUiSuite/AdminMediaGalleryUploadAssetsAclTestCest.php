...
/**
 * @Title("https://app.hiptest.com/projects/131313/test-plan/folders/943908/scenarios/3218882: User manages ACL rules for Media Gallery upload assets functionality")
 * @Description("User manages ACL rules for Media Gallery upload assets functionality<h3>Test files</h3>app/code/Magento/MediaGalleryUi/Test/Mftf/Test/AdminMediaGalleryUploadAssetsAclTest.xml<br>")
 * @TestCaseId("https://app.hiptest.com/projects/131313/test-plan/folders/943908/scenarios/3218882")
 * @group media_gallery_ui
 */
class AdminMediaGalleryUploadAssetsAclTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminMediaGalleryUploadAssetsAclTest(AcceptanceTester $I)
	{
		...
		$I->comment("Entering Action Group [AddMediaGalleryUnchekDeleteAssets] AdminAddRestrictedRoleActionGroup");
		$I->selectOption("#all", "0"); // stepKey: selectResourceAccessCustomAddMediaGalleryUnchekDeleteAssets
		$I->scrollTo("//*[text()='Upload assets']//*[@class='jstree-checkbox']", 0, -100); // stepKey: scrollToResourceElementAddMediaGalleryUnchekDeleteAssets
		$I->waitForElementVisible("//*[text()='Upload assets']//*[@class='jstree-checkbox']", 30); // stepKey: waitForElementVisibleAddMediaGalleryUnchekDeleteAssets
		$I->click("//*[text()='Upload assets']//*[@class='jstree-checkbox']"); // stepKey: clickContentBlockCheckboxAddMediaGalleryUnchekDeleteAssets
		$I->comment("Exiting Action Group [AddMediaGalleryUnchekDeleteAssets] AdminAddRestrictedRoleActionGroup");
		...
		$I->assertEquals(["Upload Image"], $verifyDisabledAttributeAssertCreateButtonEnabledAllOthersDisabled); // stepKey: assertSelectedCategoriesAssertCreateButtonEnabledAllOthersDisabled
