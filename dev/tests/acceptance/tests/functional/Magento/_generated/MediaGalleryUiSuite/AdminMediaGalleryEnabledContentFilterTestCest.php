...
/**
 * @Title("https://studio.cucumber.io/projects/131313/test-plan/folders/1320712/scenarios/4970565: User filter asset by enabled content")
 * @TestCaseId("https://studio.cucumber.io/projects/131313/test-plan/folders/1320712/scenarios/4970565")
 * @Description("User filter asset by enabled content<h3>Test files</h3>app/code/Magento/MediaGalleryUi/Test/Mftf/Test/AdminMediaGalleryEnabledContentFilterTest.xml<br>")
 * @group media_gallery_ui
 */
class AdminMediaGalleryEnabledContentFilterTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminMediaGalleryEnabledContentFilterTest(AcceptanceTester $I)
	{
		...
		$I->click("//label[@class='admin__form-field-label']/span[text()='Content Status']/parent::*/parent::div/div[@class='admin__form-field-control']/select/option[@data-title='Enabled']"); // stepKey: selectFilterOptionSelectFilterOption
