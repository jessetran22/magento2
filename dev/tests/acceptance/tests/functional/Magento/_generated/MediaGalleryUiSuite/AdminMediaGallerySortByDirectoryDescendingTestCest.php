...
/**
 * @Title("https://github.com/magento/adobe-stock-integration/issues/1776: User uses Sort by Directory Descending in Standalone Media Gallery")
 * @TestCaseId("https://github.com/magento/adobe-stock-integration/issues/1776")
 * @Description("User uses Sort by Directory Descending in Standalone Media Gallery<h3>Test files</h3>app/code/Magento/MediaGalleryUi/Test/Mftf/Test/AdminMediaGallerySortByDirectoryDescendingTest.xml<br>")
 * @group media_gallery_ui
 */
class AdminMediaGallerySortByDirectoryDescendingTestCest
{
    /**
	 ...
	 * @Stories({"User uses Sort by Directory Descending in Standalone Media Gallery"})
	 ...
	 * @throws \Exception
	 */
	public function AdminMediaGallerySortByDirectoryDescendingTest(AcceptanceTester $I)
	{
		$I->comment("Entering Action Group [openStandaloneMediaGalleryPage] AdminOpenStandaloneMediaGalleryActionGroup");
		$I->amOnPage((getenv("MAGENTO_BACKEND_BASE_URL") ? rtrim(getenv("MAGENTO_BACKEND_BASE_URL"), "/") : "") . "/" . getenv("MAGENTO_BACKEND_NAME") . "/media_gallery/media"); // stepKey: amOnStandaloneMediaGalleryPageOpenStandaloneMediaGalleryPage
		$I->waitForPageLoad(30); // stepKey: waitForPageLoadOpenStandaloneMediaGalleryPage
		...
		$I->attachFile("#image-uploader-input", "magento2.jpg"); // stepKey: uploadImageUploadThirdImage
		...
		$I->comment("Entering Action Group [sortByDirectoryDescending] AdminEnhancedMediaGalleryClickSortActionGroup");
		$I->click("div[class='masonry-image-sortby'] select"); // stepKey: clickOnSortDropdownSortByDirectoryDescending
		$I->click("//div[@class='masonry-image-sortby'] //option[@value='directory_desc']"); // stepKey: clickOnSortOptionSortByDirectoryDescending
		$I->waitForPageLoad(30); // stepKey: waitForLoadSortByDirectoryDescending
		$I->comment("Exiting Action Group [sortByDirectoryDescending] AdminEnhancedMediaGalleryClickSortActionGroup");
		$I->comment("Entering Action Group [assertImagePositionAfterSortByDirectoryDescending] AssertAdminEnhancedMediaGallerySortByActionGroup");
		$getFirstImageSrcAfterSortAssertImagePositionAfterSortByDirectoryDescending = $I->grabAttributeFrom("div[class='masonry-image-column'][data-repeat-index='0'] img", "src"); // stepKey: getFirstImageSrcAfterSortAssertImagePositionAfterSortByDirectoryDescending
		$getSecondImageSrcAfterSortAssertImagePositionAfterSortByDirectoryDescending = $I->grabAttributeFrom("div[class='masonry-image-column'][data-repeat-index='1'] img", "src"); // stepKey: getSecondImageSrcAfterSortAssertImagePositionAfterSortByDirectoryDescending
		$getThirdImageSrcAfterSortAssertImagePositionAfterSortByDirectoryDescending = $I->grabAttributeFrom("div[class='masonry-image-column'][data-repeat-index='2'] img", "src"); // stepKey: getThirdImageSrcAfterSortAssertImagePositionAfterSortByDirectoryDescending
		$I->assertStringContainsString("magento2.jpg", $getFirstImageSrcAfterSortAssertImagePositionAfterSortByDirectoryDescending); // stepKey: assertFirstImagePositionAfterSortAssertImagePositionAfterSortByDirectoryDescending
		$I->assertStringContainsString("magento.jpg", $getSecondImageSrcAfterSortAssertImagePositionAfterSortByDirectoryDescending); // stepKey: assertSecondImagePositionAfterSortAssertImagePositionAfterSortByDirectoryDescending
		$I->assertStringContainsString("magento-again.jpg", $getThirdImageSrcAfterSortAssertImagePositionAfterSortByDirectoryDescending); // stepKey: assertThirdImagePositionAfterSortAssertImagePositionAfterSortByDirectoryDescending
		$I->comment("Exiting Action Group [assertImagePositionAfterSortByDirectoryDescending] AssertAdminEnhancedMediaGallerySortByActionGroup");
	}
}
