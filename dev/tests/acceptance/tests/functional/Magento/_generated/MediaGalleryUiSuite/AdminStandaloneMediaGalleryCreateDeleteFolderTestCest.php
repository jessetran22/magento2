...
/**
 * @Title("https://studio.cucumber.io/projects/131313/test-plan/folders/1337102/scenarios/4503041; https://studio.cucumber.io/projects/131313/test-plan/folders/1337102/scenarios/4503101: Creating, deleting new folder functionality in Standalone Media Gallery")
 * @TestCaseId("https://studio.cucumber.io/projects/131313/test-plan/folders/1337102/scenarios/4503041; https://studio.cucumber.io/projects/131313/test-plan/folders/1337102/scenarios/4503101")
 * @Description("Creating, deleting new folder functionality in Standalone Media Gallery<h3>Test files</h3>app/code/Magento/MediaGalleryUi/Test/Mftf/Test/AdminStandaloneMediaGalleryCreateDeleteFolderTest.xml<br>")
 * @group media_gallery_ui
 */
class AdminStandaloneMediaGalleryCreateDeleteFolderTestCest
{
    /**
	 ...
	 * @Stories({"Creating, deleting new folder functionality in Standalone Media Gallery"})
	 ...
	 * @throws \Exception
	 */
	public function AdminStandaloneMediaGalleryCreateDeleteFolderTest(AcceptanceTester $I)
	{
		...
		$I->comment("Entering Action Group [openMediaGalleryForPage] AdminOpenStandaloneMediaGalleryActionGroup");
		$I->amOnPage((getenv("MAGENTO_BACKEND_BASE_URL") ? rtrim(getenv("MAGENTO_BACKEND_BASE_URL"), "/") : "") . "/" . getenv("MAGENTO_BACKEND_NAME") . "/media_gallery/media"); // stepKey: amOnStandaloneMediaGalleryPageOpenMediaGalleryForPage
		$I->waitForPageLoad(30); // stepKey: waitForPageLoadOpenMediaGalleryForPage
		$I->comment("Exiting Action Group [openMediaGalleryForPage] AdminOpenStandaloneMediaGalleryActionGroup");
