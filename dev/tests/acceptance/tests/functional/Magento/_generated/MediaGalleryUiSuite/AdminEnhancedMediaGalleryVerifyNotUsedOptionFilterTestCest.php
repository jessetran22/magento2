...
/**
 * @Title("https://studio.cucumber.io/projects/131313/test-plan/folders/1320712/scenarios/4930844: User filters images that are not used in the content")
 * @TestCaseId("https://studio.cucumber.io/projects/131313/test-plan/folders/1320712/scenarios/4930844")
 * @Description("User filters images that are not used in the content<h3>Test files</h3>app/code/Magento/MediaGalleryUi/Test/Mftf/Test/AdminEnhancedMediaGalleryVerifyNotUsedOptionFilterTest.xml<br>")
 * @group media_gallery_ui
 */
class AdminEnhancedMediaGalleryVerifyNotUsedOptionFilterTestCest
{
    /**
	 ...
	 * @Stories({"Story 52: User filters images that are not used in the content"})
	 ...
	 * @throws \Exception
	 */
	public function AdminEnhancedMediaGalleryVerifyNotUsedOptionFilterTest(AcceptanceTester $I)
	{
		...
		$I->click("//label[@class='admin__action-multiselect-label']/span[text()='Not used anywhere']"); // stepKey: selectEntityTypeApplyUsedInCategoryFilter
