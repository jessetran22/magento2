...
/**
 * @Title("https://app.hiptest.com/projects/131313/test-plan/folders/943908/scenarios/3218882: User manages ACL rules for Media Gallery delete folder functionality")
 * @Description("User manages ACL rules for Media Gallery delete folder functionality<h3>Test files</h3>app/code/Magento/MediaGalleryUi/Test/Mftf/Test/AdminMediaGalleryDeleteFolderAclTest.xml<br>")
 * @TestCaseId("https://app.hiptest.com/projects/131313/test-plan/folders/943908/scenarios/3218882")
 * @group media_gallery_ui
 */
class AdminMediaGalleryDeleteFolderAclTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminMediaGalleryDeleteFolderAclTest(AcceptanceTester $I)
	{
		...
		$I->comment("Entering Action Group [AddMediaGalleryResource] AdminAddRestrictedRoleActionGroup");
		$I->selectOption("#all", "0"); // stepKey: selectResourceAccessCustomAddMediaGalleryResource
		$I->scrollTo("//*[text()='Delete folder']//*[@class='jstree-checkbox']", 0, -100); // stepKey: scrollToResourceElementAddMediaGalleryResource
		$I->waitForElementVisible("//*[text()='Delete folder']//*[@class='jstree-checkbox']", 30); // stepKey: waitForElementVisibleAddMediaGalleryResource
		$I->click("//*[text()='Delete folder']//*[@class='jstree-checkbox']"); // stepKey: clickContentBlockCheckboxAddMediaGalleryResource
		$I->comment("Exiting Action Group [AddMediaGalleryResource] AdminAddRestrictedRoleActionGroup");
		...
		$I->assertEquals(["Delete Folder"], $verifyDisabledAttributeAssertCreateButtonEnabledAllOthersDisabled); // stepKey: assertSelectedCategoriesAssertCreateButtonEnabledAllOthersDisabled
