...
/**
 * @Title("https://github.com/magento/adobe-stock-integration/issues/1776: User uses Sort by Directory Ascending in Standalone Media Gallery")
 * @TestCaseId("https://github.com/magento/adobe-stock-integration/issues/1776")
 * @Description("User uses Sort by Directory Ascending in Standalone Media Gallery<h3>Test files</h3>app/code/Magento/MediaGalleryUi/Test/Mftf/Test/AdminMediaGallerySortByDirectoryAscendingTest.xml<br>")
 * @group media_gallery_ui
 */
class AdminMediaGallerySortByDirectoryAscendingTestCest
{
    /**
	 ...
	 * @Stories({"User uses Sort by Directory Ascending in Standalone Media Gallery"})
	 ...
	 * @throws \Exception
	 */
	public function AdminMediaGallerySortByDirectoryAscendingTest(AcceptanceTester $I)
	{
		$I->comment("Entering Action Group [openStandaloneMediaGalleryPage] AdminOpenStandaloneMediaGalleryActionGroup");
		$I->amOnPage((getenv("MAGENTO_BACKEND_BASE_URL") ? rtrim(getenv("MAGENTO_BACKEND_BASE_URL"), "/") : "") . "/" . getenv("MAGENTO_BACKEND_NAME") . "/media_gallery/media"); // stepKey: amOnStandaloneMediaGalleryPageOpenStandaloneMediaGalleryPage
		$I->waitForPageLoad(30); // stepKey: waitForPageLoadOpenStandaloneMediaGalleryPage
		...
		$I->comment("Entering Action Group [sortByDirectoryAscending] AdminEnhancedMediaGalleryClickSortActionGroup");
		$I->click("div[class='masonry-image-sortby'] select"); // stepKey: clickOnSortDropdownSortByDirectoryAscending
		$I->click("//div[@class='masonry-image-sortby'] //option[@value='directory_asc']"); // stepKey: clickOnSortOptionSortByDirectoryAscending
		$I->waitForPageLoad(30); // stepKey: waitForLoadSortByDirectoryAscending
		$I->comment("Exiting Action Group [sortByDirectoryAscending] AdminEnhancedMediaGalleryClickSortActionGroup");
		$I->comment("Entering Action Group [assertImagePositionAfterSortByDirectoryAscending] AssertAdminEnhancedMediaGallerySortByActionGroup");
		$getFirstImageSrcAfterSortAssertImagePositionAfterSortByDirectoryAscending = $I->grabAttributeFrom("div[class='masonry-image-column'][data-repeat-index='0'] img", "src"); // stepKey: getFirstImageSrcAfterSortAssertImagePositionAfterSortByDirectoryAscending
		$getSecondImageSrcAfterSortAssertImagePositionAfterSortByDirectoryAscending = $I->grabAttributeFrom("div[class='masonry-image-column'][data-repeat-index='1'] img", "src"); // stepKey: getSecondImageSrcAfterSortAssertImagePositionAfterSortByDirectoryAscending
		$getThirdImageSrcAfterSortAssertImagePositionAfterSortByDirectoryAscending = $I->grabAttributeFrom("div[class='masonry-image-column'][data-repeat-index='2'] img", "src"); // stepKey: getThirdImageSrcAfterSortAssertImagePositionAfterSortByDirectoryAscending
		$I->assertStringContainsString("magento-again.jpg", $getFirstImageSrcAfterSortAssertImagePositionAfterSortByDirectoryAscending); // stepKey: assertFirstImagePositionAfterSortAssertImagePositionAfterSortByDirectoryAscending
		$I->assertStringContainsString("magento.jpg", $getSecondImageSrcAfterSortAssertImagePositionAfterSortByDirectoryAscending); // stepKey: assertSecondImagePositionAfterSortAssertImagePositionAfterSortByDirectoryAscending
		$I->assertStringContainsString("magento2.jpg", $getThirdImageSrcAfterSortAssertImagePositionAfterSortByDirectoryAscending); // stepKey: assertThirdImagePositionAfterSortAssertImagePositionAfterSortByDirectoryAscending
		$I->comment("Exiting Action Group [assertImagePositionAfterSortByDirectoryAscending] AssertAdminEnhancedMediaGallerySortByActionGroup");
	}
}
