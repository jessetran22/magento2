...
/**
 * @Title("https://app.hiptest.com/projects/131313/test-plan/folders/943908/scenarios/3218882: User manages ACL rules for Media Gallery cretae folder functionality")
 * @Description("User manages ACL rules for Media Gallery cretae folder functionality<h3>Test files</h3>app/code/Magento/MediaGalleryUi/Test/Mftf/Test/AdminMediaGalleryCreateFolderAclTest.xml<br>")
 * @TestCaseId("https://app.hiptest.com/projects/131313/test-plan/folders/943908/scenarios/3218882")
 * @group media_gallery_ui
 */
class AdminMediaGalleryCreateFolderAclTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminMediaGalleryCreateFolderAclTest(AcceptanceTester $I)
	{
		...
		$I->scrollTo("//*[text()='Create folder']//*[@class='jstree-checkbox']", 0, -100); // stepKey: scrollToResourceElementAddMediaGalleryResource
		$I->waitForElementVisible("//*[text()='Create folder']//*[@class='jstree-checkbox']", 30); // stepKey: waitForElementVisibleAddMediaGalleryResource
		$I->click("//*[text()='Create folder']//*[@class='jstree-checkbox']"); // stepKey: clickContentBlockCheckboxAddMediaGalleryResource
		...
		$I->assertEquals(["Create Folder"], $verifyDisabledAttributeAssertCreateButtonEnabledAllOthersDisabled); // stepKey: assertSelectedCategoriesAssertCreateButtonEnabledAllOthersDisabled
