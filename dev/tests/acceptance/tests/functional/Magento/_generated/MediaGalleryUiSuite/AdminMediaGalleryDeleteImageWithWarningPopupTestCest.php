...
/**
 * @Title("https://studio.cucumber.io/projects/131313/test-plan/folders/1320712/scenarios/4843896: User sees warning when deleting image if it's used on storefront")
 * @TestCaseId("https://studio.cucumber.io/projects/131313/test-plan/folders/1320712/scenarios/4843896")
 * @Description("User sees warning when deleting image if it's used on storefront<h3>Test files</h3>app/code/Magento/MediaGalleryUi/Test/Mftf/Test/AdminMediaGalleryDeleteImageWithWarningPopupTest.xml<br>")
 * @group media_gallery_ui
 */
class AdminMediaGalleryDeleteImageWithWarningPopupTestCest
{
    /**
	 ...
	 * @Stories({"User sees warning when deleting image if it's used on storefront"})
	 ...
	 * @throws \Exception
	 */
	public function AdminMediaGalleryDeleteImageWithWarningPopupTest(AcceptanceTester $I)
	{
		...
		$I->attachFile("#image-uploader-input", "magento3.jpg"); // stepKey: uploadImageUploadCategoryImage
		...
		$I->comment("Entering Action Group [openMediaGalleryFromWysiwygToAssertMessage] AdminOpenMediaGalleryTinyMceActionGroup");
		$I->conditionalClick("div[data-index='content']", "//*[@class='file-uploader-area']/label[text()='Upload']", false); // stepKey: clickExpandContentOpenMediaGalleryFromWysiwygToAssertMessage
		$I->waitForElementVisible(".tox-tinymce", 30); // stepKey: waitForTinyMCEOpenMediaGalleryFromWysiwygToAssertMessage
		$I->click("button[title='Insert/edit image']"); // stepKey: clickInsertImageIconOpenMediaGalleryFromWysiwygToAssertMessage
		$I->waitForPageLoad(30); // stepKey: clickInsertImageIconOpenMediaGalleryFromWysiwygToAssertMessageWaitForPageLoad
		$I->waitForPageLoad(30); // stepKey: waitForPageLoadOpenMediaGalleryFromWysiwygToAssertMessage
		$I->click(".tox-browse-url"); // stepKey: clickBrowseOpenMediaGalleryFromWysiwygToAssertMessage
		$I->waitForPageLoad(30); // stepKey: waitForPopupOpenMediaGalleryFromWysiwygToAssertMessage
		$I->comment("Exiting Action Group [openMediaGalleryFromWysiwygToAssertMessage] AdminOpenMediaGalleryTinyMceActionGroup");
		...
		$I->comment("Entering Action Group [assertMessageImageUsedIn] AdminEnhancedMediaGalleryAssertWarningMessageActionGroup");
		$I->see("The selected assets are used in the content of the following entities: Categories(1)"); // stepKey: assertWarningMessageAssertMessageImageUsedIn
		$I->comment("Exiting Action Group [assertMessageImageUsedIn] AdminEnhancedMediaGalleryAssertWarningMessageActionGroup");
