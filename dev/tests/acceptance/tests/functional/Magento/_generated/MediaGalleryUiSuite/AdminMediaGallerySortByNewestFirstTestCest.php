...
/**
 * @Title("https://github.com/magento/adobe-stock-integration/issues/1776: User uses Sort by Newest First in Standalone Media Gallery")
 * @TestCaseId("https://github.com/magento/adobe-stock-integration/issues/1776")
 * @Description("User uses Sort by Newest First in Standalone Media Gallery<h3>Test files</h3>app/code/Magento/MediaGalleryUi/Test/Mftf/Test/AdminMediaGallerySortByNewestFirstTest.xml<br>")
 * @group media_gallery_ui
 */
class AdminMediaGallerySortByNewestFirstTestCest
{
    /**
	 ...
	 * @Stories({"User uses Sort by Newest First in Standalone Media Gallery"})
	 ...
	 * @throws \Exception
	 */
	public function AdminMediaGallerySortByNewestFirstTest(AcceptanceTester $I)
	{
		$I->comment("Entering Action Group [openStandaloneMediaGalleryPage] AdminOpenStandaloneMediaGalleryActionGroup");
		$I->amOnPage((getenv("MAGENTO_BACKEND_BASE_URL") ? rtrim(getenv("MAGENTO_BACKEND_BASE_URL"), "/") : "") . "/" . getenv("MAGENTO_BACKEND_NAME") . "/media_gallery/media"); // stepKey: amOnStandaloneMediaGalleryPageOpenStandaloneMediaGalleryPage
		$I->waitForPageLoad(30); // stepKey: waitForPageLoadOpenStandaloneMediaGalleryPage
		...
		$I->comment("Entering Action Group [sortByNewestFirst] AdminEnhancedMediaGalleryClickSortActionGroup");
		$I->click("div[class='masonry-image-sortby'] select"); // stepKey: clickOnSortDropdownSortByNewestFirst
		$I->click("//div[@class='masonry-image-sortby'] //option[@value='newest_first']"); // stepKey: clickOnSortOptionSortByNewestFirst
		$I->waitForPageLoad(30); // stepKey: waitForLoadSortByNewestFirst
		$I->comment("Exiting Action Group [sortByNewestFirst] AdminEnhancedMediaGalleryClickSortActionGroup");
		$I->comment("Entering Action Group [assertImagePositionAfterSortByNewestFirst] AssertAdminEnhancedMediaGallerySortByActionGroup");
		$getFirstImageSrcAfterSortAssertImagePositionAfterSortByNewestFirst = $I->grabAttributeFrom("div[class='masonry-image-column'][data-repeat-index='0'] img", "src"); // stepKey: getFirstImageSrcAfterSortAssertImagePositionAfterSortByNewestFirst
		$getSecondImageSrcAfterSortAssertImagePositionAfterSortByNewestFirst = $I->grabAttributeFrom("div[class='masonry-image-column'][data-repeat-index='1'] img", "src"); // stepKey: getSecondImageSrcAfterSortAssertImagePositionAfterSortByNewestFirst
		$getThirdImageSrcAfterSortAssertImagePositionAfterSortByNewestFirst = $I->grabAttributeFrom("div[class='masonry-image-column'][data-repeat-index='2'] img", "src"); // stepKey: getThirdImageSrcAfterSortAssertImagePositionAfterSortByNewestFirst
		$I->assertStringContainsString("magento2.jpg", $getFirstImageSrcAfterSortAssertImagePositionAfterSortByNewestFirst); // stepKey: assertFirstImagePositionAfterSortAssertImagePositionAfterSortByNewestFirst
		$I->assertStringContainsString("magento-again.jpg", $getSecondImageSrcAfterSortAssertImagePositionAfterSortByNewestFirst); // stepKey: assertSecondImagePositionAfterSortAssertImagePositionAfterSortByNewestFirst
		$I->assertStringContainsString("magento.jpg", $getThirdImageSrcAfterSortAssertImagePositionAfterSortByNewestFirst); // stepKey: assertThirdImagePositionAfterSortAssertImagePositionAfterSortByNewestFirst
		$I->comment("Exiting Action Group [assertImagePositionAfterSortByNewestFirst] AssertAdminEnhancedMediaGallerySortByActionGroup");
	}
}
