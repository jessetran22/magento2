...
/**
 * @Title("https://github.com/magento/adobe-stock-integration/issues/1776: User uses Sort by Oldest First in Standalone Media Gallery")
 * @TestCaseId("https://github.com/magento/adobe-stock-integration/issues/1776")
 * @Description("User uses Sort by Oldest First in Standalone Media Gallery<h3>Test files</h3>app/code/Magento/MediaGalleryUi/Test/Mftf/Test/AdminMediaGallerySortByOldestFirstTest.xml<br>")
 * @group media_gallery_ui
 */
class AdminMediaGallerySortByOldestFirstTestCest
{
    /**
	 ...
	 * @Stories({"User uses Sort by Oldest First in Standalone Media Gallery"})
	 ...
	 * @throws \Exception
	 */
	public function AdminMediaGallerySortByOldestFirstTest(AcceptanceTester $I)
	{
		$I->comment("Entering Action Group [openStandaloneMediaGalleryPage] AdminOpenStandaloneMediaGalleryActionGroup");
		$I->amOnPage((getenv("MAGENTO_BACKEND_BASE_URL") ? rtrim(getenv("MAGENTO_BACKEND_BASE_URL"), "/") : "") . "/" . getenv("MAGENTO_BACKEND_NAME") . "/media_gallery/media"); // stepKey: amOnStandaloneMediaGalleryPageOpenStandaloneMediaGalleryPage
		$I->waitForPageLoad(30); // stepKey: waitForPageLoadOpenStandaloneMediaGalleryPage
		...
		$I->comment("Entering Action Group [sortByOldestFirst] AdminEnhancedMediaGalleryClickSortActionGroup");
		$I->click("div[class='masonry-image-sortby'] select"); // stepKey: clickOnSortDropdownSortByOldestFirst
		$I->click("//div[@class='masonry-image-sortby'] //option[@value='oldest_first']"); // stepKey: clickOnSortOptionSortByOldestFirst
		$I->waitForPageLoad(30); // stepKey: waitForLoadSortByOldestFirst
		$I->comment("Exiting Action Group [sortByOldestFirst] AdminEnhancedMediaGalleryClickSortActionGroup");
		$I->comment("Entering Action Group [assertImagePositionAfterSortByOldestFirst] AssertAdminEnhancedMediaGallerySortByActionGroup");
		$getFirstImageSrcAfterSortAssertImagePositionAfterSortByOldestFirst = $I->grabAttributeFrom("div[class='masonry-image-column'][data-repeat-index='0'] img", "src"); // stepKey: getFirstImageSrcAfterSortAssertImagePositionAfterSortByOldestFirst
		$getSecondImageSrcAfterSortAssertImagePositionAfterSortByOldestFirst = $I->grabAttributeFrom("div[class='masonry-image-column'][data-repeat-index='1'] img", "src"); // stepKey: getSecondImageSrcAfterSortAssertImagePositionAfterSortByOldestFirst
		$getThirdImageSrcAfterSortAssertImagePositionAfterSortByOldestFirst = $I->grabAttributeFrom("div[class='masonry-image-column'][data-repeat-index='2'] img", "src"); // stepKey: getThirdImageSrcAfterSortAssertImagePositionAfterSortByOldestFirst
		$I->assertStringContainsString("magento.jpg", $getFirstImageSrcAfterSortAssertImagePositionAfterSortByOldestFirst); // stepKey: assertFirstImagePositionAfterSortAssertImagePositionAfterSortByOldestFirst
		$I->assertStringContainsString("magento-again.jpg", $getSecondImageSrcAfterSortAssertImagePositionAfterSortByOldestFirst); // stepKey: assertSecondImagePositionAfterSortAssertImagePositionAfterSortByOldestFirst
		$I->assertStringContainsString("magento2.jpg", $getThirdImageSrcAfterSortAssertImagePositionAfterSortByOldestFirst); // stepKey: assertThirdImagePositionAfterSortAssertImagePositionAfterSortByOldestFirst
		$I->comment("Exiting Action Group [assertImagePositionAfterSortByOldestFirst] AssertAdminEnhancedMediaGallerySortByActionGroup");
	}
}
