...
/**
 * @Title("https://studio.cucumber.io/projects/131313/test-plan/folders/1320712/scenarios/3961351: User edits image meta data in standalone media gallery")
 * @Description("User edits image meta data in Standalone Media Gallery<h3>Test files</h3>app/code/Magento/MediaGalleryUi/Test/Mftf/Test/AdminStandaloneMediaGalleryEditImageDetailsFromDialogTest.xml<br>")
 * @TestCaseId("https://studio.cucumber.io/projects/131313/test-plan/folders/1320712/scenarios/3961351")
 * @group media_gallery_ui
 */
class AdminStandaloneMediaGalleryEditImageDetailsFromDialogTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminStandaloneMediaGalleryEditImageDetailsFromDialogTest(AcceptanceTester $I)
	{
		...
		$secondsFromMinuteStart = $date->format("s");

		$I->comment("Entering Action Group [clickViewDetails] AdminEnhancedMediaGalleryViewImageDetails");
		$I->click(".three-dots"); // stepKey: openContextMenuClickViewDetails
		$I->click("//ul[@class='action-menu _active']//a[text()='View Details']"); // stepKey: viewDetailsClickViewDetails
		$I->waitForPageLoad(30); // stepKey: viewDetailsClickViewDetailsWaitForPageLoad
		$I->waitForElementVisible("//aside[contains(@class, 'media-gallery-image-details') and contains(@class, '_show')]//header[contains(@class, 'modal-header')]//h1[contains(@class, 'modal-title') and contains(., 'Image Details')]", 30); // stepKey: waitForLoadingMaskToDisappearClickViewDetails
		$I->comment("Exiting Action Group [clickViewDetails] AdminEnhancedMediaGalleryViewImageDetails");
		$I->comment("Entering Action Group [verifyCreatedAndUpdatedAtDate] AssertAdminEnhancedMediaGalleryUploadedImageDateTimeEqualsActionGroup");
		$grabCreatedTimeVerifyCreatedAndUpdatedAtDate = $I->grabTextFrom("//div[@class='attribute']/span[contains(text(), 'Created')]/following-sibling::div"); // stepKey: grabCreatedTimeVerifyCreatedAndUpdatedAtDate
		$grabModifietTimeVerifyCreatedAndUpdatedAtDate = $I->grabTextFrom("//div[@class='attribute']/span[contains(text(), 'Modified')]/following-sibling::div"); // stepKey: grabModifietTimeVerifyCreatedAndUpdatedAtDate
		$I->assertEquals($grabModifietTimeVerifyCreatedAndUpdatedAtDate, $grabCreatedTimeVerifyCreatedAndUpdatedAtDate); // stepKey: verifyContentTypeVerifyCreatedAndUpdatedAtDate
		$I->comment("Exiting Action Group [verifyCreatedAndUpdatedAtDate] AssertAdminEnhancedMediaGalleryUploadedImageDateTimeEqualsActionGroup");
		$calcWaitPeriod = $I->executeJS("return 60 - {$secondsFromMinuteStart} + 5"); // stepKey: calcWaitPeriod
		$I->wait($calcWaitPeriod); // stepKey: waitTillEndOfAMinute
		...
		$I->comment("Entering Action Group [assertUpdatedAtTimeChanged] AssertAdminEnhancedMediaGalleryImageCreatedAtNotEqualsUpdatedAtTimeActionGroup");
		$grabCreatedTimeAssertUpdatedAtTimeChanged = $I->grabTextFrom("//div[@class='attribute']/span[contains(text(), 'Created')]/following-sibling::div"); // stepKey: grabCreatedTimeAssertUpdatedAtTimeChanged
		$grabModifietTimeAssertUpdatedAtTimeChanged = $I->grabTextFrom("//div[@class='attribute']/span[contains(text(), 'Modified')]/following-sibling::div"); // stepKey: grabModifietTimeAssertUpdatedAtTimeChanged
		$I->assertNotEquals($grabModifietTimeAssertUpdatedAtTimeChanged, $grabCreatedTimeAssertUpdatedAtTimeChanged); // stepKey: verifyContentTypeAssertUpdatedAtTimeChanged
		$I->comment("Exiting Action Group [assertUpdatedAtTimeChanged] AssertAdminEnhancedMediaGalleryImageCreatedAtNotEqualsUpdatedAtTimeActionGroup");
