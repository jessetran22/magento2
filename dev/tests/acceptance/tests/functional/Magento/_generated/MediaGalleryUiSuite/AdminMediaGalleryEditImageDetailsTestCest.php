...
/**
 * @Title("https://studio.cucumber.io/projects/131313/test-plan/folders/1320712/scenarios/3961351: DEPRECATED. User edits image meta data in media gallery")
 * @TestCaseId("https://studio.cucumber.io/projects/131313/test-plan/folders/1320712/scenarios/3961351")
 * @Description("User edits image meta data in Standalone Media Gallery<h3 class='y-label y-label_status_broken'>Deprecated Notice(s):</h3><ul><li>Use AdminMediaGalleryEditImageDetailsFromGridTest instead</li></ul><h3>Test files</h3>app/code/Magento/MediaGalleryUi/Test/Mftf/Test/AdminMediaGalleryEditImageDetailsTest.xml<br>")
 * @group media_gallery_ui
 */
class AdminMediaGalleryEditImageDetailsTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminMediaGalleryEditImageDetailsTest(AcceptanceTester $I, \Codeception\Scenario $scenario)
	{
