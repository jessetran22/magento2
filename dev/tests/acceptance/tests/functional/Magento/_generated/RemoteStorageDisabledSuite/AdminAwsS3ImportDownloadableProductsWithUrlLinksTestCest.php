...
/**
 * @Title("[NO TESTCASEID]: S3 - Import Downloadable Products with Url Links")
 * @Description("Imports a .csv file containing a downloadable product with url links. Verifies that             products are imported successfully.<h3>Test files</h3>app/code/Magento/AwsS3/Test/Mftf/Test/AdminAwsS3ImportDownloadableProductsWithUrlLinksTest.xml<br>")
 * @group importExport
 * @group Downloadable
 * @group remote_storage_aws_s3
 * @group remote_storage_disabled
 */
class AdminAwsS3ImportDownloadableProductsWithUrlLinksTestCest
{
    /**
	...
	{
		$I->comment("Add Downloadable Domain, Create Category, & Create Customer");
		...
		$I->createEntity("createImportCategory", "hook", "ImportCategory_Downloadable_UrlLinks", [], []); // stepKey: createImportCategory
		...
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->createDirectory("pub/media/import/import-product-downloadable-url-links", 511); // stepKey: createDirectoryForImportFiles
		$I->comment('[copyImportFile] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::copy()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->copy("dev/tests/acceptance/tests/_data/import_downloadable_product_url_links.csv", "pub/media/import/import-product-downloadable-url-links/import_downloadable_product_url_links.csv"); // stepKey: copyImportFile
		...
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->copy("dev/tests/acceptance/tests/_data/magento-logo.png", "pub/media/import/import-product-downloadable-url-links/magento-logo.png"); // stepKey: copyBaseImage
		$I->comment('[copySmallImage] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::copy()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->copy("dev/tests/acceptance/tests/_data/m-logo.gif", "pub/media/import/import-product-downloadable-url-links/m-logo.gif"); // stepKey: copySmallImage
		$I->comment('[copyThumbnailImage] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::copy()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->copy("dev/tests/acceptance/tests/_data/adobe-base.jpg", "pub/media/import/import-product-downloadable-url-links/adobe-base.jpg"); // stepKey: copyThumbnailImage
		...
		$this->helperContainer->get('Magento\AwsS3\Test\Mftf\Helper\S3FileAssertions')->createDirectory("var/import/images/import-product-downloadable-url-links", 511); // stepKey: createDirectoryForImportFilesInS3
		$I->comment('[copyBaseImageInS3] Magento\AwsS3\Test\Mftf\Helper\S3FileAssertions::copy()');
		$this->helperContainer->get('Magento\AwsS3\Test\Mftf\Helper\S3FileAssertions')->copy("media/import/import-product-downloadable-url-links/magento-logo.png", "var/import/images/import-product-downloadable-url-links/magento-logo.png"); // stepKey: copyBaseImageInS3
		$I->comment('[copySmallImageInS3] Magento\AwsS3\Test\Mftf\Helper\S3FileAssertions::copy()');
		$this->helperContainer->get('Magento\AwsS3\Test\Mftf\Helper\S3FileAssertions')->copy("media/import/import-product-downloadable-url-links/m-logo.gif", "var/import/images/import-product-downloadable-url-links/m-logo.gif"); // stepKey: copySmallImageInS3
		$I->comment('[copyThumbnailImageInS3] Magento\AwsS3\Test\Mftf\Helper\S3FileAssertions::copy()');
		$this->helperContainer->get('Magento\AwsS3\Test\Mftf\Helper\S3FileAssertions')->copy("media/import/import-product-downloadable-url-links/adobe-base.jpg", "var/import/images/import-product-downloadable-url-links/adobe-base.jpg"); // stepKey: copyThumbnailImageInS3
		...
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->createDirectory("pub/media/import/import-product-downloadable-url-links", 511); // stepKey: createDirectoryForImportDownloadableLinkFiles
		$I->comment('[copyBaseImage2] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::copy()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->copy("dev/tests/acceptance/tests/_data/magento-logo.png", "pub/media/import/import-product-downloadable-url-links/magento-logo.png"); // stepKey: copyBaseImage2
		$I->comment('[copySmallImage2] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::copy()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->copy("dev/tests/acceptance/tests/_data/m-logo.gif", "pub/media/import/import-product-downloadable-url-links/m-logo.gif"); // stepKey: copySmallImage2
		$I->comment('[copyThumbnailImage3] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::copy()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->copy("dev/tests/acceptance/tests/_data/adobe-base.jpg", "pub/media/import/import-product-downloadable-url-links/adobe-base.jpg"); // stepKey: copyThumbnailImage3
	...
	{
		$I->comment("Revert Configuration & Delete Data");
		...
		$this->helperContainer->get('Magento\AwsS3\Test\Mftf\Helper\S3FileAssertions')->deleteDirectory("media/import/import-product-downloadable-url-links"); // stepKey: deleteImportFilesDirectoryS3
		$I->comment('[deleteImportImagesFilesDirectoryS3] Magento\AwsS3\Test\Mftf\Helper\S3FileAssertions::deleteDirectory()');
		$this->helperContainer->get('Magento\AwsS3\Test\Mftf\Helper\S3FileAssertions')->deleteDirectory("var/import/images/import-product-downloadable-url-links"); // stepKey: deleteImportImagesFilesDirectoryS3
		$I->comment('[deleteDownloadableLinkFilesDirectory] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::deleteDirectory()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->deleteDirectory("pub/media/import/import-product-downloadable-url-links"); // stepKey: deleteDownloadableLinkFilesDirectory
		$I->deleteEntityByUrl("/V1/products/import-product-downloadable-url-links"); // stepKey: deleteImportedDownloadableProduct
		...
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->deleteDirectory("pub/media/import/import-product-downloadable-url-links"); // stepKey: deleteImportFilesDirectoryLocal
	 ...
	 * @throws \Exception
	 */
	public function AdminAwsS3ImportDownloadableProductsWithUrlLinksTest(AcceptanceTester $I)
	{
		...
		$I->attachFile("#import_file", "import_downloadable_product_url_links.csv"); // stepKey: attachFileForImportFillImportForm
		$I->fillField("#import_images_file_dir", "import-product-downloadable-url-links"); // stepKey: fillImagesFileDirectoryFieldFillImportForm
		...
		$I->see("import_downloadable_product_url_links.csv", "table.data-grid tbody > tr:nth-of-type(1)"); // stepKey: seeImportedFile
		...
		$I->fillField("input.admin__control-text[name='sku']", "import-product-downloadable-url-links"); // stepKey: fillProductSkuFilterGoToDownloadableProductEditPage
		...
		$I->click("//td/div[text()='import-product-downloadable-url-links']"); // stepKey: clickProductGoToDownloadableProductEditPage
		...
		$I->seeInField("//*[@name='product[sku]']", "import-product-downloadable-url-links"); // stepKey: seeProductSKUGoToDownloadableProductEditPage
		...
		$I->seeInField(".admin__field[data-index=name] input", "import-product-downloadable-url-links"); // stepKey: seeProductNameAssertDownloadableProductOnEditPage
		$I->seeInField(".admin__field[data-index=sku] input", "import-product-downloadable-url-links"); // stepKey: seeProductSkuAssertDownloadableProductOnEditPage
		$I->seeInField(".admin__field[data-index=price] input", "99.00"); // stepKey: seeProductPriceAssertDownloadableProductOnEditPage
		...
		$I->seeElement("//*[@class='admin__action-multiselect-crumb']/span[contains(text(), 'import-category-downloadable-url-links')]"); // stepKey: seeProductCategoriesAssertDownloadableProductOnEditPage
		...
		$I->seeInField("input[name='downloadable[link][0][price]']", "2.00"); // stepKey: seePriceVerifyDownloadableLinkAdmin
		$I->seeInField("select[name='downloadable[link][0][type]']", "URL"); // stepKey: seeFileTypeVerifyDownloadableLinkAdmin
		...
		$I->assertStringContainsString("https://static.magento.com/sites/all/themes/mag_redesign/images/magento-logo.svg", $grabFileNameOrUrlVerifyDownloadableLinkAdmin); // stepKey: assertFileNameOrUrlVerifyDownloadableLinkAdmin
		$I->seeInField("select[name='downloadable[link][0][sample][type]']", "URL"); // stepKey: seeSampleTypeVerifyDownloadableLinkAdmin
		...
		$I->assertStringContainsString("https://static.magento.com/sites/all/themes/mag_redesign/images/magento-logo.svg", $grabSampleFileNameOrUrlVerifyDownloadableLinkAdmin); // stepKey: assertSampleFileNameOrUrlVerifyDownloadableLinkAdmin
		$I->seeInField("select[name='downloadable[link][0][is_shareable]']", "Yes"); // stepKey: seeShareableVerifyDownloadableLinkAdmin
		...
		$I->seeInField("select[name='downloadable[sample][0][type]']", "URL"); // stepKey: seeFileTypeVerifyDownloadableSampleLinkAdmin
		...
		$I->assertStringContainsString("https://static.magento.com/sites/all/themes/mag_redesign/images/magento-logo.svg", $grabFileNameOrUrlVerifyDownloadableSampleLinkAdmin); // stepKey: assertFileNameOrUrlVerifyDownloadableSampleLinkAdmin
		...
		$I->amOnPage("/import-category-downloadable-url-links.html"); // stepKey: goToStorefrontCategoryPageGoToCategoryPage
		...
		$I->see("import-product-downloadable-url-links", ".product-item-name"); // stepKey: seeProduct
		...
		$I->amOnPage("/import-product-downloadable-url-links.html"); // stepKey: openProductPageOpenProductStorefrontPage
		...
		$I->see("import-product-downloadable-url-links", ".base"); // stepKey: seeProductName
		$I->see("import-product-downloadable-url-links", ".product.attribute.sku>.value"); // stepKey: seeSku
		$I->see("$99.00", "div.price-box.price-final_price"); // stepKey: seePrice
		...
		$I->waitForElement("//*[name()='title'][contains(.,'magento-logo')]", 30); // stepKey: seeImageTitle
		$I->waitForElement("svg", 30); // stepKey: seeImage
		...
		$I->waitForElement("//*[name()='title'][contains(.,'magento-logo')]", 30); // stepKey: seeImageTitle2
		$I->waitForElement("svg", 30); // stepKey: seeImage2
		...
		$I->waitForText("$101.00", 30, "div.price-box.price-final_price"); // stepKey: seeUpdatedPrice
		...
		$I->waitForElement("//*[name()='title'][contains(.,'magento-logo')]", 30); // stepKey: seeImageTitle3
		$I->waitForElement("svg", 30); // stepKey: seeImage3
