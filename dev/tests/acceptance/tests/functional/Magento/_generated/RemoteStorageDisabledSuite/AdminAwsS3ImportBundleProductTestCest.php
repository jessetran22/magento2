...
/**
 * @Title("[NO TESTCASEID]: S3 - Import Bundle Product")
 * @Description("Imports a .csv file containing a bundle product. Verifies that product is imported             successfully and can be purchased.<h3>Test files</h3>app/code/Magento/AwsS3/Test/Mftf/Test/AdminAwsS3ImportBundleProductTest.xml<br>")
 * @group importExport
 * @group Bundle
 * @group remote_storage_aws_s3
 * @group remote_storage_disabled
 */
class AdminAwsS3ImportBundleProductTestCest
{
    /**
	...
	public function _before(AcceptanceTester $I)
	{
		...
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->createDirectory("pub/media/import/import-product-bundle", 511); // stepKey: createDirectoryForImportFiles
		$I->comment('[copyImportFile] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::copy()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->copy("dev/tests/acceptance/tests/_data/import_bundle_product.csv", "pub/media/import/import-product-bundle/import_bundle_product.csv"); // stepKey: copyImportFile
		...
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->copy("dev/tests/acceptance/tests/_data/magento-logo.png", "pub/media/import/import-product-bundle/magento-logo.png"); // stepKey: copyProduct1BaseImage
		$I->comment('[copyProduct2BaseImage] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::copy()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->copy("dev/tests/acceptance/tests/_data/m-logo.gif", "pub/media/import/import-product-bundle/m-logo.gif"); // stepKey: copyProduct2BaseImage
		$I->comment('[copyProduct3BaseImage] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::copy()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->copy("dev/tests/acceptance/tests/_data/adobe-base.jpg", "pub/media/import/import-product-bundle/adobe-base.jpg"); // stepKey: copyProduct3BaseImage
		...
		$this->helperContainer->get('Magento\AwsS3\Test\Mftf\Helper\S3FileAssertions')->createDirectory("var/import/images/import-product-bundle", 511); // stepKey: createDirectoryForImportFilesInS3
		$I->comment('[copyProduct1BaseImageInS3] Magento\AwsS3\Test\Mftf\Helper\S3FileAssertions::copy()');
		$this->helperContainer->get('Magento\AwsS3\Test\Mftf\Helper\S3FileAssertions')->copy("media/import/import-product-bundle/magento-logo.png", "var/import/images/import-product-bundle/magento-logo.png"); // stepKey: copyProduct1BaseImageInS3
		$I->comment('[copyProduct2BaseImageInS3] Magento\AwsS3\Test\Mftf\Helper\S3FileAssertions::copy()');
		$this->helperContainer->get('Magento\AwsS3\Test\Mftf\Helper\S3FileAssertions')->copy("media/import/import-product-bundle/m-logo.gif", "var/import/images/import-product-bundle/m-logo.gif"); // stepKey: copyProduct2BaseImageInS3
		$I->comment('[copyProduct3BaseImageInS3] Magento\AwsS3\Test\Mftf\Helper\S3FileAssertions::copy()');
		$this->helperContainer->get('Magento\AwsS3\Test\Mftf\Helper\S3FileAssertions')->copy("media/import/import-product-bundle/adobe-base.jpg", "var/import/images/import-product-bundle/adobe-base.jpg"); // stepKey: copyProduct3BaseImageInS3
	...
	public function _after(AcceptanceTester $I)
	{
		...
		$this->helperContainer->get('Magento\AwsS3\Test\Mftf\Helper\S3FileAssertions')->deleteDirectory("media/import/import-product-bundle"); // stepKey: deleteImportFilesDirectoryS3
		$I->comment('[deleteImportImagesFilesDirectoryS3] Magento\AwsS3\Test\Mftf\Helper\S3FileAssertions::deleteDirectory()');
		$this->helperContainer->get('Magento\AwsS3\Test\Mftf\Helper\S3FileAssertions')->deleteDirectory("var/import/images/import-product-bundle"); // stepKey: deleteImportImagesFilesDirectoryS3
		...
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->deleteDirectory("pub/media/import/import-product-bundle"); // stepKey: deleteImportFilesDirectoryLocal
	 ...
	 * @throws \Exception
	 */
	public function AdminAwsS3ImportBundleProductTest(AcceptanceTester $I)
	{
		...
		$I->comment("Import Bundle Product");
	}
}
