...
/**
 * @Title("MC-3424: Admin should be able to set/edit product Content when editing a configurable product")
 * @Description("Admin should be able to set/edit product Content when editing a configurable product<h3>Test files</h3>app/code/Magento/ConfigurableProduct/Test/Mftf/Test/AdminConfigurableProductSetEditContentTest.xml<br>")
 * @TestCaseId("MC-3424")
 * @group ConfigurableProduct
 * @group WYSIWYGDisabled
 */
class AdminConfigurableProductSetEditContentTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function AdminConfigurableProductSetEditContentTest(AcceptanceTester $I)
	{
		...
		$I->waitForElementVisible(".item[data-ui-id='products-list-add-new-product-button-item-configurable']", 30); // stepKey: waitForAddProductDropdownGoToCreateProduct
		$I->click(".item[data-ui-id='products-list-add-new-product-button-item-configurable']"); // stepKey: clickAddProductTypeGoToCreateProduct
		$I->waitForPageLoad(30); // stepKey: waitForCreateProductPageLoadGoToCreateProduct
		$I->seeInCurrentUrl((getenv("MAGENTO_BACKEND_BASE_URL") ? rtrim(getenv("MAGENTO_BACKEND_BASE_URL"), "/") : "") . "/" . getenv("MAGENTO_BACKEND_NAME") . "/catalog/product/new/set/4/type/configurable/"); // stepKey: seeNewProductUrlGoToCreateProduct
		...
		$I->amOnPage("configurable" . msq("BaseConfigurableProduct") . ".html"); // stepKey: goToStorefront
