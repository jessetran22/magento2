...
/**
 * @Title("MC-3422: Admin should be able to set/edit product Content when editing a simple product")
 * @Description("Admin should be able to set/edit product Content when editing a simple product<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/AdminSimpleProductSetEditContentTest.xml<br>")
 * @TestCaseId("MC-3422")
 * @group Catalog
 * @group WYSIWYGDisabled
 */
class AdminSimpleProductSetEditContentTestCest
{
	/**
	...
	public function _after(AcceptanceTester $I)
	{
		...
		$I->fillField("input.admin__control-text[name='name']", "Simple Product " . msq("SimpleProduct")); // stepKey: fillProductNameFilterDeleteProduct
	 ...
	 * @throws \Exception
	 */
	public function AdminSimpleProductSetEditContentTest(AcceptanceTester $I)
	{
		...
		$I->fillField(".admin__field[data-index=name] input", "Simple Product " . msq("SimpleProduct")); // stepKey: fillProductNameFillProductForm
		...
		$I->amOnPage("simple-product-" . msq("SimpleProduct") . ".html"); // stepKey: goToStorefront
