...
/**
 * @Title("MC-3343: Admin should be able to set/edit product Content when editing a bundle product")
 * @Description("Admin should be able to set/edit product Content when editing a bundle product<h3>Test files</h3>app/code/Magento/Bundle/Test/Mftf/Test/AdminBundleProductSetEditContentTest.xml<br>")
 * @TestCaseId("MC-3343")
 * @group Bundle
 * @group WYSIWYGDisabled
 */
class AdminBundleProductSetEditContentTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function AdminBundleProductSetEditContentTest(AcceptanceTester $I)
	{
		...
		$I->fillField(".admin__field[data-index=name] input", "BundleProduct" . msq("BundleProduct")); // stepKey: fillProductNameFillProductForm
		$I->fillField(".admin__field[data-index=sku] input", "bundleproduct" . msq("BundleProduct")); // stepKey: fillProductSkuFillProductForm
