...
/**
 * @Title("MC-3423: Admin should be able to set/edit product Content when editing a grouped product")
 * @Description("Admin should be able to set/edit product Content when editing a grouped product<h3>Test files</h3>app/code/Magento/GroupedProduct/Test/Mftf/Test/AdminGroupedProductSetEditContentTest.xml<br>")
 * @TestCaseId("MC-3423")
 * @group GroupedProduct
 * @group WYSIWYGDisabled
 */
class AdminGroupedProductSetEditContentTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function AdminGroupedProductSetEditContentTest(AcceptanceTester $I)
	{
		...
		$I->comment("Entering Action Group [fillProductForm] FillProductNameAndSkuInProductFormActionGroup");
		$I->fillField(".admin__field[data-index=name] input", "GroupedProduct" . msq("GroupedProduct")); // stepKey: fillProductNameFillProductForm
		$I->fillField(".admin__field[data-index=sku] input", "groupedproduct" . msq("GroupedProduct")); // stepKey: fillProductSkuFillProductForm
		$I->comment("Exiting Action Group [fillProductForm] FillProductNameAndSkuInProductFormActionGroup");
