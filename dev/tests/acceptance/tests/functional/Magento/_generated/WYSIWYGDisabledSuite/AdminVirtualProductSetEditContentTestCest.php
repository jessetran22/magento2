...
/**
 * @Title("MC-3425: Admin should be able to set/edit product Content when editing a virtual product")
 * @Description("Admin should be able to set/edit product Content when editing a virtual product<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/AdminVirtualProductSetEditContentTest.xml<br>")
 * @TestCaseId("MC-3425")
 * @group Catalog
 * @group WYSIWYGDisabled
 */
class AdminVirtualProductSetEditContentTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function AdminVirtualProductSetEditContentTest(AcceptanceTester $I)
	{
		...
		$I->fillField(".admin__field[data-index=name] input", "virtualProduct" . msq("defaultVirtualProduct")); // stepKey: fillProductNameFillProductForm
		$I->fillField(".admin__field[data-index=sku] input", "virtualProduct" . msq("defaultVirtualProduct")); // stepKey: fillProductSkuFillProductForm
		$I->fillField(".admin__field[data-index=price] input", "12.34"); // stepKey: fillProductPriceFillProductForm
		...
		$I->amOnPage("virtualproduct" . msq("defaultVirtualProduct") . ".html"); // stepKey: goToStorefront
