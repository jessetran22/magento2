...
/**
 * @Title("MC-122: Admin should be able to set Virtual Product as new so that it shows up in the Catalog New Products List Widget")
 * @Description("Admin should be able to set Virtual Product as new so that it shows up in the Catalog New Products List Widget<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/NewProductsListWidgetVirtualProductTest.xml<br>app/code/Magento/PageCache/Test/Mftf/Test/NewProductsListWidgetTest/NewProductsListWidgetVirtualProductTest.xml<br>")
 * @TestCaseId("MC-122")
 * @group Catalog
 * @group WYSIWYGDisabled
 */
class NewProductsListWidgetVirtualProductTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function NewProductsListWidgetVirtualProductTest(AcceptanceTester $I)
	{
		...
		$I->comment("Create a Virtual Product to appear in the widget");
		...
		$I->comment("Entering Action Group [clickAddVirtualProduct] AdminClickAddProductToggleAndSelectProductTypeActionGroup");
		$I->click(".action-toggle.primary.add"); // stepKey: clickAddProductDropdownClickAddVirtualProduct
		$I->waitForPageLoad(30); // stepKey: clickAddProductDropdownClickAddVirtualProductWaitForPageLoad
		$I->click(".item[data-ui-id='products-list-add-new-product-button-item-virtual']"); // stepKey: clickAddProductClickAddVirtualProduct
		$I->waitForPageLoad(30); // stepKey: waitForFormToLoadClickAddVirtualProduct
		$I->comment("Exiting Action Group [clickAddVirtualProduct] AdminClickAddProductToggleAndSelectProductTypeActionGroup");
		...
		$I->fillField(".admin__field[data-index=price] input", "123.45"); // stepKey: fillProductPrice
		$I->fillField(".admin__field[data-index=qty] input", "100"); // stepKey: fillProductQuantity
		$I->fillField("input[name='product[news_from_date]']", "01/1/2000"); // stepKey: fillProductNewFrom
		$I->fillField("input[name='product[news_to_date]']", "01/1/2099"); // stepKey: fillProductNewTo
		...
		$I->amOnPage("test-page-" . msq("_newDefaultCmsPage")); // stepKey: amOnCmsPage
		$I->waitForPageLoad(30); // stepKey: waitForCmsPage
		$I->see("testProductName" . msq("_defaultProduct"), ".product-item-info"); // stepKey: seeProductName
	}
}
