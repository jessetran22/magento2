 ...
 * @Description("When user add Configurable child product to WIshlist then child product image should be shown in Wishlist<h3>Test files</h3>app/code/Magento/Wishlist/Test/Mftf/Test/ConfigurableProductChildImageShouldBeShownOnWishListTest.xml<br>")
