...
/**
 * @Title("MAGETWO-24729: Negative product search")
 * @Description("Negative product search<h3>Test files</h3>app/code/Magento/CatalogSearch/Test/Mftf/Test/StorefrontAdvancedSearchNegativeProductSearchTest.xml<br>")
 * @TestCaseId("MAGETWO-24729")
 * @group searchFrontend
 * @group mtf_migrated
 */
class StorefrontAdvancedSearchNegativeProductSearchTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function StorefrontAdvancedSearchNegativeProductSearchTest(AcceptanceTester $I)
	{
		...
		$I->fillField("#name", "Negative_product_search"); // stepKey: fillNameSearch
