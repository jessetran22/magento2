 ...
 * @Description("Products removed from wishlist and a customer remains on the same page.<h3>Test files</h3>app/code/Magento/Wishlist/Test/Mftf/Test/StorefrontRemoveProductsFromWishlistUsingSidebarTest.xml<br>")
 * @group wishlist
 */
