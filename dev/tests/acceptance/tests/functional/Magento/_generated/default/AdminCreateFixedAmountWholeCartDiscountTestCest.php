...
/**
 * @Title("MC-91: Admin should be able to create a cart price rule of type Fixed amount discount for whole cart")
 * @Description("Admin should be able to create a cart price rule of type Fixed amount discount for whole cart<h3>Test files</h3>app/code/Magento/SalesRule/Test/Mftf/Test/AdminCreateFixedAmountWholeCartDiscountTest.xml<br>")
 * @TestCaseId("MC-91")
 * @group SalesRule
 */
class AdminCreateFixedAmountWholeCartDiscountTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateFixedAmountWholeCartDiscountTest(AcceptanceTester $I)
	{
		$I->comment("Create a cart price rule for Fixed amount discount for whole cart");
		...
		$I->fillField("input[name='discount_amount']", "19.99"); // stepKey: fillDiscountAmount
		...
		$I->see("-$19.99", "td[data-th='Discount']"); // stepKey: seeDiscountTotalVerifyStorefront
