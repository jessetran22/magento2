...
/**
 * @Title("MC-14511: Create downloadable product without tax class id test")
 * @Description("Admin should be able to create downloadable product without tax class id<h3>Test files</h3>app/code/Magento/Downloadable/Test/Mftf/Test/AdminCreateDownloadableProductWithoutTaxClassIdTest.xml<br>")
 * @TestCaseId("MC-14511")
 * @group Downloadable
 * @group mtf_migrated
 */
class AdminCreateDownloadableProductWithoutTaxClassIdTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateDownloadableProductWithoutTaxClassIdTest(AcceptanceTester $I)
	{
		...
		$I->comment("Tax class id = \"none\"");
		$I->selectOption("//select[@name='product[tax_class_id]']", "None"); // stepKey: taxClassDropDown
		$I->waitForPageLoad(30); // stepKey: taxClassDropDownWaitForPageLoad
