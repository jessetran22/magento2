 ...
 * @Description("Admin should be able to navigate to Reports > Low Stock<h3>Test files</h3>app/code/Magento/Reports/Test/Mftf/Test/AdminReportsLowStockNavigateMenuTest.xml<br>")
 * @TestCaseId("MC-14169")
 * @group menu
 * @group mtf_migrated
 */
