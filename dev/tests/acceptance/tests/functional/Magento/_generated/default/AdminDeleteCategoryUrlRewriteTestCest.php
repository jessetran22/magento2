 ...
 * @Description("Test log in to URL rewrite and Delete Category URL rewrite<h3>Test files</h3>app/code/Magento/UrlRewrite/Test/Mftf/Test/AdminDeleteCategoryUrlRewriteTest.xml<br>")
 * @TestCaseId("")
 * @group mtf_migrated
 */
