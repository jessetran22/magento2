...
/**
 * @Title("MAGETWO-91409: Magento Rush theme should not be available in Themes grid")
 * @Description("Magento Rush theme should not be available in Themes grid<h3>Test files</h3>app/code/Magento/Theme/Test/Mftf/Test/ThemeTest.xml<br>")
 * @TestCaseId("MAGETWO-91409")
 * @group Theme
 */
class ThemeTestCest
{
	 ...
	 * @throws \Exception
	 */
	public function ThemeTest(AcceptanceTester $I)
	{
		...
		$I->comment("Navigate to Themes page");
		$I->amOnPage((getenv("MAGENTO_BACKEND_BASE_URL") ? rtrim(getenv("MAGENTO_BACKEND_BASE_URL"), "/") : "") . "/" . getenv("MAGENTO_BACKEND_NAME") . "/admin/system_design_theme/"); // stepKey: navigateToThemesIndexPage
		$I->waitForPageLoad(30); // stepKey: wait1
		$I->dontSee("//table//div[contains(text(), 'Magento Rush')]"); // stepKey: dontSeeRushThemeInTitleColumn
		$I->waitForPageLoad(30); // stepKey: waitForThemeGridLoad
