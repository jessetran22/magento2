...
/**
 * @Title("MC-252: Guest customer should be able to advance search Downloadable product with product sku")
 * @Description("Guest customer should be able to advance search Downloadable product with product sku<h3>Test files</h3>app/code/Magento/Downloadable/Test/Mftf/Test/AdvanceCatalogSearchDownloadableProductTest/AdvanceCatalogSearchDownloadableBySkuTest.xml<br>")
 * @TestCaseId("MC-252")
 * @group Downloadable
 */
class AdvanceCatalogSearchDownloadableBySkuTestCest
{
    /**
	...
	public function _before(AcceptanceTester $I)
	{
		...
		$I->createEntity("product", "hook", "ApiDownloadableProductUnderscoredSku", [], []); // stepKey: product
	 ...
	 * @throws \Exception
	 */
	public function AdvanceCatalogSearchDownloadableBySkuTest(AcceptanceTester $I)
	{
