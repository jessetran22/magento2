...
/**
 * @Title("MC-5325: Creating tax rule with new tax classes and tax rate")
 * @Description("Test log in to Create Tax Rule and Create tax rule with New Tax Classes and Tax Rate<h3>Test files</h3>app/code/Magento/Tax/Test/Mftf/Test/AdminCreateTaxRuleWithNewTaxClassesAndTaxRateTest.xml<br>")
 * @TestCaseId("MC-5325")
 * @group tax
 * @group mtf_migrated
 */
class AdminCreateTaxRuleWithNewTaxClassesAndTaxRateTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateTaxRuleWithNewTaxClassesAndTaxRateTest(AcceptanceTester $I)
	{
		...
		$I->comment("Verify we see created tax rule with new tax classes and tax rate(from the above step) on the tax rule grid page");
		...
		$I->comment("Verify we see created tax rule with new tax classes and tax rate on the tax rule form page");
