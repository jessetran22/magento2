...
/**
 * @Title("[NO TESTCASEID]: Update CMS Page URL Redirect With Temporary Redirect")
 * @Description("Login as Admin and tried to update the created URL Rewrite for CMS page<h3>Test files</h3>app/code/Magento/UrlRewrite/Test/Mftf/Test/AdminUpdateCmsPageRewriteEntityWithTemporaryRedirectTest.xml<br>")
 * @group cMSContent
 * @group mtf_migrated
 */
class AdminUpdateCmsPageRewriteEntityWithTemporaryRedirectTestCest
{
    /**
	...
	/**
	 * @Stories({"Update CMS Page URL Redirect With Temporary Redirect"})
	 ...
	 * @throws \Exception
	 */
	public function AdminUpdateCmsPageRewriteEntityWithTemporaryRedirectTest(AcceptanceTester $I)
	{
		...
		$I->fillField("//input[@id='request_path']", "temporaryrequestpath.html"); // stepKey: fillRequestPathUpdateUrlRewrite
		$I->click("//select[@id='redirect_type']"); // stepKey: selectRedirectTypeUpdateUrlRewrite
		$I->click("//select[@id='redirect_type']//option[contains(., 'Temporary (302)')]"); // stepKey: selectRedirectTypeValueUpdateUrlRewrite
		$I->fillField("#description", "test description_302"); // stepKey: fillDescriptionUpdateUrlRewrite
		...
		$I->amOnPage("temporaryrequestpath.html"); // stepKey: goToStorefrontNavigateToTheStoreFront
		...
		$I->fillField(".admin__data-grid-filters input[name='request_path']", "temporaryrequestpath.html"); // stepKey: fillRedirectPathFilterDeleteCustomUrlRewrite
