...
/**
 * @Title("MC-10928: Admin should be able to switch a new product from virtual to simple")
 * @Description("After selecting a virtual product when adding Admin should be switch to simple implicitly<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/AdminCreateAndSwitchProductType/AdminCreateVirtualProductSwitchToSimpleTest.xml<br>")
 * @TestCaseId("MC-10928")
 * @group catalog
 * @group mtf_migrated
 */
class AdminCreateVirtualProductSwitchToSimpleTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateVirtualProductSwitchToSimpleTest(AcceptanceTester $I)
	{
		...
		$I->click(".item[data-ui-id='products-list-add-new-product-button-item-virtual']"); // stepKey: clickAddProductOpenProductFillForm
