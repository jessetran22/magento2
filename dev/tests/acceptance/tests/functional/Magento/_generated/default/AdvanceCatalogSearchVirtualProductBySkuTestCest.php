...
/**
 * @Title("MC-162: Guest customer should be able to advance search virtual product with product sku")
 * @Description("Guest customer should be able to advance search virtual product with product sku<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/AdvanceCatalogSearchVirtualProductTest/AdvanceCatalogSearchVirtualProductBySkuTest.xml<br>")
 * @TestCaseId("MC-162")
 * @group Catalog
 */
class AdvanceCatalogSearchVirtualProductBySkuTestCest
{
    /**
	...
	{
		$I->createEntity("product", "hook", "ApiVirtualProductWithDescriptionAndUnderscoredSku", [], []); // stepKey: product
	}
	 ...
	 * @throws \Exception
	 */
	public function AdvanceCatalogSearchVirtualProductBySkuTest(AcceptanceTester $I)
	{
