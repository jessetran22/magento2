...
/**
 * @Title("MAGETWO-92043: Other Payment Methods section in Admin expanded by default")
 * @Description("Other Payment Methods section in Admin expanded by default<h3>Test files</h3>app/code/Magento/Paypal/Test/Mftf/Test/AdminConfigPaymentsSectionStateTest.xml<br>")
 * @TestCaseId("MAGETWO-92043")
 */
class AdminConfigPaymentsSectionStateTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminConfigPaymentsSectionStateTest(AcceptanceTester $I)
	{
		...
		$I->amOnPage((getenv("MAGENTO_BACKEND_BASE_URL") ? rtrim(getenv("MAGENTO_BACKEND_BASE_URL"), "/") : "") . "/" . getenv("MAGENTO_BACKEND_NAME") . "/admin/system_config/edit/section/payment/"); // stepKey: navigateToConfigurationPage
		$I->waitForPageLoad(30); // stepKey: waitForPageLoad1
		$I->seeElement("#payment_us_other_payment_methods-head.open"); // stepKey: seeSectionExpanded
	}
}
