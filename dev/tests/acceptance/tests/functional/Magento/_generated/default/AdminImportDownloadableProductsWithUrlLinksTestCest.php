...
/**
 * @Title("MC-38947: Import Downloadable Products with Url Links")
 * @Description("Imports a .csv file containing a downloadable product with url links. Verifies that             products are imported successfully.<h3>Test files</h3>app/code/Magento/DownloadableImportExport/Test/Mftf/Test/AdminImportDownloadableProductsWithUrlLinksTest.xml<br>")
 * @TestCaseId("MC-38947")
 * @group importExport
 * @group Downloadable
 */
class AdminImportDownloadableProductsWithUrlLinksTestCest
{
    /**
	...
	public function _before(AcceptanceTester $I)
	{
		...
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->createDirectory("var/import/images/import-product-downloadable-url-links", 511); // stepKey: createDirectoryForImportImages
		$I->comment('[copyBaseImage] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::copy()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->copy("dev/tests/acceptance/tests/_data/magento-logo.png", "var/import/images/import-product-downloadable-url-links/magento-logo.png"); // stepKey: copyBaseImage
		$I->comment('[copySmallImage] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::copy()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->copy("dev/tests/acceptance/tests/_data/m-logo.gif", "var/import/images/import-product-downloadable-url-links/m-logo.gif"); // stepKey: copySmallImage
		$I->comment('[copyThumbnailImage] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::copy()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->copy("dev/tests/acceptance/tests/_data/adobe-base.jpg", "var/import/images/import-product-downloadable-url-links/adobe-base.jpg"); // stepKey: copyThumbnailImage
	...
	public function _after(AcceptanceTester $I)
	{
		...
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->deleteDirectory("var/import/images/import-product-downloadable-url-links"); // stepKey: deleteProductImageDirectory
	...
	/**
	 * @Features({"DownloadableImportExport"})
	 ...
	 * @throws \Exception
	 */
	public function AdminImportDownloadableProductsWithUrlLinksTest(AcceptanceTester $I)
	{
