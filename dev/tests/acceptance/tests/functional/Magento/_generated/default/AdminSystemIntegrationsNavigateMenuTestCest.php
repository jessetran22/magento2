...
/**
 * @Title("MC-14149: Admin system integrations navigate menu test")
 * @Description("Admin should be able to navigate to System > Integrations<h3>Test files</h3>app/code/Magento/Integration/Test/Mftf/Test/AdminSystemIntegrationsNavigateMenuTest.xml<br>")
 * @TestCaseId("MC-14149")
 * @group menu
 * @group mtf_migrated
 */
class AdminSystemIntegrationsNavigateMenuTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminSystemIntegrationsNavigateMenuTest(AcceptanceTester $I)
	{
		...
		$I->see("Integrations", ".page-title-wrapper h1"); // stepKey: assertPageTitleSeePageTitle
