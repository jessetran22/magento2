...
/**
 * @Title("MC-18281: Checkout order summary has wrong item count - display items quantities")
 * @Description("Items count in shopping cart and on checkout page should be consistent with settings 'checkout/cart_link/use_qty'<h3>Test files</h3>app/code/Magento/Checkout/Test/Mftf/Test/StorefrontCheckCartAndCheckoutItemsCountTest/StorefrontCartItemsCountDisplayItemsQuantitiesTest.xml<br>")
 * @TestCaseId("MC-18281")
 * @group checkout
 */
class StorefrontCartItemsCountDisplayItemsQuantitiesTestCest
{
    /**
	...
	public function _before(AcceptanceTester $I)
	{
		...
		$setDisplayCartSummary = $I->magentoCLI("config:set checkout/cart_link/use_qty 1", 60); // stepKey: setDisplayCartSummary
	 ...
	 * @throws \Exception
	 */
	public function StorefrontCartItemsCountDisplayItemsQuantitiesTest(AcceptanceTester $I)
	{
		...
		$I->see("3", "//header//div[contains(@class, 'minicart-wrapper')]//a[contains(@class, 'showcart')]//span[@class='counter-number']"); // stepKey: seeProductCountInCartAssertProductCountAndTextInMiniCart
		$I->see("3 Items in Cart", "//div[@class='items-total']"); // stepKey: seeNumberOfItemDisplayInMiniCartAssertProductCountAndTextInMiniCart
		...
		$I->see("3 Items in Cart", "div.items-in-cart div.title"); // stepKey: seeOrderSummaryTextAssertProductCountOnCheckoutPage
		$I->waitForPageLoad(30); // stepKey: seeOrderSummaryTextAssertProductCountOnCheckoutPageWaitForPageLoad
