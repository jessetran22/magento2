...
/**
 * @Title("[NO TESTCASEID]: Create Checkout with purchase order payment method test")
 * @Description("Create Checkout with purchase order payment method<h3>Test files</h3>app/code/Magento/Checkout/Test/Mftf/Test/StorefrontCheckoutWithPurchaseOrderNumberTest.xml<br>")
 * @group checkout
 */
class StorefrontCheckoutWithPurchaseOrderNumberTestCest
{
    /**
	...
	/**
	 * @Features({"Checkout"})
	 * @Stories({"Checkout with Purchase Order Payment"})
	 ...
	 * @throws \Exception
	 */
	public function StorefrontCheckoutWithPurchaseOrderNumberTest(AcceptanceTester $I)
	{
