 ...
 * @Description("Admin should be able to configure the default layout for CMS Page from System Configuration<h3>Test files</h3>app/code/Magento/Cms/Test/Mftf/Test/AdminConfigDefaultCMSPageLayoutFromConfigurationSettingTest.xml<br>")
...
class AdminConfigDefaultCMSPageLayoutFromConfigurationSettingTestCest
{
	...
	public function AdminConfigDefaultCMSPageLayoutFromConfigurationSettingTest(AcceptanceTester $I)
	{
		...
		$I->comment("Entering Action Group [amOnPagePagesGrid] AdminOpenCreateNewCMSPageActionGroup");
		$I->amOnPage((getenv("MAGENTO_BACKEND_BASE_URL") ? rtrim(getenv("MAGENTO_BACKEND_BASE_URL"), "/") : "") . "/" . getenv("MAGENTO_BACKEND_NAME") . "/cms/page/new"); // stepKey: navigateToCreateNewPageAmOnPagePagesGrid
		$I->waitForPageLoad(30); // stepKey: waitForNewPagePageLoadAmOnPagePagesGrid
		$I->comment("Exiting Action Group [amOnPagePagesGrid] AdminOpenCreateNewCMSPageActionGroup");
