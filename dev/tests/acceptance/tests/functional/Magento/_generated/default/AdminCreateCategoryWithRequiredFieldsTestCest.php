 ...
 * @Description("Login as an admin and create a category with required fields.<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/AdminCreateCategoryWithRequiredFieldsTest.xml<br>")
 * @TestCaseId("MC-5265")
 * @group Catalog
 * @group mtf_migrated
 */
