...
/**
 * @Title(": Try to login as a user with an invalid expiration date")
 * @Description("Try to login as a user with an invalid expiration date.<h3>Test files</h3>app/code/Magento/Security/Test/Mftf/Test/AdminLoginAdminUserWithInvalidExpirationTest.xml<br>")
 * @TestCaseId("")
 * @group security
 */
class AdminLoginAdminUserWithInvalidExpirationTestCest
{
    /**
	...
	/**
	 * @Features({"Security"})
	 * @Stories({"Try to login as a user with an invalid expiration date."})
	 ...
	 * @throws \Exception
	 */
	public function AdminLoginAdminUserWithInvalidExpirationTest(AcceptanceTester $I)
	{
