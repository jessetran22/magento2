 ...
 * @Description("Assert items return to stock (partial refund)<h3>Test files</h3>app/code/Magento/Sales/Test/Mftf/Test/AdminCreateCreditMemoPartialRefundTest.xml<br>")
 * @TestCaseId("MC-15861")
 * @group sales
 * @group mtf_migrated
 */
class AdminCreateCreditMemoPartialRefundTestCest
{
	...
	public function AdminCreateCreditMemoPartialRefundTest(AcceptanceTester $I)
	{
		...
		$I->click("table.data-grid tbody > tr:nth-of-type(1)"); // stepKey: openOrderViewPageOpenOrderPage
