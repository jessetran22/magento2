...
/**
 * @Title("MC-10912: Update Customer Address (France) in Storefront")
 * @Description("Test log in to Storefront and Update Customer Address (France) in Storefront<h3>Test files</h3>app/code/Magento/Customer/Test/Mftf/Test/StorefrontUpdateCustomerAddressFranceTest.xml<br>")
 * @TestCaseId("MC-10912")
 * @group customer
 * @group mtf_migrated
 */
class StorefrontUpdateCustomerAddressFranceTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function StorefrontUpdateCustomerAddressFranceTest(AcceptanceTester $I)
	{
		$I->comment("Update customer address France in storefront");
		...
		$I->fillField("#firstname", "Jean"); // stepKey: fillFirstNameEnterAddress
		$I->fillField("#lastname", "Reno"); // stepKey: fillLastNameEnterAddress
		$I->fillField("#company", "Magento"); // stepKey: fillCompanyEnterAddress
		$I->fillField("#telephone", "555-888-111-999"); // stepKey: fillPhoneNumberEnterAddress
		$I->fillField("#street_1", "18-20 Rue Maréchal Lecler"); // stepKey: fillStreetAddress1EnterAddress
		$I->fillField("#street_2", "18-20 Rue Maréchal Lecler"); // stepKey: fillStreetAddress2EnterAddress
		$I->fillField("#city", "Quintin"); // stepKey: fillCityNameEnterAddress
		$I->selectOption("#country", "FR"); // stepKey: selectCountyEnterAddress
		$I->selectOption("#region_id", "Côtes-d'Armor"); // stepKey: selectStateEnterAddress
		...
		$I->comment("Verify customer default billing address");
		$I->see("Jean Reno", ".box-address-billing"); // stepKey: seeAssertCustomerDefaultBillingAddressFirstnameAndLastnameVerifyBillingAddress
		$I->see("Magento", ".box-address-billing"); // stepKey: seeAssertCustomerDefaultBillingAddressCompanyVerifyBillingAddress
		$I->see("18-20 Rue Maréchal Lecler", ".box-address-billing"); // stepKey: seeAssertCustomerDefaultBillingAddressStreetVerifyBillingAddress
		$I->see("18-20 Rue Maréchal Lecler", ".box-address-billing"); // stepKey: seeAssertCustomerDefaultBillingAddressStreet1VerifyBillingAddress
		$I->see("Quintin, Côtes-d'Armor, 12345", ".box-address-billing"); // stepKey: seeAssertCustomerDefaultBillingAddressCityAndPostcodeVerifyBillingAddress
		$I->see("France", ".box-address-billing"); // stepKey: seeAssertCustomerDefaultBillingAddressCountryVerifyBillingAddress
		$I->see("555-888-111-999", ".box-address-billing"); // stepKey: seeAssertCustomerDefaultBillingAddressTelephoneVerifyBillingAddress
		...
		$I->comment("Verify customer default shipping address");
		$I->see("Jean Reno", ".box-address-shipping"); // stepKey: seeAssertCustomerDefaultShippingAddressFirstnameAndLastnameVerifyShippingAddress
		$I->see("Magento", ".box-address-shipping"); // stepKey: seeAssertCustomerDefaultShippingAddressCompanyVerifyShippingAddress
		$I->see("18-20 Rue Maréchal Lecler", ".box-address-shipping"); // stepKey: seeAssertCustomerDefaultShippingAddressStreetVerifyShippingAddress
		$I->see("18-20 Rue Maréchal Lecler", ".box-address-shipping"); // stepKey: seeAssertCustomerDefaultShippingAddressStreet1VerifyShippingAddress
		$I->see("Quintin, Côtes-d'Armor, 12345", ".box-address-shipping"); // stepKey: seeAssertCustomerDefaultShippingAddressCityAndPostcodeVerifyShippingAddress
		$I->see("France", ".box-address-shipping"); // stepKey: seeAssertCustomerDefaultShippingAddressCountryVerifyShippingAddress
		$I->see("555-888-111-999", ".box-address-shipping"); // stepKey: seeAssertCustomerDefaultShippingAddressTelephoneVerifyShippingAddress
