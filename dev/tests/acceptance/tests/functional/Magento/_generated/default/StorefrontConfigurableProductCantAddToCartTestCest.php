...
/**
 * @Title("MC-81: Guest customer should not be able to add the product to the cart if options are not selected")
 * @Description("Guest customer should not be able to add the product to the cart if options are not selected<h3>Test files</h3>app/code/Magento/ConfigurableProduct/Test/Mftf/Test/StorefrontConfigurableProductDetailsTest/StorefrontConfigurableProductCantAddToCartTest.xml<br>")
 * @TestCaseId("MC-81")
 * @group ConfigurableProduct
 */
class StorefrontConfigurableProductCantAddToCartTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function StorefrontConfigurableProductCantAddToCartTest(AcceptanceTester $I)
	{
		$I->comment("Verify not able to add configurable product to cart when no option is selected in storefront product view");
		...
		$I->comment("Entering Action Group [clickAddToCart] StorefrontClickAddToCartButtonOnProductPageActionGroup");
		$I->click("#product-addtocart-button"); // stepKey: addToCartClickAddToCart
		$I->waitForPageLoad(60); // stepKey: addToCartClickAddToCartWaitForPageLoad
		$I->waitForPageLoad(30); // stepKey: waitForAddToCartClickAddToCart
		$I->comment("Exiting Action Group [clickAddToCart] StorefrontClickAddToCartButtonOnProductPageActionGroup");
		$I->comment("Entering Action Group [seeError] AssertStorefrontRequiredFieldErrorMessageForProductOptionActionGroup");
		$I->see("This is a required field", "//div[@class='mage-error']"); // stepKey: seeErrorMessageSeeError
		$I->comment("Exiting Action Group [seeError] AssertStorefrontRequiredFieldErrorMessageForProductOptionActionGroup");
	}
}
