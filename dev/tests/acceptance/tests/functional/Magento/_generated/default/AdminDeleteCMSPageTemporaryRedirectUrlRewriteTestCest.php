 ...
 * @Description("Login as Admin and create custom CMS page UrlRewrite and add Temporary redirect type and delete Temporary redirect URL rewrite<h3>Test files</h3>app/code/Magento/UrlRewrite/Test/Mftf/Test/AdminDeleteCMSPageTemporaryRedirectUrlRewriteTest.xml<br>")
 * @TestCaseId("")
 * @group mtf_migrated
 */
