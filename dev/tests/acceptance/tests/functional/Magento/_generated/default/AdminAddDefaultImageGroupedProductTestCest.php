 ...
 * @Description("Admin should be able to add default images for a Grouped Product<h3>Test files</h3>app/code/Magento/GroupedProduct/Test/Mftf/Test/AdminAddDefaultImageGroupedProductTest.xml<br>")
 * @TestCaseId("MC-106")
...
class AdminAddDefaultImageGroupedProductTestCest
{
	...
	public function _after(AcceptanceTester $I)
	{
		...
		$I->waitForPageLoad(30); // stepKey: clickActionDropdownDeleteGroupedProductWaitForPageLoad
		...
		$I->waitForPageLoad(30); // stepKey: clickDeleteActionDeleteGroupedProductWaitForPageLoad
