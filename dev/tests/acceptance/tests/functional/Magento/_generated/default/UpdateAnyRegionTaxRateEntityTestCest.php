 ...
 * @Description("Test log in to Tax Rate and Update Any Region<h3>Test files</h3>app/code/Magento/Tax/Test/Mftf/Test/UpdateAnyRegionTaxRateEntityTest.xml<br>")
 * @TestCaseId("MC-5331")
 * @group tax
 * @group mtf_migrated
 */
class UpdateAnyRegionTaxRateEntityTestCest
{
	...
	public function UpdateAnyRegionTaxRateEntityTest(AcceptanceTester $I)
	{
		...
		$I->fillField("#tax_rate_grid_filter_code", "TaxRate" . msq("taxRateCustomRateCanada")); // stepKey: fillNameFilterFillTaxIdentifierField3
