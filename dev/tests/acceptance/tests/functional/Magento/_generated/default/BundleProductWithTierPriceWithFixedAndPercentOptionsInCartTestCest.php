...
/**
 * @Title("MC-26543: Customer should get the right subtotal in cart when the bundle product with tier price and bundle items with fixed and percent price added to the cart")
 * @Description("Customer should be able to add bundle product with tier price and bundle items with fixed and percent price to the cart and get the right price<h3>Test files</h3>app/code/Magento/Bundle/Test/Mftf/Test/BundleProductWithTierPriceWithFixedAndPercentOptionsInCartTest.xml<br>")
 * @TestCaseId("MC-26543")
 * @group bundle
 * @group catalog
 */
class BundleProductWithTierPriceWithFixedAndPercentOptionsInCartTestCest
{
    /**
	...
	{
		$createProductForBundleItem1Fields['price'] = "100.00";
		$I->createEntity("createProductForBundleItem1", "hook", "SimpleProduct2", [], $createProductForBundleItem1Fields); // stepKey: createProductForBundleItem1
	 ...
	 * @throws \Exception
	 */
	public function BundleProductWithTierPriceWithFixedAndPercentOptionsInCartTest(AcceptanceTester $I)
	{
		...
		$I->click("div[data-index='sku_type'] .admin__actions-switch-label"); // stepKey: disableDynamicSku
		$I->waitForPageLoad(30); // stepKey: disableDynamicSkuWaitForPageLoad
		...
		$I->fillField("//div[@data-index='price']//input", "100"); // stepKey: fillBundlePrice
		...
		$I->selectOption("bundle_options[bundle_options][0][bundle_selections][0][selection_price_type]", "Percent"); // stepKey: selectPercentPrice
		...
		$I->fillField("[name='bundle_options[bundle_options][1][bundle_selections][0][selection_price_value]']", "100"); // stepKey: fillBundleOption2Price
		...
		$I->assertEquals("$150.00", $grabProductPrice, "ExpectedPrice"); // stepKey: assertBundleProductPrice
		...
		$I->assertEquals("$150.00", $grabTextFromMiniCartSubtotalFieldAssertSubTotalOnStorefrontMiniCart, "Mini shopping cart should contain subtotal $150.00"); // stepKey: assertSubtotalFieldFromMiniShoppingCart1AssertSubTotalOnStorefrontMiniCart
