...
/**
 * @Title("MC-132: Guest customer should be able to advance search simple product with product name")
 * @Description("Guest customer should be able to advance search simple product with product name<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/AdvanceCatalogSearchSimpleProductTest/AdvanceCatalogSearchSimpleProductByNameTest.xml<br>app/code/Magento/CatalogSearch/Test/Mftf/Test/AdvanceCatalogSearchSimpleProductTest/AdvanceCatalogSearchSimpleProductByNameTest.xml<br>")
 * @TestCaseId("MC-132")
 * @group Catalog
 * @group CatalogSearch
 */
class AdvanceCatalogSearchSimpleProductByNameTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdvanceCatalogSearchSimpleProductByNameTest(AcceptanceTester $I)
	{
