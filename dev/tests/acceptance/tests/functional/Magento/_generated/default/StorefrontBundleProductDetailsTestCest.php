 ...
 * @Description("Customer should be able to see basic bundle product details<h3>Test files</h3>app/code/Magento/Bundle/Test/Mftf/Test/StorefrontBundleProductDetailsTest.xml<br>")
 * @TestCaseId("MC-230")
 * @group Bundle
 */
