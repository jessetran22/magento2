 ...
 * @Description("Admin should be able to delete a simple product<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/AdminDeleteSimpleProductTest.xml<br>")
 * @TestCaseId("MC-11013")
 * @group mtf_migrated
 */
