...
/**
 * @Title("MC-3416: Admin should be able to set/edit Related Products information when editing a downloadable product")
 * @Description("Admin should be able to set/edit Related Products information when editing a downloadable product<h3>Test files</h3>app/code/Magento/Downloadable/Test/Mftf/Test/AdminDownloadableSetEditRelatedProductsTest.xml<br>")
 * @TestCaseId("MC-3416")
 * @group Downloadable
 */
class AdminDownloadableSetEditRelatedProductsTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminDownloadableSetEditRelatedProductsTest(AcceptanceTester $I)
	{
