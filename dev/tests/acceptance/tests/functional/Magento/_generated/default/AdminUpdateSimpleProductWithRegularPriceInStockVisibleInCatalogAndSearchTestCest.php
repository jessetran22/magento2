...
/**
 * @Title("MC-10802: Update Simple Product with Regular Price (In Stock) Visible in Catalog and Search")
 * @Description("Test log in to Update Simple Product and Update Simple Product with Regular Price (In Stock) Visible in Catalog and Search<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/AdminUpdateSimpleProductWithRegularPriceInStockVisibleInCatalogAndSearchTest.xml<br>")
 * @TestCaseId("MC-10802")
 * @group catalog
 * @group mtf_migrated
 */
class AdminUpdateSimpleProductWithRegularPriceInStockVisibleInCatalogAndSearchTestCest
{
    /**
	...
	public function _after(AcceptanceTester $I)
	{
		...
		$I->fillField("input.admin__control-text[name='sku']", "test_simple_product_sku" . msq("simpleProductRegularPrice245InStock")); // stepKey: fillProductSkuFilterDeleteCreatedProduct
		...
		$I->see("test_simple_product_sku" . msq("simpleProductRegularPrice245InStock"), "//tr[1]//td[count(//div[@data-role='grid-wrapper']//tr//th[normalize-space(.)='SKU']/preceding-sibling::th) +1 ]"); // stepKey: seeProductSkuInGridDeleteCreatedProduct
	 ...
	 * @throws \Exception
	 */
	public function AdminUpdateSimpleProductWithRegularPriceInStockVisibleInCatalogAndSearchTest(AcceptanceTester $I)
	{
		...
		$I->fillField(".admin__field[data-index=name] input", "TestSimpleProduct" . msq("simpleProductRegularPrice245InStock")); // stepKey: fillSimpleProductName
		$I->fillField(".admin__field[data-index=sku] input", "test_simple_product_sku" . msq("simpleProductRegularPrice245InStock")); // stepKey: fillSimpleProductSku
		...
		$I->fillField("input[name='product[url_key]']", "test-simple-product" . msq("simpleProductRegularPrice245InStock")); // stepKey: fillSimpleProductUrlKey
		...
		$I->fillField("input.admin__control-text[name='name']", "TestSimpleProduct" . msq("simpleProductRegularPrice245InStock")); // stepKey: fillSimpleProductNameInNameFilter
		$I->fillField("input.admin__control-text[name='sku']", "test_simple_product_sku" . msq("simpleProductRegularPrice245InStock")); // stepKey: fillProductSku
		...
		$I->seeInField(".admin__field[data-index=name] input", "TestSimpleProduct" . msq("simpleProductRegularPrice245InStock")); // stepKey: seeSimpleProductName
		$I->seeInField(".admin__field[data-index=sku] input", "test_simple_product_sku" . msq("simpleProductRegularPrice245InStock")); // stepKey: seeSimpleProductSku
		...
		$I->seeInField("input[name='product[url_key]']", "test-simple-product" . msq("simpleProductRegularPrice245InStock")); // stepKey: seeUrlKey
		...
		$I->see("TestSimpleProduct" . msq("simpleProductRegularPrice245InStock"), "a.product-item-link"); // stepKey: seeSimpleProductNameOnCategoryPage
		...
		$I->amOnPage("/test-simple-product" . msq("simpleProductRegularPrice245InStock") . ".html"); // stepKey: amOnProductPageGoToProductPage
		...
		$I->see("TestSimpleProduct" . msq("simpleProductRegularPrice245InStock"), ".base"); // stepKey: seeProductNameSeeSimpleProductNameOnStoreFrontPage
		...
		$I->see("245.00", ".product-info-main [data-price-type='finalPrice']"); // stepKey: seeProductPriceSeeSimpleProductPriceOnStoreFrontPage
		...
		$I->see("test_simple_product_sku" . msq("simpleProductRegularPrice245InStock"), ".product.attribute.sku>.value"); // stepKey: seeProductSkuSeeSimpleProductSkuOnStoreFrontPage
		...
		$I->amOnPage("/test-simple-product" . msq("simpleProductRegularPrice245InStock") . ".html"); // stepKey: goToMagentoStorefrontPage
		...
		$I->fillField("#search", "test_simple_product_sku" . msq("simpleProductRegularPrice245InStock")); // stepKey: fillInputFillSimpleProductSkuInSearchTextBox
		...
		$I->seeInTitle("Search results for: 'test_simple_product_sku" . msq("simpleProductRegularPrice245InStock") . "'"); // stepKey: assertQuickSearchTitleFillSimpleProductSkuInSearchTextBox
		$I->see("Search results for: 'test_simple_product_sku" . msq("simpleProductRegularPrice245InStock") . "'", ".page-title span"); // stepKey: assertQuickSearchNameFillSimpleProductSkuInSearchTextBox
		$I->comment("Exiting Action Group [fillSimpleProductSkuInSearchTextBox] StorefrontCheckQuickSearchStringActionGroup");
		$I->comment("Comment is added to preserve the step key for backward compatibility");
		$I->comment("Comment is added to preserve the step key for backward compatibility");
		$I->comment("Comment is added to preserve the step key for backward compatibility");
		$I->comment("Entering Action Group [seeSimpleProductNameOnStorefrontPage] StorefrontAssertProductNameOnProductMainPageActionGroup");
		$I->waitForPageLoad(30); // stepKey: waitForTheProductPageToLoadSeeSimpleProductNameOnStorefrontPage
		$I->see("TestSimpleProduct" . msq("simpleProductRegularPrice245InStock"), ".product-item-name"); // stepKey: seeProductNameSeeSimpleProductNameOnStorefrontPage
		$I->comment("Exiting Action Group [seeSimpleProductNameOnStorefrontPage] StorefrontAssertProductNameOnProductMainPageActionGroup");
	}
}
