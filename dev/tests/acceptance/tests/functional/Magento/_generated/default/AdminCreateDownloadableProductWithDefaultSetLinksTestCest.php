...
/**
 * @Title("MC-14507: Create downloadable product with default set links")
 * @Description("Admin should be able to create downloadable product with default set links<h3>Test files</h3>app/code/Magento/Downloadable/Test/Mftf/Test/AdminCreateDownloadableProductWithDefaultSetLinksTest.xml<br>")
 * @TestCaseId("MC-14507")
 * @group Downloadable
 * @group mtf_migrated
 */
class AdminCreateDownloadableProductWithDefaultSetLinksTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateDownloadableProductWithDefaultSetLinksTest(AcceptanceTester $I)
	{
		...
		$I->comment("See product links in storefront product page");
		...
		$I->comment("Assert product in stock");
