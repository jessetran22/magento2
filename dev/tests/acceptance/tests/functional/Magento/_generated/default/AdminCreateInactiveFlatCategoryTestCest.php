...
/**
 * @Title("MC-11007: Flat Catalog - Create Category as Inactive, Should Not be Visible on Storefront")
 * @Description("Login as admin and create flat Inactive category and verify category is not visible in store front<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/AdminCreateInactiveFlatCategoryTest.xml<br>")
 * @TestCaseId("MC-11007")
 * @group mtf_migrated
 */
class AdminCreateInactiveFlatCategoryTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateInactiveFlatCategoryTest(AcceptanceTester $I)
	{
		...
		$I->click("input[name='is_active']+label"); // stepKey: disableActiveCategory
		...
		$I->dontSeeCheckboxIsChecked("input[name='is_active']+label"); // stepKey: verifyInactiveIncludeInMenu
		...
		$I->seeElement("//h1[@class='page-title']//span[contains(., 'Whoops, our bad...')]"); // stepKey: seeWhoopsOurBadMessage1
	}
}
