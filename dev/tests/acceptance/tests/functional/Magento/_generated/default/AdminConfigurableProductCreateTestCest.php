...
/**
 * @Title("MC-84: admin should be able to create a configurable product with attributes")
 * @Description("admin should be able to create a configurable product with attributes<h3>Test files</h3>app/code/Magento/ConfigurableProduct/Test/Mftf/Test/AdminConfigurableProductCreateTest/AdminConfigurableProductCreateTest.xml<br>")
 * @TestCaseId("MC-84")
 * @group ConfigurableProduct
 */
class AdminConfigurableProductCreateTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminConfigurableProductCreateTest(AcceptanceTester $I)
	{
		...
		$I->comment("assert color configurations on the admin create product page");
		$I->dontSee("//div[@data-index='configurable-matrix']/label"); // stepKey: seeLabelNotVisible
		$I->seeNumberOfElements(".data-row", "3"); // stepKey: seeNumberOfRows
		$I->comment("Entering Action Group [seeAttributeName1InField] AssertAdminChildProductDataOnParentProductEditPageActionGroup");
		$I->see("White" . msq("colorProductAttribute1"), ".admin__control-fields[data-index='name_container']"); // stepKey: seeChildProductDataSeeAttributeName1InField
		$I->comment("Exiting Action Group [seeAttributeName1InField] AssertAdminChildProductDataOnParentProductEditPageActionGroup");
		$I->comment("Entering Action Group [seeAttributeName2InField] AssertAdminChildProductDataOnParentProductEditPageActionGroup");
		$I->see("Red" . msq("colorProductAttribute2"), ".admin__control-fields[data-index='name_container']"); // stepKey: seeChildProductDataSeeAttributeName2InField
		$I->comment("Exiting Action Group [seeAttributeName2InField] AssertAdminChildProductDataOnParentProductEditPageActionGroup");
		$I->comment("Entering Action Group [seeAttributeName3InField] AssertAdminChildProductDataOnParentProductEditPageActionGroup");
		$I->see("Blue" . msq("colorProductAttribute3"), ".admin__control-fields[data-index='name_container']"); // stepKey: seeChildProductDataSeeAttributeName3InField
		$I->comment("Exiting Action Group [seeAttributeName3InField] AssertAdminChildProductDataOnParentProductEditPageActionGroup");
		$I->comment("Entering Action Group [seeAttributeSku1InField] AssertAdminChildProductDataOnParentProductEditPageActionGroup");
		$I->see("White" . msq("colorProductAttribute1"), ".admin__control-fields[data-index='sku_container']"); // stepKey: seeChildProductDataSeeAttributeSku1InField
		$I->comment("Exiting Action Group [seeAttributeSku1InField] AssertAdminChildProductDataOnParentProductEditPageActionGroup");
		$I->comment("Entering Action Group [seeAttributeSku2InField] AssertAdminChildProductDataOnParentProductEditPageActionGroup");
		$I->see("Red" . msq("colorProductAttribute2"), ".admin__control-fields[data-index='sku_container']"); // stepKey: seeChildProductDataSeeAttributeSku2InField
		$I->comment("Exiting Action Group [seeAttributeSku2InField] AssertAdminChildProductDataOnParentProductEditPageActionGroup");
		$I->comment("Entering Action Group [seeAttributeSku3InField] AssertAdminChildProductDataOnParentProductEditPageActionGroup");
		$I->see("Blue" . msq("colorProductAttribute3"), ".admin__control-fields[data-index='sku_container']"); // stepKey: seeChildProductDataSeeAttributeSku3InField
		$I->comment("Exiting Action Group [seeAttributeSku3InField] AssertAdminChildProductDataOnParentProductEditPageActionGroup");
		$I->comment("Entering Action Group [seeUniquePrice1InField] AssertAdminChildProductDataOnParentProductEditPageActionGroup");
		$I->see("1.00", ".admin__control-fields[data-index='price_container']"); // stepKey: seeChildProductDataSeeUniquePrice1InField
		$I->comment("Exiting Action Group [seeUniquePrice1InField] AssertAdminChildProductDataOnParentProductEditPageActionGroup");
		$I->comment("Entering Action Group [seeUniquePrice2InField] AssertAdminChildProductDataOnParentProductEditPageActionGroup");
		$I->see("2.00", ".admin__control-fields[data-index='price_container']"); // stepKey: seeChildProductDataSeeUniquePrice2InField
		$I->comment("Exiting Action Group [seeUniquePrice2InField] AssertAdminChildProductDataOnParentProductEditPageActionGroup");
		$I->comment("Entering Action Group [seeUniquePrice3InField] AssertAdminChildProductDataOnParentProductEditPageActionGroup");
		$I->see("3.00", ".admin__control-fields[data-index='price_container']"); // stepKey: seeChildProductDataSeeUniquePrice3InField
		$I->comment("Exiting Action Group [seeUniquePrice3InField] AssertAdminChildProductDataOnParentProductEditPageActionGroup");
		$I->comment("Entering Action Group [seeQuantityInField] AssertAdminChildProductDataOnParentProductEditPageActionGroup");
		$I->see("1", ".admin__control-fields[data-index='quantity_container']"); // stepKey: seeChildProductDataSeeQuantityInField
		$I->comment("Exiting Action Group [seeQuantityInField] AssertAdminChildProductDataOnParentProductEditPageActionGroup");
		...
		$I->comment("Comment is added to preserve the step key for backward compatibility");
		$I->comment("Entering Action Group [clickOnCategoryName] StorefrontGoToCategoryPageActionGroup");
		$I->amOnPage("/"); // stepKey: onFrontendClickOnCategoryName
		$I->waitForPageLoad(30); // stepKey: waitForStorefrontPageLoadClickOnCategoryName
		$I->click("//nav//a[span[contains(., '" . $I->retrieveEntityField('createCategory', 'name', 'test') . "')]]"); // stepKey: toCategoryClickOnCategoryName
		$I->waitForPageLoad(30); // stepKey: toCategoryClickOnCategoryNameWaitForPageLoad
		$I->waitForPageLoad(30); // stepKey: waitForCategoryPageClickOnCategoryName
		$I->comment("Exiting Action Group [clickOnCategoryName] StorefrontGoToCategoryPageActionGroup");
		$I->comment("Comment is added to preserve the step key for backward compatibility");
		$I->comment("Entering Action Group [assertProductPresent] AssertStorefrontProductIsPresentOnCategoryPageActionGroup");
		$I->waitForElementVisible("//main//li//a[contains(text(), 'testProductName" . msq("_defaultProduct") . "')]", 30); // stepKey: assertProductNameAssertProductPresent
		$I->comment("Exiting Action Group [assertProductPresent] AssertStorefrontProductIsPresentOnCategoryPageActionGroup");
		$I->comment("Entering Action Group [assertProductPricePresent] StorefrontAssertProductPriceOnCategoryPageActionGroup");
		$I->see("1.00", "//main//li[.//a[contains(text(), 'testProductName" . msq("_defaultProduct") . "')]]//span[@class='price']"); // stepKey: seeProductPriceAssertProductPricePresent
		$I->comment("Exiting Action Group [assertProductPricePresent] StorefrontAssertProductPriceOnCategoryPageActionGroup");
		$I->comment("assert storefront product details page");
		$I->comment("Comment is added to preserve the step key for backward compatibility");
		$I->comment("Comment is added to preserve the step key for backward compatibility");
		$I->comment("Entering Action Group [assertProductNameTitle] AssertProductNameAndSkuInStorefrontProductPageActionGroup");
		$I->comment("Go to storefront product page, assert product name and sku");
		$I->amOnPage("testproductname" . msq("_defaultProduct") . ".html"); // stepKey: navigateToProductPageAssertProductNameTitle
		$I->waitForPageLoad(30); // stepKey: waitForPageLoad2AssertProductNameTitle
		$I->seeInTitle("testProductName" . msq("_defaultProduct")); // stepKey: assertProductNameTitleAssertProductNameTitle
		$I->see("testProductName" . msq("_defaultProduct"), ".base"); // stepKey: assertProductNameAssertProductNameTitle
		$I->see("testSku" . msq("_defaultProduct"), ".product.attribute.sku>.value"); // stepKey: assertProductSkuAssertProductNameTitle
		$I->comment("Exiting Action Group [assertProductNameTitle] AssertProductNameAndSkuInStorefrontProductPageActionGroup");
		$I->comment("Comment is added to preserve the step key for backward compatibility");
		$I->comment("Entering Action Group [assertProductPrice] StorefrontAssertProductPriceOnProductPageActionGroup");
		$I->see("1.00", ".product-info-main [data-price-type='finalPrice']"); // stepKey: seeProductPriceAssertProductPrice
		$I->comment("Exiting Action Group [assertProductPrice] StorefrontAssertProductPriceOnProductPageActionGroup");
		$I->comment("Comment is added to preserve the step key for backward compatibility");
		$I->comment("Entering Action Group [seeColorAttributeName1] AssertStorefrontProductAttributeLabelVisibleActionGroup");
		$I->see("Color" . msq("colorProductAttribute"), "#product-options-wrapper div[tabindex='0'] label"); // stepKey: seeProductAttributeLabelSeeColorAttributeName1
		$I->comment("Exiting Action Group [seeColorAttributeName1] AssertStorefrontProductAttributeLabelVisibleActionGroup");
		$I->comment("Entering Action Group [seeInDropDown1] AssertStorefrontProductAttributeOptionVisibleActionGroup");
		$I->see("White" . msq("colorProductAttribute1"), "#product-options-wrapper div[tabindex='0'] option"); // stepKey: seeProductAttributeOptionSeeInDropDown1
		$I->comment("Exiting Action Group [seeInDropDown1] AssertStorefrontProductAttributeOptionVisibleActionGroup");
		$I->comment("Entering Action Group [seeInDropDown2] AssertStorefrontProductAttributeOptionVisibleActionGroup");
		$I->see("Red" . msq("colorProductAttribute2"), "#product-options-wrapper div[tabindex='0'] option"); // stepKey: seeProductAttributeOptionSeeInDropDown2
		$I->comment("Exiting Action Group [seeInDropDown2] AssertStorefrontProductAttributeOptionVisibleActionGroup");
		$I->comment("Entering Action Group [seeInDropDown3] AssertStorefrontProductAttributeOptionVisibleActionGroup");
		$I->see("Blue" . msq("colorProductAttribute3"), "#product-options-wrapper div[tabindex='0'] option"); // stepKey: seeProductAttributeOptionSeeInDropDown3
		$I->comment("Exiting Action Group [seeInDropDown3] AssertStorefrontProductAttributeOptionVisibleActionGroup");
	}
}
