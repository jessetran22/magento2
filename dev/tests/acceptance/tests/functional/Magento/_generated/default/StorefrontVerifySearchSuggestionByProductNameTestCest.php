...
/**
 * @Title("MC-14763: Create search query using product name and verify search suggestions")
 * @Description("Storefront search by product name and verify dropdown product search suggestions<h3>Test files</h3>app/code/Magento/Search/Test/Mftf/Test/StorefrontVerifySearchSuggestionByProductNameTest.xml<br>")
 * @TestCaseId("MC-14763")
 * @group mtf_migrated
 */
class StorefrontVerifySearchSuggestionByProductNameTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function StorefrontVerifySearchSuggestionByProductNameTest(AcceptanceTester $I)
	{
		...
		$I->see($I->retrieveEntityField('simpleProduct', 'name', 'test'), "//div[@id='search_autocomplete']/ul/li/span"); // stepKey: seeDropDownSuggestionSeeDropDownSearchSuggestion
		$I->click("//div[@id='search_autocomplete']//span[contains(., '" . $I->retrieveEntityField('simpleProduct', 'name', 'test') . "')]"); // stepKey: clickOnSearchSuggestionSeeDropDownSearchSuggestion
