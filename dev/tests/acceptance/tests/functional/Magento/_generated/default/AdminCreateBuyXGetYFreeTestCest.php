...
/**
 * @Title("MC-73: Admin should be able to create a cart price rule of type Buy X get Y free")
 * @Description("Admin should be able to create a cart price rule of type Buy X get Y free<h3>Test files</h3>app/code/Magento/SalesRule/Test/Mftf/Test/AdminCreateBuyXGetYFreeTest.xml<br>")
 * @TestCaseId("MC-73")
 * @group SalesRule
 */
class AdminCreateBuyXGetYFreeTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateBuyXGetYFreeTest(AcceptanceTester $I)
	{
		...
		$I->amOnPage("testproductname" . msq("_defaultProduct") . ".html"); // stepKey: goToProductPageVerifyStorefront
		$I->waitForPageLoad(30); // stepKey: waitForProductPageLoadVerifyStorefront
		$I->fillField("#qty", "2"); // stepKey: fillQuantityVerifyStorefront
		...
		$I->see("-$123.00", "td[data-th='Discount']"); // stepKey: seeDiscountTotalVerifyStorefront
