...
/**
 * @Title("MC-77: Guest customer should see basic Configurable Product details")
 * @Description("Guest customer should see basic Configurable Product details<h3>Test files</h3>app/code/Magento/ConfigurableProduct/Test/Mftf/Test/StorefrontConfigurableProductDetailsTest/StorefrontConfigurableProductBasicInfoTest.xml<br>")
 * @TestCaseId("MC-77")
 * @group ConfigurableProduct
 */
class StorefrontConfigurableProductBasicInfoTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function StorefrontConfigurableProductBasicInfoTest(AcceptanceTester $I)
	{
		$I->comment("Verify configurable product details in storefront product view");
		$I->comment("Entering Action Group [amOnConfigurableProductPage] StorefrontOpenProductPageActionGroup");
		$I->amOnPage("/testproductname" . msq("_defaultProduct") . ".html"); // stepKey: openProductPageAmOnConfigurableProductPage
		$I->waitForPageLoad(30); // stepKey: waitForProductPageLoadedAmOnConfigurableProductPage
		$I->comment("Exiting Action Group [amOnConfigurableProductPage] StorefrontOpenProductPageActionGroup");
		...
		$I->see("testSku" . msq("_defaultProduct"), ".product.attribute.sku>.value"); // stepKey: seeProductSkuSeeProductSku
		$I->comment("Exiting Action Group [seeProductSku] StorefrontAssertProductSkuOnProductPageActionGroup");
		$I->see("As low as", ".price-label"); // stepKey: seeProductPriceLabel
		$I->comment("Entering Action Group [seeProductStockStatus] AssertStorefrontProductStockStatusOnProductPageActionGroup");
		$I->see("In Stock", ".stock[title=Availability]>span"); // stepKey: seeProductStockStatusSeeProductStockStatus
		$I->comment("Exiting Action Group [seeProductStockStatus] AssertStorefrontProductStockStatusOnProductPageActionGroup");
		$I->comment("Entering Action Group [seeProductPrice] StorefrontAssertProductPriceOnProductPageActionGroup");
		$I->see("1.00", ".product-info-main [data-price-type='finalPrice']"); // stepKey: seeProductPriceSeeProductPrice
		$I->comment("Exiting Action Group [seeProductPrice] StorefrontAssertProductPriceOnProductPageActionGroup");
		$I->comment("Entering Action Group [seeProductAttributeTitle] AssertStorefrontProductAttributeLabelVisibleActionGroup");
		$I->see("Color" . msq("colorProductAttribute"), "#product-options-wrapper div[tabindex='0'] label"); // stepKey: seeProductAttributeLabelSeeProductAttributeTitle
		$I->comment("Exiting Action Group [seeProductAttributeTitle] AssertStorefrontProductAttributeLabelVisibleActionGroup");
		$I->comment("Comment is added to preserve the step key for backward compatibility");
