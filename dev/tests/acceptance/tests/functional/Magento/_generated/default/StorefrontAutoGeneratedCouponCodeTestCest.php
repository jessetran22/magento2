 ...
 * @Description("[Cart Price Rule] Auto generated coupon code considers 'Uses per Coupon' and 'Uses per Customer' options<h3>Test files</h3>app/code/Magento/SalesRule/Test/Mftf/Test/StorefrontAutoGeneratedCouponCodeTest.xml<br>")
...
class StorefrontAutoGeneratedCouponCodeTestCest
{
	...
	public function StorefrontAutoGeneratedCouponCodeTest(AcceptanceTester $I)
	{
		...
		$I->comment("Start the usage processing consumer");
		$I->comment("Entering Action Group [startUsageProcessingMessageQueue1] CliConsumerStartActionGroup");
		$startMessageQueueStartUsageProcessingMessageQueue1 = $I->magentoCLI("queue:consumers:start sales.rule.update.coupon.usage --max-messages=10", 60); // stepKey: startMessageQueueStartUsageProcessingMessageQueue1
		$I->comment($startMessageQueueStartUsageProcessingMessageQueue1);
		$I->comment("Exiting Action Group [startUsageProcessingMessageQueue1] CliConsumerStartActionGroup");
		$I->comment("Step: 9-10. Open the Product Page, add the product to Cart, go to Shopping Cart and Apply the same coupon code");
		$I->amOnPage("/" . $I->retrieveEntityField('createSimpleProduct', 'custom_attributes[url_key]', 'test') . ".html"); // stepKey: openProductPage1
		...
		$I->amOnPage("/" . $I->retrieveEntityField('createSimpleProduct', 'custom_attributes[url_key]', 'test') . ".html"); // stepKey: openProductPage2
		...
		$I->comment("Entering Action Group [clickProceedToCheckout1] StorefrontClickProceedToCheckoutActionGroup");
		$I->click(".action.primary.checkout span"); // stepKey: goToCheckoutClickProceedToCheckout1
		$I->waitForPageLoad(30); // stepKey: goToCheckoutClickProceedToCheckout1WaitForPageLoad
		$I->waitForPageLoad(30); // stepKey: waitForPageToLoadClickProceedToCheckout1
		$I->comment("Exiting Action Group [clickProceedToCheckout1] StorefrontClickProceedToCheckoutActionGroup");
		...
		$I->comment("Start the usage processing consumer");
		$I->comment("Entering Action Group [startUsageProcessingMessageQueue2] CliConsumerStartActionGroup");
		$startMessageQueueStartUsageProcessingMessageQueue2 = $I->magentoCLI("queue:consumers:start sales.rule.update.coupon.usage --max-messages=10", 60); // stepKey: startMessageQueueStartUsageProcessingMessageQueue2
		$I->comment($startMessageQueueStartUsageProcessingMessageQueue2);
		$I->comment("Exiting Action Group [startUsageProcessingMessageQueue2] CliConsumerStartActionGroup");
		$I->comment("Step; 15-16. Open the Product Page, add the product to Cart, go to Shopping Cart and Apply the same coupon code");
		$I->amOnPage("/" . $I->retrieveEntityField('createSimpleProduct', 'custom_attributes[url_key]', 'test') . ".html"); // stepKey: openProductPage3
		...
		$I->amOnPage("/" . $I->retrieveEntityField('createSimpleProduct', 'custom_attributes[url_key]', 'test') . ".html"); // stepKey: openProductPage4
