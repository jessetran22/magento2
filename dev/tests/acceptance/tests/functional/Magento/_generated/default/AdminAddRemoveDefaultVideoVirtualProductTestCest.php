 ...
 * @Description("Admin should be able to add/remove default product video for a Virtual Product<h3>Test files</h3>app/code/Magento/ProductVideo/Test/Mftf/Test/AdminAddRemoveDefaultVideoVirtualProductTest.xml<br>")
 * @TestCaseId("MC-109")
 * @group catalog
 * @group productVideo
 */
