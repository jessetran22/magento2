 ...
 * @Description("Admin should be able to navigate to Sales > Orders<h3>Test files</h3>app/code/Magento/Sales/Test/Mftf/Test/AdminSalesOrdersNavigateMenuTest.xml<br>")
 * @TestCaseId("MC-14137")
 * @group menu
 * @group mtf_migrated
 */
