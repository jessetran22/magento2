...
/**
 * @Title("MC-34033: Swatch option should show the tier price on product page")
 * @Description("Configurable product with swatch attribute should show the tier price on product page<h3>Test files</h3>app/code/Magento/Swatches/Test/Mftf/Test/StorefrontConfigurableProductSwatchTierPriceTest.xml<br>")
 * @TestCaseId("MC-34033")
 * @group Swatches
 */
class StorefrontConfigurableProductSwatchTierPriceTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function StorefrontConfigurableProductSwatchTierPriceTest(AcceptanceTester $I)
	{
		...
		$I->comment("Generate configurations for configurable product");
		...
		$I->comment("Set Tier Price to one of configuration product");
		...
		$I->comment("Select White configuration");
		...
		$I->comment("Assert tier price on selected configuration");
