...
/**
 * @Title("MAGETWO-94814: Add new default billing/shipping customer address")
 * @Description("Add new default billing/shipping customer address on customer addresses tab<h3>Test files</h3>app/code/Magento/Customer/Test/Mftf/Test/AdminAddNewDefaultBillingShippingCustomerAddressTest.xml<br>")
 * @TestCaseId("MAGETWO-94814")
 * @group customer
 */
class AdminAddNewDefaultBillingShippingCustomerAddressTestCest
{
	/**
	...
	/**
	 * @Stories({"Add new default billing/shipping customer address"})
	 ...
	 * @throws \Exception
	 */
	public function AdminAddNewDefaultBillingShippingCustomerAddressTest(AcceptanceTester $I)
	{
		$I->comment("-
		...
		$I->seeElement("//div[@class='customer-default-billing-address-content']//address//span"); // stepKey: seeDefaultBillingAddressSectionBeforeChangingDefaultAddress
		$I->see("The customer does not have default billing address", "//div[@class='customer-default-billing-address-content']//address//span"); // stepKey: assertThereIsNoDefaultBillingAddressSet
		$I->seeElement("//div[@class='customer-default-shipping-address-content']//address//span"); // stepKey: seeDefaultShippingAddressSectionBeforeChangingDefaultAddress
		$I->see("The customer does not have default shipping address", "//div[@class='customer-default-shipping-address-content']//address//span"); // stepKey: assertThereIsNoDefaultShippingAddressSet
