...
/**
 * @Title("MAGETWO-29398: Admin should be able to switch a new product from simple to configurable")
 * @Description("After selecting a simple product when adding Admin should be switch to configurable implicitly<h3>Test files</h3>app/code/Magento/ConfigurableProduct/Test/Mftf/Test/AdminCreateAndSwitchProductType/AdminCreateSimpleProductSwitchToConfigurableTest.xml<br>")
 * @TestCaseId("MAGETWO-29398")
 * @group catalog
 */
class AdminCreateSimpleProductSwitchToConfigurableTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateSimpleProductSwitchToConfigurableTest(AcceptanceTester $I)
	{
		...
		$I->comment("Create configurable product from simple product page");
		$I->comment("Create configurable product");
		$I->comment("Verify product on store front");
		$I->comment("Verify product on store front");
	}
}
