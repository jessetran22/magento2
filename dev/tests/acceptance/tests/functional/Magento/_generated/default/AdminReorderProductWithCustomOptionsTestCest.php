...
/**
 * @Title("MC-42974: Make reorder as Admin")
 * @Description("Make reorder as admin on admin order page with simple product custom options<h3>Test files</h3>app/code/Magento/Sales/Test/Mftf/Test/AdminReorderProductWithCustomOptionsTest.xml<br>")
 * @TestCaseId("MC-42974")
 * @group sales
 */
class AdminReorderProductWithCustomOptionsTestCest
{
    /**
	...
	/**
	 * @Stories({"Admin reorder product with custom options"})
	 ...
	 * @throws \Exception
	 */
	public function AdminReorderProductWithCustomOptionsTest(AcceptanceTester $I)
	{
		...
		$I->comment("Entering Action Group [adminOpenOrderById] OpenOrderByIdActionGroup");
		$I->amOnPage((getenv("MAGENTO_BACKEND_BASE_URL") ? rtrim(getenv("MAGENTO_BACKEND_BASE_URL"), "/") : "") . "/" . getenv("MAGENTO_BACKEND_NAME") . "/sales/order/"); // stepKey: navigateToOrderGridPageAdminOpenOrderById
		$I->waitForPageLoad(30); // stepKey: waitForOrdersPageAdminOpenOrderById
		$I->conditionalClick(".admin__data-grid-header [data-action='grid-filter-reset']", ".admin__data-grid-header [data-action='grid-filter-reset']", true); // stepKey: clearExistingOrderFiltersAdminOpenOrderById
		$I->waitForPageLoad(30); // stepKey: clearExistingOrderFiltersAdminOpenOrderByIdWaitForPageLoad
		$I->waitForPageLoad(30); // stepKey: waitForClearFiltersAdminOpenOrderById
		$I->click("button[data-action='grid-filter-expand']"); // stepKey: openOrderGridFiltersAdminOpenOrderById
		$I->waitForPageLoad(30); // stepKey: openOrderGridFiltersAdminOpenOrderByIdWaitForPageLoad
		$I->waitForPageLoad(30); // stepKey: waitForClickFiltersAdminOpenOrderById
		$I->fillField(".admin__data-grid-filters input[name='increment_id']", $grabOrderNumber); // stepKey: fillOrderIdFilterAdminOpenOrderById
		$I->click("button[data-action='grid-filter-apply']"); // stepKey: clickOrderApplyFiltersAdminOpenOrderById
		$I->waitForPageLoad(30); // stepKey: clickOrderApplyFiltersAdminOpenOrderByIdWaitForPageLoad
		$I->click("table.data-grid tbody > tr:nth-of-type(1)"); // stepKey: openOrderViewPageAdminOpenOrderById
		$I->waitForPageLoad(60); // stepKey: openOrderViewPageAdminOpenOrderByIdWaitForPageLoad
		$I->waitForPageLoad(30); // stepKey: waitForOrderViewPageOpenedAdminOpenOrderById
		$I->waitForPageLoad(30); // stepKey: waitForApplyFiltersAdminOpenOrderById
		$I->comment("Exiting Action Group [adminOpenOrderById] OpenOrderByIdActionGroup");
		$I->comment("Entering Action Group [adminStartReorder] AdminStartReorderFromOrderPageActionGroup");
		$I->click("#order_reorder"); // stepKey: clickReorderAdminStartReorder
		$I->waitForPageLoad(30); // stepKey: clickReorderAdminStartReorderWaitForPageLoad
		$I->waitForPageLoad(30); // stepKey: waitPageLoadAdminStartReorder
		$I->waitForElementVisible(".page-header h1.page-title", 30); // stepKey: waitForPageTitleAdminStartReorder
		$I->see("Create New Order", ".page-header h1.page-title"); // stepKey: seeCreateNewOrderPageTitleAdminStartReorder
		$I->comment("Exiting Action Group [adminStartReorder] AdminStartReorderFromOrderPageActionGroup");
		$I->comment("Entering Action Group [adminSubmitOrder] AdminSubmitOrderActionGroup");
		$I->scrollTo("#submit_order_top_button"); // stepKey: scrollToSubmitButtonAdminSubmitOrder
		$I->waitForPageLoad(60); // stepKey: scrollToSubmitButtonAdminSubmitOrderWaitForPageLoad
		$I->click("#submit_order_top_button"); // stepKey: submitOrderAdminSubmitOrder
		$I->waitForPageLoad(60); // stepKey: submitOrderAdminSubmitOrderWaitForPageLoad
		$I->waitForPageLoad(30); // stepKey: waitForPageLoadAdminSubmitOrder
		$I->see("You created the order."); // stepKey: seeSuccessMessageForOrderAdminSubmitOrder
		$I->comment("Exiting Action Group [adminSubmitOrder] AdminSubmitOrderActionGroup");
