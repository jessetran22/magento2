...
/**
 * @Title("MC-14509: Create downloadable product with out of stock status test")
 * @Description("Admin should be able to create downloadable product with out of stock status<h3>Test files</h3>app/code/Magento/Downloadable/Test/Mftf/Test/AdminCreateDownloadableProductWithOutOfStockStatusTest.xml<br>")
 * @TestCaseId("MC-14509")
 * @group Downloadable
 * @group mtf_migrated
 */
class AdminCreateDownloadableProductWithOutOfStockStatusTestCest
{
    /**
	...
	public function _after(AcceptanceTester $I)
	{
		...
		$I->fillField("input.admin__control-text[name='sku']", "downloadableoutofstockproduct" . msq("DownloadableProductOutOfStock")); // stepKey: fillProductSkuFilterDeleteProduct
		$I->fillField("input.admin__control-text[name='name']", "DownloadableProduct" . msq("DownloadableProductOutOfStock")); // stepKey: fillProductNameFilterDeleteProduct
		...
		$I->see("downloadableoutofstockproduct" . msq("DownloadableProductOutOfStock"), "//tr[1]//td[count(//div[@data-role='grid-wrapper']//tr//th[normalize-space(.)='SKU']/preceding-sibling::th) +1 ]"); // stepKey: seeProductSkuInGridDeleteProduct
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateDownloadableProductWithOutOfStockStatusTest(AcceptanceTester $I)
	{
		...
		$I->fillField(".admin__field[data-index=name] input", "DownloadableProduct" . msq("DownloadableProductOutOfStock")); // stepKey: fillProductNameFillDownloadableProductForm
		$I->fillField(".admin__field[data-index=sku] input", "downloadableoutofstockproduct" . msq("DownloadableProductOutOfStock")); // stepKey: fillProductSkuFillDownloadableProductForm
		...
		$I->selectOption("select[name='product[quantity_and_stock_status][is_in_stock]']", "0"); // stepKey: selectStockStatusFillDownloadableProductForm
		...
		$I->comment("Assert product is out of stock");
		$I->amOnPage("downloadableproduct" . msq("DownloadableProductOutOfStock") . ".html"); // stepKey: navigateToProductPage
		...
		$I->fillField("input.admin__control-text[name='sku']", "downloadableoutofstockproduct" . msq("DownloadableProductOutOfStock")); // stepKey: fillProductSkuFilterFindCreatedConfigurableProduct
