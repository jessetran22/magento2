...
/**
 * @Title("MC-5345: Create custom URL rewrite, CMS permanent")
 * @Description("Login as Admin and create custom CMS page UrlRewrite and add Permanent redirect type<h3>Test files</h3>app/code/Magento/UrlRewrite/Test/Mftf/Test/AdminCreateCustomCMSPageUrlRewriteAndAddPermanentRedirectTest.xml<br>")
 * @TestCaseId("MC-5345")
 * @group mtf_migrated
 */
class AdminCreateCustomCMSPageUrlRewriteAndAddPermanentRedirectTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateCustomCMSPageUrlRewriteAndAddPermanentRedirectTest(AcceptanceTester $I)
	{
