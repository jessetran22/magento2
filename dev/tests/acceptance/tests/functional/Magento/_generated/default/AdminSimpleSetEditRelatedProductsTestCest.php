...
/**
 * @Title("MC-3411: Admin should be able to set/edit Related Products information when editing a simple product")
 * @Description("Admin should be able to set/edit Related Products information when editing a simple product<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/AdminSimpleSetEditRelatedProductsTest.xml<br>")
 * @TestCaseId("MC-3411")
 * @group Catalog
 */
class AdminSimpleSetEditRelatedProductsTestCest
{
    /**
	...
	public function _after(AcceptanceTester $I)
	{
		...
		$I->fillField("input.admin__control-text[name='sku']", "SimpleProduct3" . msq("SimpleProduct3")); // stepKey: fillProductSkuFilterDeleteProduct
		$I->fillField("input.admin__control-text[name='name']", "Simple Product 3 " . msq("SimpleProduct3")); // stepKey: fillProductNameFilterDeleteProduct
		...
		$I->see("SimpleProduct3" . msq("SimpleProduct3"), "//tr[1]//td[count(//div[@data-role='grid-wrapper']//tr//th[normalize-space(.)='SKU']/preceding-sibling::th) +1 ]"); // stepKey: seeProductSkuInGridDeleteProduct
	...
	/**
	 * @Features({"Catalog"})
	 * @Stories({"Create/edit simple product"})
	 ...
	 * @throws \Exception
	 */
	public function AdminSimpleSetEditRelatedProductsTest(AcceptanceTester $I)
	{
		...
		$I->fillField(".admin__field[data-index=name] input", "Simple Product 3 " . msq("SimpleProduct3")); // stepKey: fillProductNameFillProductForm
		$I->fillField(".admin__field[data-index=sku] input", "SimpleProduct3" . msq("SimpleProduct3")); // stepKey: fillProductSkuFillProductForm
		...
		$I->amOnPage("simple-product-3-" . msq("SimpleProduct3") . ".html"); // stepKey: goToStorefront
