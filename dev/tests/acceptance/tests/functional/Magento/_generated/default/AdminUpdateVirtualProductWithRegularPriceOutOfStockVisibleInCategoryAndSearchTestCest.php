 ...
 * @Description("Test log in to Update Virtual Product and Update Virtual Product with Regular Price (Out of Stock) Visible in Category and Search<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/AdminUpdateVirtualProductWithRegularPriceOutOfStockVisibleInCategoryAndSearchTest.xml<br>")
 * @TestCaseId("MC-7433")
 * @group catalog
 * @group mtf_migrated
 */
