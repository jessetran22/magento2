...
/**
 * @Title("MC-16587: Guest Checkout when Cart sidebar disabled")
 * @Description("Should be able to place an order as a Guest when Cart sidebar is disabled<h3>Test files</h3>app/code/Magento/Checkout/Test/Mftf/Test/StorefrontGuestCheckoutTest/StorefrontGuestCheckoutWithSidebarDisabledTest.xml<br>")
 * @TestCaseId("MC-16587")
 * @group checkout
 */
class StorefrontGuestCheckoutWithSidebarDisabledTestCest
{
    /**
	...
	public function _before(AcceptanceTester $I)
	{
		...
		$disableSidebar = $I->magentoCLI("config:set checkout/sidebar/display 0", 60); // stepKey: disableSidebar
		$I->comment($disableSidebar);
	}
	...
	public function _after(AcceptanceTester $I)
	{
		...
		$enableSidebar = $I->magentoCLI("config:set checkout/sidebar/display 1", 60); // stepKey: enableSidebar
		$I->comment($enableSidebar);
	}
	 ...
	 * @throws \Exception
	 */
	public function StorefrontGuestCheckoutWithSidebarDisabledTest(AcceptanceTester $I)
	{
		...
		$I->comment("Entering Action Group [guestGoToCheckoutFromCart] GoToCheckoutFromCartActionGroup");
		...
		$I->waitForLoadingMaskToDisappear(); // stepKey: waitForLoadingMaskGuestGoToCheckoutFromCart
		$I->seeInCurrentUrl("/checkout/cart"); // stepKey: assertCheckoutCartUrlGuestGoToCheckoutFromCart
		$I->click(".action.primary.checkout span"); // stepKey: goToCheckoutGuestGoToCheckoutFromCart
		$I->waitForPageLoad(30); // stepKey: goToCheckoutGuestGoToCheckoutFromCartWaitForPageLoad
		$I->comment("Exiting Action Group [guestGoToCheckoutFromCart] GoToCheckoutFromCartActionGroup");
