...
/**
 * @Title("MC-15609: Create Cart Price Rule With Matching Total Weight And Verify Rule Condition Is Applied")
 * @Description("Test log in to Cart Price Rules and Create Cart Price Rule With Matching Total Weight And Verify Rule Condition Is Applied<h3>Test files</h3>app/code/Magento/SalesRule/Test/Mftf/Test/AdminCreateCartPriceRuleWithMatchingTotalWeightAndVerifyRuleConditionIsAppliedTest.xml<br>")
 * @TestCaseId("MC-15609")
 * @group SalesRule
 * @group mtf_migrated
 */
class AdminCreateCartPriceRuleWithMatchingTotalWeightAndVerifyRuleConditionIsAppliedTestCest
{
    /**
	...
	public function _before(AcceptanceTester $I)
	{
		...
		$I->createEntity("initialSimpleProduct", "hook", "defaultSimpleProductWeight200", [], []); // stepKey: initialSimpleProduct
	}
	...
	public function _after(AcceptanceTester $I)
	{
		...
		$I->fillField("input[name='name']", "Cart Price Rule With Weight Condition Applied" . msq("CartPriceRuleConditionAppliedForWeight")); // stepKey: filterByNameDeleteCreatedCartPriceRule
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateCartPriceRuleWithMatchingTotalWeightAndVerifyRuleConditionIsAppliedTest(AcceptanceTester $I)
	{
		...
		$I->fillField("input[name='name']", "Cart Price Rule With Weight Condition Applied" . msq("CartPriceRuleConditionAppliedForWeight")); // stepKey: fillRuleName
		...
		$I->click(".rule-param.rule-param-new-child"); // stepKey: clickOnNewCondition
		$I->waitForPageLoad(30); // stepKey: clickOnNewConditionWaitForPageLoad
		$I->selectOption("select[name='rule[conditions][1][new_child]']", "Total Weight"); // stepKey: selectTotalWeight
		$I->waitForPageLoad(30); // stepKey: waitForThirdConditionLoad
		$I->click("//ul[contains(@id, 'conditions')]//a[.='...']"); // stepKey: clickOnEllipsis
		$I->fillField("[id='conditions__1--1__value']", "200"); // stepKey: fillTotalItemQuantity
		...
		$I->fillField("input[name='store_labels[0]']", "Total Weight is 200"); // stepKey: fillDefaultRuleLabelAllStoreViewsCreateActiveCartPriceRuleLabelsSection
		$I->fillField("input[name='store_labels[1]']", "Total Weight is 200"); // stepKey: fillDefaultStoreViewCreateActiveCartPriceRuleLabelsSection
		...
		$I->fillField("input[name='name']", "Cart Price Rule With Weight Condition Applied" . msq("CartPriceRuleConditionAppliedForWeight")); // stepKey: filterByNameSearchCreatedCartPriceRuleInGrid
		...
		$I->seeInField("input[name='name']", "Cart Price Rule With Weight Condition Applied" . msq("CartPriceRuleConditionAppliedForWeight")); // stepKey: seeRuleName
		...
		$I->seeInField("[id='conditions__1--1__value']", "200"); // stepKey: seeTotalWeightParameter
		...
		$I->seeInField("input[name='store_labels[0]']", "Total Weight is 200"); // stepKey: seeDefaultRuleLabelAllStoreViews
		$I->seeInField("input[name='store_labels[1]']", "Total Weight is 200"); // stepKey: seeDefaultStoreView
		...
		$I->comment("Verify AssertCartPriceRuleConditionIsApplied if condition Total Weight equals 200 is true");
		...
		$I->comment("Entering Action Group [seeAssertDiscountAmountAppliedForWeightConditionIsTrue] AssertStorefrontCartDiscountActionGroup");
		$I->waitForElementVisible("td[data-th='Discount']", 30); // stepKey: waitForDiscountSeeAssertDiscountAmountAppliedForWeightConditionIsTrue
		$I->see("-$280.00", "td[data-th='Discount']"); // stepKey: assertDiscountSeeAssertDiscountAmountAppliedForWeightConditionIsTrue
		$I->comment("Exiting Action Group [seeAssertDiscountAmountAppliedForWeightConditionIsTrue] AssertStorefrontCartDiscountActionGroup");
	}
}
