 ...
 * @Description("Default value of Paypal Customize Button should be NO<h3>Test files</h3>app/code/Magento/Paypal/Test/Mftf/Test/AdminCheckDefaultValueOfPayPalCustomizeButtonTest.xml<br>")
 * @TestCaseId("MC-10904")
 * @group paypal
 */
