...
/**
 * @Title("MC-38222: Import Configurable Product With Simple Child Products With Images")
 * @Description("Imports a .csv file containing a configurable product with 3 child simple products that             have images. Verifies that products are imported successfully, that the images are attached to the             products as expected, and that the configurable product can be purchased successfully.<h3>Test files</h3>app/code/Magento/ConfigurableImportExport/Test/Mftf/Test/AdminImportSimpleAndConfigurableProductsWithAssignedImagesTest.xml<br>")
 * @TestCaseId("MC-38222")
 * @group importExport
 * @group ConfigurableProduct
 */
class AdminImportSimpleAndConfigurableProductsWithAssignedImagesTestCest
{
    /**
	...
	public function _before(AcceptanceTester $I)
	{
		...
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->createDirectory("var/import/images/import-product-configurable", 511); // stepKey: createDirectoryForImportImages
		$I->comment('[copyProduct1BaseImage] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::copy()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->copy("dev/tests/acceptance/tests/_data/magento-logo.png", "var/import/images/import-product-configurable/magento-logo.png"); // stepKey: copyProduct1BaseImage
		$I->comment('[copyProduct2BaseImage] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::copy()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->copy("dev/tests/acceptance/tests/_data/m-logo.gif", "var/import/images/import-product-configurable/m-logo.gif"); // stepKey: copyProduct2BaseImage
		$I->comment('[copyProduct3BaseImage] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::copy()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->copy("dev/tests/acceptance/tests/_data/adobe-base.jpg", "var/import/images/import-product-configurable/adobe-base.jpg"); // stepKey: copyProduct3BaseImage
	}
	...
	public function _after(AcceptanceTester $I)
	{
		...
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->deleteDirectory("var/import/images/import-product-configurable"); // stepKey: deleteProductImageDirectory
	...
	/**
	 * @Features({"ConfigurableImportExport"})
	 ...
	 * @throws \Exception
	 */
	public function AdminImportSimpleAndConfigurableProductsWithAssignedImagesTest(AcceptanceTester $I)
	{
