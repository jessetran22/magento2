...
/**
 * @Title("MC-10930: Admin should be able to switch a new product from virtual to configurable")
 * @Description("After selecting a virtual product when adding Admin should be switch to configurable implicitly<h3>Test files</h3>app/code/Magento/ConfigurableProduct/Test/Mftf/Test/AdminCreateAndSwitchProductType/AdminCreateVirtualProductSwitchToConfigurableTest.xml<br>")
 * @TestCaseId("MC-10930")
 * @group catalog
 * @group mtf_migrated
 */
class AdminCreateVirtualProductSwitchToConfigurableTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateVirtualProductSwitchToConfigurableTest(AcceptanceTester $I)
	{
