 ...
 * @Description("Admin should be able to create a unicode named simple product<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/AdminCreateSimpleProductWithUnicodeTest.xml<br>")
 * @TestCaseId("MC-105")
 * @group product
 */
class AdminCreateSimpleProductWithUnicodeTestCest
{
	...
	public function _after(AcceptanceTester $I)
	{
		...
		$I->fillField("input.admin__control-text[name='sku']", "霁产品" . msq("ProductWithUnicode")); // stepKey: fillProductSkuFilterDeleteProduct
		...
		$I->see("霁产品" . msq("ProductWithUnicode"), "//tr[1]//td[count(//div[@data-role='grid-wrapper']//tr//th[normalize-space(.)='SKU']/preceding-sibling::th) +1 ]"); // stepKey: seeProductSkuInGridDeleteProduct
