...
/**
 * @Title("MC-14188: Admin marketing newsletter template navigate menu test")
 * @Description("Admin should be able to navigate to Marketing > Newsletter Template<h3>Test files</h3>app/code/Magento/Newsletter/Test/Mftf/Test/AdminMarketingNewsletterTemplateNavigateMenuTest.xml<br>")
 * @TestCaseId("MC-14188")
 * @group menu
 * @group mtf_migrated
 */
class AdminMarketingNewsletterTemplateNavigateMenuTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminMarketingNewsletterTemplateNavigateMenuTest(AcceptanceTester $I)
	{
		...
		$I->see("Newsletter Templates", ".page-title-wrapper h1"); // stepKey: assertPageTitleSeePageTitle
