...
class AdminExportBundleProductTestCest
{
	...
	public function AdminExportBundleProductTest(AcceptanceTester $I)
	{
		...
		$I->comment('[assertExportFileContainsFirstSimpleProductForDynamicBundledProduct] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::assertFileContainsString()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->assertFileContainsString("var/export/{$grabNameFile}", $I->retrieveEntityField('firstSimpleProductForDynamic', 'name', 'test'), ''); // stepKey: assertExportFileContainsFirstSimpleProductForDynamicBundledProduct
		$I->comment('[assertExportFileContainsSecondSimpleProductForDynamicBundledProduct] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::assertFileContainsString()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->assertFileContainsString("var/export/{$grabNameFile}", $I->retrieveEntityField('secondSimpleProductForDynamic', 'name', 'test'), ''); // stepKey: assertExportFileContainsSecondSimpleProductForDynamicBundledProduct
		$I->comment('[assertExportFileContainsDynamicBundleProduct] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::assertFileContainsString()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->assertFileContainsString("var/export/{$grabNameFile}", $I->retrieveEntityField('createDynamicBundleProduct', 'name', 'test'), ''); // stepKey: assertExportFileContainsDynamicBundleProduct
		$I->comment('[assertExportFileContainsDynamicBundleProductOption1] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::assertFileContainsString()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->assertFileContainsString("var/export/{$grabNameFile}", "name=" . $I->retrieveEntityField('createFirstBundleOption', 'option[title]', 'test') . ",type=" . $I->retrieveEntityField('createFirstBundleOption', 'option[type]', 'test') . ",required=" . $I->retrieveEntityField('createFirstBundleOption', 'option[required]', 'test') . ",sku=" . $I->retrieveEntityField('firstSimpleProductForDynamic', 'sku', 'test'), ''); // stepKey: assertExportFileContainsDynamicBundleProductOption1
		$I->comment('[assertExportFileContainsDynamicBundleProductOption2] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::assertFileContainsString()');
		...
		$I->comment('[assertExportFileContainsDynamicPriceBundleProduct] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::assertFileContainsString()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->assertFileContainsString("var/export/{$grabNameFile}", "0.000000,,,," . $I->retrieveEntityField('createDynamicBundleProduct', 'sku', 'test'), ''); // stepKey: assertExportFileContainsDynamicPriceBundleProduct
		$I->comment("Validate Export File on File System: Fixed Bundle Product");
		$I->comment('[assertExportFileContainsFirstSimpleProductForFixedBundledProduct] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::assertFileContainsString()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->assertFileContainsString("var/export/{$grabNameFile}", $I->retrieveEntityField('firstSimpleProductForFixed', 'name', 'test'), ''); // stepKey: assertExportFileContainsFirstSimpleProductForFixedBundledProduct
		$I->comment('[assertExportFileContainsSecondSimpleProductForFixedBundledProduct] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::assertFileContainsString()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->assertFileContainsString("var/export/{$grabNameFile}", $I->retrieveEntityField('secondSimpleProductForFixed', 'name', 'test'), ''); // stepKey: assertExportFileContainsSecondSimpleProductForFixedBundledProduct
		$I->comment('[assertExportFileContainsFixedBundleProduct] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::assertFileContainsString()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->assertFileContainsString("var/export/{$grabNameFile}", $I->retrieveEntityField('createFixedBundleProduct', 'name', 'test'), ''); // stepKey: assertExportFileContainsFixedBundleProduct
		$I->comment('[assertExportFileContainsFixedBundleProductOption1] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::assertFileContainsString()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->assertFileContainsString("var/export/{$grabNameFile}", "name=" . $I->retrieveEntityField('createSecondBundleOption', 'option[title]', 'test') . ",type=" . $I->retrieveEntityField('createSecondBundleOption', 'option[type]', 'test') . ",required=" . $I->retrieveEntityField('createSecondBundleOption', 'option[required]', 'test') . ",sku=" . $I->retrieveEntityField('firstSimpleProductForFixed', 'sku', 'test'), ''); // stepKey: assertExportFileContainsFixedBundleProductOption1
		$I->comment('[assertExportFileContainsFixedBundleProductOption2] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::assertFileContainsString()');
		...
		$I->comment('[assertExportFileContainsFixedPriceBundleProduct] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::assertFileContainsString()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->assertFileContainsString("var/export/{$grabNameFile}", $I->retrieveEntityField('createFixedBundleProduct', 'price', 'test') . "0000,,,," . $I->retrieveEntityField('createFixedBundleProduct', 'sku', 'test'), ''); // stepKey: assertExportFileContainsFixedPriceBundleProduct
		$I->comment("Validate Export File on File System: Fixed Bundle Product with Attribute");
		$I->comment('[assertExportFileContainsFirstSimpleProductForFixedBundledProductWithAttribute] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::assertFileContainsString()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->assertFileContainsString("var/export/{$grabNameFile}", $I->retrieveEntityField('firstSimpleProductForFixedWithAttribute', 'name', 'test'), ''); // stepKey: assertExportFileContainsFirstSimpleProductForFixedBundledProductWithAttribute
		$I->comment('[assertExportFileContainsSecondSimpleProductForFixedBundledProductWithAttribute] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::assertFileContainsString()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->assertFileContainsString("var/export/{$grabNameFile}", $I->retrieveEntityField('secondSimpleProductForFixedWithAttribute', 'name', 'test'), ''); // stepKey: assertExportFileContainsSecondSimpleProductForFixedBundledProductWithAttribute
		$I->comment('[assertExportFileContainsFixedBundleProductWithAttribute] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::assertFileContainsString()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->assertFileContainsString("var/export/{$grabNameFile}", $I->retrieveEntityField('createFixedBundleProductWithAttribute', 'name', 'test'), ''); // stepKey: assertExportFileContainsFixedBundleProductWithAttribute
		$I->comment('[assertExportFileContainsFixedBundleProductWithAttributeOption1] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::assertFileContainsString()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->assertFileContainsString("var/export/{$grabNameFile}", "name=" . $I->retrieveEntityField('createBundleOptionWithAttribute', 'option[title]', 'test') . ",type=" . $I->retrieveEntityField('createBundleOptionWithAttribute', 'option[type]', 'test') . ",required=" . $I->retrieveEntityField('createBundleOptionWithAttribute', 'option[required]', 'test') . ",sku=" . $I->retrieveEntityField('firstSimpleProductForFixedWithAttribute', 'sku', 'test'), ''); // stepKey: assertExportFileContainsFixedBundleProductWithAttributeOption1
		$I->comment('[assertExportFileContainsFixedBundleProductWithAttributeOption2] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::assertFileContainsString()');
		...
		$I->comment('[assertExportFileContainsFixedPriceBundleProductWithAttribute] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::assertFileContainsString()');
