...
/**
 * @Title("[NO TESTCASEID]: Check thumbnail images and active image for Configurable Product with predefined                 by query params options")
 * @Description("Login as admin, create attribute with two options, configurable product with two                 associated simple products. Add few images for products, check the fotorama thumbnail images                 (visible and active) for each option for the configurable product using product URL with params                 to selected needed option.<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/StorefrontSelectedByQueryParamsConfigurableOptionsThumbImagesTest.xml<br>")
 * @group catalog
 */
class StorefrontSelectedByQueryParamsConfigurableOptionsThumbImagesTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function StorefrontSelectedByQueryParamsConfigurableOptionsThumbImagesTest(AcceptanceTester $I)
	{
