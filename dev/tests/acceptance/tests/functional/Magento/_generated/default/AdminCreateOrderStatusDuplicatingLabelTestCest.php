 ...
 * @Description("Create an order status and get success message<h3>Test files</h3>app/code/Magento/Sales/Test/Mftf/Test/AdminCreateOrderStatusDuplicatingLabelTest.xml<br>")
 * @TestCaseId("MC-15433")
 * @group sales
 * @group mtf_migrated
 */
