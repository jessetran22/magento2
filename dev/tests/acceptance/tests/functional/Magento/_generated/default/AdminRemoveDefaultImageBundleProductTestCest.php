 ...
 * @Description("Admin should be able to remove default images from a Bundle Product<h3>Test files</h3>app/code/Magento/Bundle/Test/Mftf/Test/AdminRemoveDefaultImageBundleProductTest.xml<br>")
 * @TestCaseId("MC-200")
 * @group Bundle
 */
