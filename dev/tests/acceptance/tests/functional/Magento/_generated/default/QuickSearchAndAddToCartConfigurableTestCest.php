 ...
 * @Description("Use Quick Search to find configurable Product and Add to Cart<h3>Test files</h3>app/code/Magento/CatalogSearch/Test/Mftf/Test/SearchEntityResultsTest/QuickSearchAndAddToCartConfigurableTest.xml<br>")
 * @TestCaseId("MC-14786")
 * @group CatalogSearch
 * @group mtf_migrated
 */
class QuickSearchAndAddToCartConfigurableTestCest
{
	...
	public function QuickSearchAndAddToCartConfigurableTest(AcceptanceTester $I)
	{
		...
		$I->seeInCurrentUrl("testproductname" . msq("_defaultProduct")); // stepKey: checkUrlOpenAndCheckProduct
