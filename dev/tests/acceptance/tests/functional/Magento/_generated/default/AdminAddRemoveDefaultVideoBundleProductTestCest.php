 ...
 * @Description("Admin should be able to add/remove default product video for a Bundle Product<h3>Test files</h3>app/code/Magento/ProductVideo/Test/Mftf/Test/AdminAddRemoveDefaultVideoBundleProductTest.xml<br>")
 * @TestCaseId("MC-110")
 * @group catalog
 * @group bundle
 * @group productVideo
