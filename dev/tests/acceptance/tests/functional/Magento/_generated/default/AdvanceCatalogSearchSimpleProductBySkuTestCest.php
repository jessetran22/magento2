...
/**
 * @Title("MC-133: Guest customer should be able to advance search simple product with product sku")
 * @Description("Guest customer should be able to advance search simple product with product sku<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/AdvanceCatalogSearchSimpleProductTest/AdvanceCatalogSearchSimpleProductBySkuTest.xml<br>app/code/Magento/CatalogSearch/Test/Mftf/Test/AdvanceCatalogSearchSimpleProductTest/AdvanceCatalogSearchSimpleProductBySkuTest.xml<br>")
 * @TestCaseId("MC-133")
 * @group Catalog
 * @group CatalogSearch
 */
class AdvanceCatalogSearchSimpleProductBySkuTestCest
{
    /**
	...
	{
		$I->createEntity("product", "hook", "ApiProductWithDescriptionAndUnderscoredSku", [], []); // stepKey: product
	}
	 ...
	 * @throws \Exception
	 */
	public function AdvanceCatalogSearchSimpleProductBySkuTest(AcceptanceTester $I)
	{
