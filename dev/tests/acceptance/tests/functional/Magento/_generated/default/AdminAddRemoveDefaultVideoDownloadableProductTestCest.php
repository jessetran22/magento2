 ...
 * @Description("Admin should be able to add/remove default product video for a Downloadable Product<h3>Test files</h3>app/code/Magento/ProductVideo/Test/Mftf/Test/AdminAddRemoveDefaultVideoDownloadableProductTest.xml<br>")
 * @TestCaseId("MC-114")
 * @group catalog
 * @group downloadable
 * @group productVideo
