...
/**
 * @Title("MC-5335: Create category URL rewrite, with no redirect")
 * @Description("Login as admin and create category UrlRewrite with No redirect<h3>Test files</h3>app/code/Magento/UrlRewrite/Test/Mftf/Test/AdminCreateCategoryUrlRewriteAndAddNoRedirectTest.xml<br>")
 * @TestCaseId("MC-5335")
 * @group mtf_migrated
 */
class AdminCreateCategoryUrlRewriteAndAddNoRedirectTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateCategoryUrlRewriteAndAddNoRedirectTest(AcceptanceTester $I)
	{
