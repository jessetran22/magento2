...
/**
 * @Title("MC-14711: Checkout as UK guest with condition available product quantity equals to ordered product quantity")
 * @Description("Checkout as UK guest with condition available product quantity equals to ordered product quantity<h3>Test files</h3>app/code/Magento/Checkout/Test/Mftf/Test/StorefrontUKGuestCheckoutWithConditionProductQuantityEqualsToOrderedQuantityTest.xml<br>")
 * @TestCaseId("MC-14711")
 * @group mtf_migrated
 */
class StorefrontUKGuestCheckoutWithConditionProductQuantityEqualsToOrderedQuantityTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function StorefrontUKGuestCheckoutWithConditionProductQuantityEqualsToOrderedQuantityTest(AcceptanceTester $I)
	{
		...
		$I->fillField("input[name=postcode]", "SE1 7RW"); // stepKey: SetCustomerZipCodeFillGuestForm
		$I->fillField("input[name=telephone]", "444-44-444-44"); // stepKey: SetCustomerPhoneNumberFillGuestForm
