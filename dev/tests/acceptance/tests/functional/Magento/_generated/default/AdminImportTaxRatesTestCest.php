...
/**
 * @Title("MC-38621: Import and Update Tax Rates")
 * @Description("Imports tax rates from the System > Data Transfer > Import/Export Tax Rates page and             from the Tax Rule page, to create new tax rates and update existing tax rates. Verifies results on the Tax             Rates grid page.<h3>Test files</h3>app/code/Magento/TaxImportExport/Test/Mftf/Test/AdminImportTaxRatesTest.xml<br>")
 * @TestCaseId("MC-38621")
 * @group importExport
 * @group tax
 */
class AdminImportTaxRatesTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminImportTaxRatesTest(AcceptanceTester $I)
	{
