...
class AdminExportDownloadableProductWithFileLinksTestCest
{
	 ...
	 * @throws \Exception
	 */
	public function AdminExportDownloadableProductWithFileLinksTest(AcceptanceTester $I)
	{
		...
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->assertFileContainsString("var/export/{$grabNameFile}", "title=" . $I->retrieveEntityField('addDownloadableLink', 'link[title]', 'test') . ",sort_order=" . $I->retrieveEntityField('addDownloadableLink', 'link[sort_order]', 'test') . ",sample_type=" . $I->retrieveEntityField('addDownloadableLink', 'link[sample_type]', 'test') . ",sample_file=/a/d/" . $I->retrieveEntityField('addDownloadableLink', 'link[sample_file_content][name]', 'test') . ",price=" . $I->retrieveEntityField('addDownloadableLink', 'link[price]', 'test') . "0000,number_of_downloads=" . $I->retrieveEntityField('addDownloadableLink', 'link[number_of_downloads]', 'test') . ",is_shareable=" . $I->retrieveEntityField('addDownloadableLink', 'link[is_shareable]', 'test') . ",link_type=" . $I->retrieveEntityField('addDownloadableLink', 'link[link_type]', 'test') . ",link_file=/m/a/" . $I->retrieveEntityField('addDownloadableLink', 'link[link_file_content][name]', 'test'), ''); // stepKey: assertExportFileContainsDownloadableLink
