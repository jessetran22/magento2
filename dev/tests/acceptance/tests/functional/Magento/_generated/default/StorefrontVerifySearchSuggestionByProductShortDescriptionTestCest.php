...
/**
 * @Title("MC-14766: Create search query using product short description and verify search suggestions")
 * @Description("Storefront search by product short description, generate search query and verify dropdown product search suggestions<h3>Test files</h3>app/code/Magento/Search/Test/Mftf/Test/StorefrontVerifySearchSuggestionByProductShortDescriptionTest.xml<br>")
 * @TestCaseId("MC-14766")
 * @group mtf_migrated
 */
class StorefrontVerifySearchSuggestionByProductShortDescriptionTestCest
{
	/**
	...
	public function _before(AcceptanceTester $I)
	{
		...
		$I->comment("Create product with short description");
	...
	public function _after(AcceptanceTester $I)
	{
		...
		$I->fillField("//tr[@class='data-grid-filters']//td/input[@name='search_query']", "API Product Short Description" . msq("ApiProductShortDescription")); // stepKey: fillSearchQueryFilterByThirdSearchQuery
		...
		$I->checkOption("//*[normalize-space()='API Product Short Description" . msq("ApiProductShortDescription") . "']/preceding-sibling::td//input[@name='search']"); // stepKey: checkCheckBoxFilterByThirdSearchQuery
	 ...
	 * @throws \Exception
	 */
	public function StorefrontVerifySearchSuggestionByProductShortDescriptionTest(AcceptanceTester $I)
	{
		...
		$I->fillField("#search", "API Product Short Description" . msq("ApiProductShortDescription")); // stepKey: fillInputQuickSearchByProductName
		...
		$I->seeInTitle("Search results for: 'API Product Short Description" . msq("ApiProductShortDescription") . "'"); // stepKey: assertQuickSearchTitleQuickSearchByProductName
		$I->see("Search results for: 'API Product Short Description" . msq("ApiProductShortDescription") . "'", ".page-title span"); // stepKey: assertQuickSearchNameQuickSearchByProductName
		...
		$I->fillField("#search", "API Product Short Description" . msq("ApiProductShortDescription")); // stepKey: fillSearchInputSeeDropDownSearchSuggestion
		...
		$I->see("API Product Short Description" . msq("ApiProductShortDescription"), "//div[@id='search_autocomplete']/ul/li/span"); // stepKey: seeDropDownSuggestionSeeDropDownSearchSuggestion
		$I->click("//div[@id='search_autocomplete']//span[contains(., 'API Product Short Description" . msq("ApiProductShortDescription") . "')]"); // stepKey: clickOnSearchSuggestionSeeDropDownSearchSuggestion
		...
		$I->see($I->retrieveEntityField('product', 'name', 'test'), ".product-item-name"); // stepKey: seeProductNameSeeProductName
