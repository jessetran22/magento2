 ...
 * @Description("Admin should be able to navigate to Stores > Configuration<h3>Test files</h3>app/code/Magento/Backend/Test/Mftf/Test/AdminStoresConfigurationNavigateMenuTest.xml<br>")
 * @TestCaseId("MC-14119")
 * @group menu
 * @group mtf_migrated
 */
