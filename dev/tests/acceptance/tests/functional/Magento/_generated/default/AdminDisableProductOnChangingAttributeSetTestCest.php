 ...
 * @Description("Value set for enabled product has to be shown when attribute set is changed<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/AdminDisableProductOnChangingAttributeSetTest.xml<br>")
 * @TestCaseId("MC-19716")
 * @group catalog
 */
