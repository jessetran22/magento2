...
/**
 * @Title("MC-14792: Quick Search can find products with names that contain special characters")
 * @Description("Use Quick Search to find a product by name<h3>Test files</h3>app/code/Magento/CatalogSearch/Test/Mftf/Test/SearchEntityResultsTest/QuickSearchProductByNameWithSpecialCharsTest.xml<br>")
 * @TestCaseId("MC-14792")
 * @group CatalogSearch
 * @group mtf_migrated
 */
class QuickSearchProductByNameWithSpecialCharsTestCest
{
    /**
	...
	public function _before(AcceptanceTester $I)
	{
		...
		$I->createEntity("createSimpleProduct", "hook", "productWithSpecialCharacters", ["createCategory"], []); // stepKey: createSimpleProduct
	 ...
	 * @throws \Exception
	 */
	public function QuickSearchProductByNameWithSpecialCharsTest(AcceptanceTester $I)
	{
		...
		$I->comment("Overwrite search to use name");
	}
}
