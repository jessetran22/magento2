...
/**
 * @Title("MC-164: Guest customer should be able to advance search virtual product with product short description")
 * @Description("Guest customer should be able to advance search virtual product with product short description<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/AdvanceCatalogSearchVirtualProductTest/AdvanceCatalogSearchVirtualProductByShortDescriptionTest.xml<br>")
 * @TestCaseId("MC-164")
 * @group Catalog
 */
class AdvanceCatalogSearchVirtualProductByShortDescriptionTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdvanceCatalogSearchVirtualProductByShortDescriptionTest(AcceptanceTester $I)
	{
