...
/**
 * @Title("MC-5312: Create customer, new via backend")
 * @Description("Login as admin and create a new customer<h3>Test files</h3>app/code/Magento/Customer/Test/Mftf/Test/AdminCreateNewCustomerTest.xml<br>")
 * @TestCaseId("MC-5312")
 * @group mtf_migrated
 */
class AdminCreateNewCustomerTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateNewCustomerTest(AcceptanceTester $I)
	{
		$I->comment("Open New Customer Page");
		$I->comment("Entering Action Group [waitToCustomerPageLoad] AdminNavigateNewCustomerActionGroup");
		$I->amOnPage((getenv("MAGENTO_BACKEND_BASE_URL") ? rtrim(getenv("MAGENTO_BACKEND_BASE_URL"), "/") : "") . "/" . getenv("MAGENTO_BACKEND_NAME") . "/customer/index/new"); // stepKey: navigateToCustomersWaitToCustomerPageLoad
		$I->waitForPageLoad(30); // stepKey: waitForLoadWaitToCustomerPageLoad
		$I->comment("Exiting Action Group [waitToCustomerPageLoad] AdminNavigateNewCustomerActionGroup");
		...
		$I->comment("Assert Customer Title");
		...
		$I->see("John Doe ", "h1.page-title"); // stepKey: seeCustomerTitle
	}
}
