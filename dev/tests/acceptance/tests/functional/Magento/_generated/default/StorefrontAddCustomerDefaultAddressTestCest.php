 ...
 * @Description("Storefront user should be able to create a new default address via the storefront<h3>Test files</h3>app/code/Magento/Customer/Test/Mftf/Test/StorefrontAddCustomerAddressTest/StorefrontAddCustomerDefaultAddressTest.xml<br>")
