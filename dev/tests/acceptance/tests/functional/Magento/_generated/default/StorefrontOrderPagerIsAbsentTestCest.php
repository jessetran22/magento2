 ...
 * @Description("Pager is disabled for orders with less than 20 items<h3>Test files</h3>app/code/Magento/Sales/Test/Mftf/Test/StorefrontOrderPagerIsAbsentTest.xml<br>")
 * @TestCaseId("MC-16166")
 * @group sales
 * @group mtf_migrated
 */
