...
/**
 * @Title("[NO TESTCASEID]: Check settings Default Value for Disable Automatic Group Changes Based on VAT ID is No")
 * @Description("Check settings Default Value for Disable Automatic Group Changes Based on VAT ID is No<h3>Test files</h3>app/code/Magento/Customer/Test/Mftf/Test/AdminCheckDefaultValueDisableAutoGroupChangeIsNoTest.xml<br>")
 * @group customer
 * @group create
 */
class AdminCheckDefaultValueDisableAutoGroupChangeIsNoTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function AdminCheckDefaultValueDisableAutoGroupChangeIsNoTest(AcceptanceTester $I)
	{
		...
		$I->assertEquals("0", $grabDisableAutomaticGroupChangeSeeDefaultValueInForm, "pass"); // stepKey: assertDisableAutomaticGroupChangeNoSeeDefaultValueInForm
