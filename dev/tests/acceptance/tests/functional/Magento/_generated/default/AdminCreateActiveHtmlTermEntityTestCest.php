...
/**
 * @Title("MC-14668: Create active HTML checkout agreement")
 * @Description("Admin should be able to create active HTML checkout agreement<h3>Test files</h3>app/code/Magento/CheckoutAgreements/Test/Mftf/Test/AdminCreateActiveHtmlTermEntityTest.xml<br>")
 * @TestCaseId("MC-14668")
 * @group checkoutAgreements
 * @group mtf_migrated
 */
class AdminCreateActiveHtmlTermEntityTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateActiveHtmlTermEntityTest(AcceptanceTester $I)
	{
		...
		$I->fillField("#name", "name" . msq("activeHtmlTerm")); // stepKey: fillFieldConditionNameFillNewTerm
		...
		$I->fillField("#checkbox_text", "test_checkbox" . msq("activeHtmlTerm")); // stepKey: fillFieldCheckboxTextFillNewTerm
