 ...
 * @Description("Checkout as customer using non default address<h3>Test files</h3>app/code/Magento/Checkout/Test/Mftf/Test/OnePageCheckoutAsCustomerUsingNonDefaultAddressTest.xml<br>")
 * @TestCaseId("MC-14739")
 * @group checkout
 * @group mtf_migrated
 */
class OnePageCheckoutAsCustomerUsingNonDefaultAddressTestCest
{
	...
	public function _before(AcceptanceTester $I)
	{
		...
		$I->createEntity("createCustomer", "hook", "Customer_DE_UK_US", [], []); // stepKey: createCustomer
	}
	...
	public function OnePageCheckoutAsCustomerUsingNonDefaultAddressTest(AcceptanceTester $I)
	{
		...
		$I->see("368 Broadway St.", "[name=billing_address_id] option:checked"); // stepKey: seeDefaultBillingAddressStreet
