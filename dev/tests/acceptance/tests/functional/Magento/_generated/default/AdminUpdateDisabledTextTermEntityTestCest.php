 ...
 * @Description("Admin should be able to update disabled Text checkout agreement<h3>Test files</h3>app/code/Magento/CheckoutAgreements/Test/Mftf/Test/AdminUpdateDisabledTextTermEntityTest.xml<br>")
 * @TestCaseId("MC-14665")
