 ...
 * @Description("Test log in to Update tax rule and Update default tax rule<h3>Test files</h3>app/code/Magento/Tax/Test/Mftf/Test/AdminUpdateDefaultTaxRuleTest.xml<br>")
 * @TestCaseId("MC-5819")
 * @group tax
 * @group mtf_migrated
 */
