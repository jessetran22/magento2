...
/**
 * @Title("MC-6964: Url-rewrites for product in anchor categories for all store views with configuration turned off")
 * @Description("Url-rewrites for product in anchor categories for all store views with configuration turned off<h3>Test files</h3>app/code/Magento/UrlRewrite/Test/Mftf/Test/AdminUrlRewritesForProductInAnchorCategoriesTest/AdminUrlRewritesForProductInAnchorCategoriesTestAllStoreViewWithConfigurationTurnedOffTest.xml<br>")
 * @TestCaseId("MC-6964")
 * @group urlRewrite
 */
class AdminUrlRewritesForProductInAnchorCategoriesTestAllStoreViewWithConfigurationTurnedOffTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminUrlRewritesForProductInAnchorCategoriesTestAllStoreViewWithConfigurationTurnedOffTest(AcceptanceTester $I)
	{
