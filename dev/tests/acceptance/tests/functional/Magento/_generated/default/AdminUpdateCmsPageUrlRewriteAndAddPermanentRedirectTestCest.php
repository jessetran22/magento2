...
/**
 * @Title(": Update Cms Page URL Rewrites, Permanent redirect type")
 * @Description("Login as Admin and update Cms Page Url Rewrite and add Permanent redirect type<h3>Test files</h3>app/code/Magento/UrlRewrite/Test/Mftf/Test/AdminUpdateCmsPageUrlRewriteAndAddPermanentRedirectTest.xml<br>")
 * @TestCaseId("")
 * @group mtf_migrated
 */
class AdminUpdateCmsPageUrlRewriteAndAddPermanentRedirectTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminUpdateCmsPageUrlRewriteAndAddPermanentRedirectTest(AcceptanceTester $I)
	{
		...
		$I->click("//select[@id='redirect_type']//option[contains(., 'Permanent (301)')]"); // stepKey: selectRedirectTypeValueUpdateCmsPageUrlRewrite
