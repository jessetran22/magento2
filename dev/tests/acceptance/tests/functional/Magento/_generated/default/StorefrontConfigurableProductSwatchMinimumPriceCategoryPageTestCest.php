 ...
 * @Description("Swatch option should show the lowest price possible on category page<h3>Test files</h3>app/code/Magento/Swatches/Test/Mftf/Test/StorefrontConfigurableProductSwatchMinimumPriceTest/StorefrontConfigurableProductSwatchMinimumPriceCategoryPageTest.xml<br>")
 * @TestCaseId("MC-19683")
 * @group Swatches
 */
class StorefrontConfigurableProductSwatchMinimumPriceCategoryPageTestCest
{
	...
	public function StorefrontConfigurableProductSwatchMinimumPriceCategoryPageTest(AcceptanceTester $I)
	{
		...
		$I->amOnPage("/" . $I->retrieveEntityField('createCategory', 'custom_attributes[url_key]', 'test') . ".html"); // stepKey: amOnConfigurableProductPage
