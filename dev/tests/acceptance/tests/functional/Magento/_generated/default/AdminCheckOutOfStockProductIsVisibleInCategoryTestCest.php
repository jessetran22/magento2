...
/**
 * @Title("MC-11067: Out of Stock Product is Visible in Category")
 * @Description("Login as admin and check out of stock product is visible in category<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/AdminCheckOutOfStockProductIsVisibleInCategoryTest.xml<br>")
 * @TestCaseId("MC-11067")
 * @group mtf_migrated
 */
class AdminCheckOutOfStockProductIsVisibleInCategoryTestCest
{
    /**
	...
	public function _before(AcceptanceTester $I)
	{
		...
		$setDisplayOutOfStockProduct = $I->magentoCLI("config:set cataloginventory/options/show_out_of_stock 1", 60); // stepKey: setDisplayOutOfStockProduct
	 ...
	 * @throws \Exception
	 */
	public function AdminCheckOutOfStockProductIsVisibleInCategoryTest(AcceptanceTester $I)
	{
		...
		$I->click("//nav//a[span[contains(., 'SimpleSubCategory" . msq("SimpleSubCategory") . "')]]"); // stepKey: toCategorySelectCategory
		...
		$I->see("Simple Product " . msq("SimpleProduct"), ".product-item-name"); // stepKey: seeProductNameSeeProductName
