...
/**
 * @Title("MC-62: Admin should be able to create a cart price rule of type Fixed amount discount")
 * @Description("Admin should be able to create a cart price rule of type Fixed amount discount<h3>Test files</h3>app/code/Magento/SalesRule/Test/Mftf/Test/AdminCreateFixedAmountDiscountTest.xml<br>")
 * @TestCaseId("MC-62")
 * @group SalesRule
 */
class AdminCreateFixedAmountDiscountTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateFixedAmountDiscountTest(AcceptanceTester $I)
	{
		...
		$I->see("-$20.00", "td[data-th='Discount']"); // stepKey: seeDiscountTotalVerifyStorefront
