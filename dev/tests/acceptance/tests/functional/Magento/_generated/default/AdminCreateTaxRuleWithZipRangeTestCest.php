 ...
 * @Description("Test log in to Create Tax Rule and Create tax rule with Zip Range<h3>Test files</h3>app/code/Magento/Tax/Test/Mftf/Test/AdminCreateTaxRuleWithZipRangeTest.xml<br>")
 * @TestCaseId("MC-5326")
 * @group tax
 * @group mtf_migrated
 */
