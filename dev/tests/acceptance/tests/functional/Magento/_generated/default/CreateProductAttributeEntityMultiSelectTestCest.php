...
/**
 * @Title("MC-10888: Admin should be able to create a MultiSelect product attribute")
 * @Description("Admin should be able to create a MultiSelect product attribute<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/CreateProductAttributeEntityTest/CreateProductAttributeEntityMultiSelectTest.xml<br>")
 * @TestCaseId("MC-10888")
 * @group Catalog
 * @group mtf_migrated
 */
class CreateProductAttributeEntityMultiSelectTestCest
{
    /**
	...
	public function _after(AcceptanceTester $I)
	{
		...
		$I->fillField("#attributeGrid_filter_frontend_label", "attribute" . msq("multiselectProductAttribute")); // stepKey: navigateToAttributeEditPage1GoToEditPage
	 ...
	 * @throws \Exception
	 */
	public function CreateProductAttributeEntityMultiSelectTest(AcceptanceTester $I)
	{
		...
		$I->fillField("#attribute_label", "attribute" . msq("multiselectProductAttribute")); // stepKey: fillDefaultLabelCreateAttribute
		$I->selectOption("#frontend_input", "multiselect"); // stepKey: checkInputTypeCreateAttribute
		...
		$I->fillField("#attributeGrid_filter_frontend_label", "attribute" . msq("multiselectProductAttribute")); // stepKey: navigateToAttributeEditPage1GoToEditPage1
		...
		$I->fillField("tbody[data-role='options-container'] tr:nth-child(1) td:nth-child(3) input", "opt1Admin" . msq("multiselectProductAttribute")); // stepKey: fillAdminCreateOption1
		$I->fillField("tbody[data-role='options-container'] tr:nth-child(1) td:nth-child(4) input", "opt1Front" . msq("multiselectProductAttribute")); // stepKey: fillStoreViewCreateOption1
		...
		$I->fillField("tbody[data-role='options-container'] tr:nth-child(2) td:nth-child(3) input", "opt2Admin" . msq("multiselectProductAttribute")); // stepKey: fillAdminCreateOption2
		$I->fillField("tbody[data-role='options-container'] tr:nth-child(2) td:nth-child(4) input", "opt2Front" . msq("multiselectProductAttribute")); // stepKey: fillStoreViewCreateOption2
		...
		$I->fillField("tbody[data-role='options-container'] tr:nth-child(3) td:nth-child(3) input", "opt3Admin" . msq("multiselectProductAttribute")); // stepKey: fillAdminCreateOption3
		$I->fillField("tbody[data-role='options-container'] tr:nth-child(3) td:nth-child(4) input", "opt3Front" . msq("multiselectProductAttribute")); // stepKey: fillStoreViewCreateOption3
		...
		$I->comment("Perform appropriate assertions against multiselectProductAttribute entity");
		...
		$I->fillField("#attributeGrid_filter_frontend_label", "attribute" . msq("multiselectProductAttribute")); // stepKey: navigateToAttributeEditPage1GoToEditPageForAssertions
		...
		$I->seeInField("#attribute_label", "attribute" . msq("multiselectProductAttribute")); // stepKey: assertLabel
		$I->seeOptionIsSelected("#frontend_input", "Multiple Select"); // stepKey: assertInputType
		$I->seeOptionIsSelected("#is_required", "No"); // stepKey: assertRequired
		$I->seeInField("#attribute_code", "attribute" . msq("multiselectProductAttribute")); // stepKey: assertAttrCode
		$I->comment("Assert options are in order and with correct attributes");
		$I->seeInField("tbody[data-role='options-container'] tr:nth-child(1) td:nth-child(3) input", "opt1Admin" . msq("multiselectProductAttribute")); // stepKey: seeOption1Admin
		$I->seeInField("tbody[data-role='options-container'] tr:nth-child(1) td:nth-child(4) input", "opt1Front" . msq("multiselectProductAttribute")); // stepKey: seeOption1StoreView
		$I->dontSeeCheckboxIsChecked("tbody[data-role='options-container'] tr:nth-child(1) .input-radio"); // stepKey: dontSeeOption1Default
		$I->seeInField("tbody[data-role='options-container'] tr:nth-child(2) td:nth-child(3) input", "opt2Admin" . msq("multiselectProductAttribute")); // stepKey: seeOption2Admin
		$I->seeInField("tbody[data-role='options-container'] tr:nth-child(2) td:nth-child(4) input", "opt2Front" . msq("multiselectProductAttribute")); // stepKey: seeOption2StoreView
		$I->dontSeeCheckboxIsChecked("tbody[data-role='options-container'] tr:nth-child(2) .input-radio"); // stepKey: dontSeeOption2Default
		$I->seeInField("tbody[data-role='options-container'] tr:nth-child(3) td:nth-child(3) input", "opt3Admin" . msq("multiselectProductAttribute")); // stepKey: seeOption3Admin
		$I->seeInField("tbody[data-role='options-container'] tr:nth-child(3) td:nth-child(4) input", "opt3Front" . msq("multiselectProductAttribute")); // stepKey: seeOption3StoreView
		$I->seeCheckboxIsChecked("tbody[data-role='options-container'] tr:nth-child(3) .input-radio"); // stepKey: seeOption3Default
		$I->comment("Go to New Product page, add Attribute and check multiselect values");
		...
		$I->fillField(".product_form_product_form_add_attribute_modal input[name='attribute_code']", "attribute" . msq("multiselectProductAttribute")); // stepKey: fillCodeAddAttributeToProduct
		...
		$I->waitForElementVisible("div[data-index='attribute" . msq("multiselectProductAttribute") . "'] .admin__field-control select", 30); // stepKey: waitforLabel
		$I->seeOptionIsSelected("div[data-index='attribute" . msq("multiselectProductAttribute") . "'] .admin__field-control select", "opt3Admin" . msq("multiselectProductAttribute")); // stepKey: seeDefaultIsCorrect
		$I->see("opt1Admin" . msq("multiselectProductAttribute"), "div[data-index='attribute" . msq("multiselectProductAttribute") . "'] .admin__field-control select"); // stepKey: seeOption1Available
		$I->see("opt2Admin" . msq("multiselectProductAttribute"), "div[data-index='attribute" . msq("multiselectProductAttribute") . "'] .admin__field-control select"); // stepKey: seeOption2Available
		$I->see("opt3Admin" . msq("multiselectProductAttribute"), "div[data-index='attribute" . msq("multiselectProductAttribute") . "'] .admin__field-control select"); // stepKey: seeOption3Available
	}
}
