...
/**
 * @Title("MC-14004: Export Simple product and Configurable products with assigned images")
 ...
 * @group mtf_migrated
 */
class AdminExportSimpleProductAndConfigurableProductsWithAssignedImagesTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminExportSimpleProductAndConfigurableProductsWithAssignedImagesTest(AcceptanceTester $I)
	{
		...
		$I->comment('[assertExportFileContainsConfigurableProductImage] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::assertFileContainsString()');
