...
/**
 * @Title("MC-5307: Create customer, without address")
 * @Description("Login as admin and create a customer without address<h3>Test files</h3>app/code/Magento/Customer/Test/Mftf/Test/AdminCreateCustomerWithoutAddressTest.xml<br>")
 * @TestCaseId("MC-5307")
 * @group mtf_migrated
 */
class AdminCreateCustomerWithoutAddressTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateCustomerWithoutAddressTest(AcceptanceTester $I)
	{
