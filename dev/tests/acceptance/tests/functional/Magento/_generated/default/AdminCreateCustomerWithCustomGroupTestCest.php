 ...
 * @Description("Login as admin and create customer with custom group<h3>Test files</h3>app/code/Magento/Customer/Test/Mftf/Test/AdminCreateCustomerWithCustomGroupTest.xml<br>")
 * @TestCaseId("MC-5313")
 * @group mtf_migrated
 */
class AdminCreateCustomerWithCustomGroupTestCest
{
	...
	public function AdminCreateCustomerWithCustomGroupTest(AcceptanceTester $I)
	{
		...
		$flushSpecifiedCacheFlushCache = $I->magentoCLI("cache:flush", 60, "compiled_config"); // stepKey: flushSpecifiedCacheFlushCache
