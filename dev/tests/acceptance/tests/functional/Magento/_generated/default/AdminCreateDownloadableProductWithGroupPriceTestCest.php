...
/**
 * @Title("MC-14514: Create downloadable product with group price test")
 * @Description("Admin should be able to create downloadable product with group price<h3>Test files</h3>app/code/Magento/Downloadable/Test/Mftf/Test/AdminCreateDownloadableProductWithGroupPriceTest.xml<br>")
 * @TestCaseId("MC-14514")
 * @group Downloadable
 * @group mtf_migrated
 */
class AdminCreateDownloadableProductWithGroupPriceTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateDownloadableProductWithGroupPriceTest(AcceptanceTester $I)
	{
		...
		$I->see("$90.00", "div.price-box.price-final_price [data-price-type='finalPrice'] .price"); // stepKey: assertGroupPrice
