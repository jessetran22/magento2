...
/**
 * @Title("MC-65: Admin should be able to create a catalog price rule applied as a percentage of original (for simple product)")
 * @Description("Admin should be able to create a catalog price rule applied as a percentage of original (for simple product)<h3>Test files</h3>app/code/Magento/CatalogRule/Test/Mftf/Test/AdminCreateCatalogPriceRuleTest/AdminCreateCatalogPriceRuleByPercentTest.xml<br>")
 * @TestCaseId("MC-65")
 * @group CatalogRule
 */
class AdminCreateCatalogPriceRuleByPercentTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateCatalogPriceRuleByPercentTest(AcceptanceTester $I)
	{
