 ...
 * @Description("After selecting a simple product when adding Admin should be switch to virtual implicitly<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/AdminCreateAndSwitchProductType/AdminCreateSimpleProductSwitchToVirtualTest.xml<br>")
 * @TestCaseId("MC-10925")
 * @group catalog
 * @group mtf_migrated
 */
