...
/**
 * @Title("MC-14215: Delete Dynamic Bundle Product from Wishlist on Frontend")
 * @Description("Delete Dynamic Bundle Product from Wishlist on Frontend<h3>Test files</h3>app/code/Magento/Wishlist/Test/Mftf/Test/StorefrontDeleteBundleDynamicProductFromWishlistTest.xml<br>")
 * @TestCaseId("MC-14215")
 * @group wishlist
 * @group mtf_migrated
 */
class StorefrontDeleteBundleDynamicProductFromWishlistTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function StorefrontDeleteBundleDynamicProductFromWishlistTest(AcceptanceTester $I)
	{
