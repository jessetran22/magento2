...
/**
 * @Title("MAGETWO-24729: Search product in advanced search by partial sku and description")
 * @Description("Search product in advanced search by partial sku and description<h3>Test files</h3>app/code/Magento/CatalogSearch/Test/Mftf/Test/StorefrontAdvancedSearchByPartialSkuAndDescriptionTest.xml<br>")
 * @TestCaseId("MAGETWO-24729")
 * @group searchFrontend
 * @group mtf_migrated
 */
class StorefrontAdvancedSearchByPartialSkuAndDescriptionTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function StorefrontAdvancedSearchByPartialSkuAndDescriptionTest(AcceptanceTester $I)
	{
		...
		$I->fillField("#sku", "abc"); // stepKey: fillSkuSearch
