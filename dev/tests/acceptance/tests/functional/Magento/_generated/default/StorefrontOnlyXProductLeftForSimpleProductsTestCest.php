 ...
 * @Description("See Only * Left on product page if Only X left Threshold was set<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/StorefrontOnlyXProductLeftForSimpleProductsTest.xml<br>")
 * @TestCaseId("MC-35235")
 */
