...
/**
 * @Title("MC-14664: Update disabled HTML checkout agreement")
 * @Description("Admin should be able to update disabled HTML checkout agreement<h3>Test files</h3>app/code/Magento/CheckoutAgreements/Test/Mftf/Test/AdminUpdateDisabledHtmlTermEntityTest.xml<br>")
 * @TestCaseId("MC-14664")
 * @group checkoutAgreements
 * @group mtf_migrated
 */
class AdminUpdateDisabledHtmlTermEntityTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminUpdateDisabledHtmlTermEntityTest(AcceptanceTester $I)
	{
		...
		$I->fillField("#name", "name" . msq("disabledHtmlTerm")); // stepKey: fillFieldConditionNameFillNewTerm
		$I->selectOption("#is_active", "Disabled"); // stepKey: selectOptionIsActiveFillNewTerm
		$I->selectOption("#is_html", "HTML"); // stepKey: selectOptionIsHtmlFillNewTerm
		...
		$I->fillField("#checkbox_text", "test_checkbox" . msq("disabledHtmlTerm")); // stepKey: fillFieldCheckboxTextFillNewTerm
		$I->fillField("#content", "<html>"); // stepKey: fillFieldContentFillNewTerm
		...
		$I->amOnPage((getenv("MAGENTO_BACKEND_BASE_URL") ? rtrim(getenv("MAGENTO_BACKEND_BASE_URL"), "/") : "") . "/" . getenv("MAGENTO_BACKEND_NAME") . "/checkout/agreement/"); // stepKey: onTermGridPageOpenTermsGrid
		...
		$I->fillField("#agreementGrid_filter_name", "name" . msq("disabledHtmlTerm")); // stepKey: fillTermNameFilterOpenUpdateTerm
		...
		$I->fillField("#name", "name" . msq("activeTextTerm")); // stepKey: fillFieldConditionNameFillUpdateTerm
		$I->selectOption("#is_active", "Enabled"); // stepKey: selectOptionIsActiveFillUpdateTerm
		$I->selectOption("#is_html", "Text"); // stepKey: selectOptionIsHtmlFillUpdateTerm
		...
		$I->fillField("#checkbox_text", "test_checkbox" . msq("activeTextTerm")); // stepKey: fillFieldCheckboxTextFillUpdateTerm
		$I->fillField("#content", "TestMessage" . msq("activeTextTerm")); // stepKey: fillFieldContentFillUpdateTerm
		...
		$I->amOnPage((getenv("MAGENTO_BACKEND_BASE_URL") ? rtrim(getenv("MAGENTO_BACKEND_BASE_URL"), "/") : "") . "/" . getenv("MAGENTO_BACKEND_NAME") . "/checkout/agreement/"); // stepKey: onTermGridPageOpenNewTermsGrid
		...
		$I->fillField("#agreementGrid_filter_name", "name" . msq("activeTextTerm")); // stepKey: fillTermNameFilterAssertTermInGrid
		...
		$I->see("name" . msq("activeTextTerm"), ".data-grid>tbody>tr>td.col-name"); // stepKey: assertTermInGridAssertTermInGrid
