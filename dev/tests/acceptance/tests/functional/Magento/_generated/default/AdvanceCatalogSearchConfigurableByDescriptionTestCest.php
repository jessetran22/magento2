...
/**
 * @Title("MC-237: Guest customer should be able to advance search configurable product with product description")
 * @Description("Guest customer should be able to advance search configurable product with product description<h3>Test files</h3>app/code/Magento/ConfigurableProduct/Test/Mftf/Test/AdvanceCatalogSearchConfigurableTest/AdvanceCatalogSearchConfigurableByDescriptionTest.xml<br>")
 * @TestCaseId("MC-237")
 * @group ConfigurableProduct
 */
class AdvanceCatalogSearchConfigurableByDescriptionTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdvanceCatalogSearchConfigurableByDescriptionTest(AcceptanceTester $I)
	{
