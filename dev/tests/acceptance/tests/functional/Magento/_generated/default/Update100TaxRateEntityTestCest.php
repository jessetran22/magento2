 ...
 * @Description("Test log in to Tax Rate and Update 100 Rate<h3>Test files</h3>app/code/Magento/Tax/Test/Mftf/Test/Update100TaxRateEntityTest.xml<br>")
 * @TestCaseId("MC-5328")
 * @group tax
 * @group mtf_migrated
 */
class Update100TaxRateEntityTestCest
{
	...
	public function Update100TaxRateEntityTest(AcceptanceTester $I)
	{
		...
		$I->fillField("#tax_rate_grid_filter_code", "Tax Rate " . msq("taxRateCustomRateUS")); // stepKey: fillNameFilterFillTaxIdentifierField3
