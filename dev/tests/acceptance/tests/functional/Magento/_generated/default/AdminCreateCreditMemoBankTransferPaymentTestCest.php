...
/**
 * @Title("MC-15862: Create Credit Memo with Bank Transfer Payment")
 * @Description("Create Credit Memo with Bank Transfer Payment and assert 0 shipping refund<h3>Test files</h3>app/code/Magento/Sales/Test/Mftf/Test/AdminCreateCreditMemoBankTransferPaymentTest.xml<br>")
 * @TestCaseId("MC-15862")
 * @group sales
 * @group mtf_migrated
 */
class AdminCreateCreditMemoBankTransferPaymentTestCest
{
    /**
	...
	public function _before(AcceptanceTester $I)
	{
		...
		$I->comment("Enable payment method one of \"Check/Money Order\", \"Bank Transfer Payment\" and  shipping method one of \"Flat Rate\"");
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateCreditMemoBankTransferPaymentTest(AcceptanceTester $I)
	{
		...
		$I->checkOption("#p_method_banktransfer"); // stepKey: checkBankTransfer
		$I->waitForPageLoad(30); // stepKey: checkBankTransferWaitForPageLoad
		...
		$I->dontSeeElement("#order_creditmemo"); // stepKey: assertNoCreditMemoButton
		...
		$I->fillField("input[name='base_grand_total[from]']", "$555.00"); // stepKey: fillRefundedFromAssertRefund
		$I->fillField("input[name='base_grand_total[to]']", "$555.00"); // stepKey: fillRefundedToAssertRefund
		...
		$I->see("$555.00", "div.data-grid-cell-content"); // stepKey: refundedPriceAssertRefund
