 ...
 * @Description("Admin should not be able to submit orders without selecting a payment method when there is more than one<h3>Test files</h3>app/code/Magento/Sales/Test/Mftf/Test/AdminSubmitsOrderPaymentMethodValidationTest.xml<br>")
 * @TestCaseId("MC-6029")
 * @group sales
 */
