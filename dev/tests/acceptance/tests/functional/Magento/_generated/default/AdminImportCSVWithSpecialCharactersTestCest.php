...
/**
 * @Title("MC-6416: Import CSV with special characters")
 * @Description("Import CSV with special characters<h3>Test files</h3>app/code/Magento/ImportExport/Test/Mftf/Test/AdminImportCSVWithSpecialCharactersTest.xml<br>")
 * @TestCaseId("MC-6416")
 * @group importExport
 */
class AdminImportCSVWithSpecialCharactersTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminImportCSVWithSpecialCharactersTest(AcceptanceTester $I)
	{
		...
		$I->attachFile("#import_file", "importSpecChars.csv"); // stepKey: attachFileForImportAdminImportProducts
		...
		$I->see("File must be saved in UTF-8 encoding for proper import", "#import_file-note"); // stepKey: seeNoteMessage
		$I->waitForPageLoad(30); // stepKey: seeNoteMessageWaitForPageLoad
		$I->see("File is valid! To start import process press \"Import\" button", ".message-success"); // stepKey: seeSuccessMessage
	}
}
