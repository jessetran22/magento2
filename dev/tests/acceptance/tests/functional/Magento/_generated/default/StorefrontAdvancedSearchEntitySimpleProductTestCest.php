...
/**
 * @Title("MAGETWO-12421: Use Advanced Search to Find the Product")
 * @Description("Use Advanced Search to Find the Product<h3>Test files</h3>app/code/Magento/CatalogSearch/Test/Mftf/Test/StorefrontAdvancedSearchEntitySimpleProductTest.xml<br>")
 * @TestCaseId("MAGETWO-12421")
 * @group searchFrontend
 * @group mtf_migrated
 */
class StorefrontAdvancedSearchEntitySimpleProductTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function StorefrontAdvancedSearchEntitySimpleProductTest(AcceptanceTester $I)
	{
