...
/**
 * @Title("MC-14198: Admin reports by products navigate menu test")
 * @Description("Admin should be able to navigate to Reports > By Products<h3>Test files</h3>app/code/Magento/Review/Test/Mftf/Test/AdminReportsByProductsNavigateMenuTest.xml<br>")
 * @TestCaseId("MC-14198")
 * @group menu
 * @group mtf_migrated
 */
class AdminReportsByProductsNavigateMenuTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminReportsByProductsNavigateMenuTest(AcceptanceTester $I)
	{
		...
		$I->see("Product Reviews Report", ".page-title-wrapper h1"); // stepKey: assertPageTitleSeePageTitle
