...
/**
 * @Title("[NO TESTCASEID]: Check thumbnail images and active image for Configurable Product with swatch attribute")
 * @Description("Login as admin, create attribute with two options, configurable product with two                 associated simple products. Add few images for products, check the fotorama thumbnail images                 (visible and active) for each selected option for the configurable product<h3>Test files</h3>app/code/Magento/Swatches/Test/Mftf/Test/StorefrontConfigurableSwatchOptionsThumbImagesTest.xml<br>")
 * @group swatches
 */
class StorefrontConfigurableSwatchOptionsThumbImagesTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function StorefrontConfigurableSwatchOptionsThumbImagesTest(AcceptanceTester $I)
	{
		...
		$I->comment("Entering Action Group [selectFirstOptionValue] StorefrontSelectSwatchOptionOnProductPageActionGroup");
		$I->click("div.swatch-option[data-option-label='" . $I->retrieveEntityField('getConfigAttributeOption1', 'label', 'test') . "']"); // stepKey: clickSwatchOptionSelectFirstOptionValue
		$I->comment("Exiting Action Group [selectFirstOptionValue] StorefrontSelectSwatchOptionOnProductPageActionGroup");
		...
		$I->comment("Entering Action Group [selectSecondOptionValue] StorefrontSelectSwatchOptionOnProductPageActionGroup");
		$I->click("div.swatch-option[data-option-label='" . $I->retrieveEntityField('getConfigAttributeOption2', 'label', 'test') . "']"); // stepKey: clickSwatchOptionSelectSecondOptionValue
		$I->comment("Exiting Action Group [selectSecondOptionValue] StorefrontSelectSwatchOptionOnProductPageActionGroup");
