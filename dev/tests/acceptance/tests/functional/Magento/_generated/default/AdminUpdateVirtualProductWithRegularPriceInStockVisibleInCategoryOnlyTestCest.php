 ...
 * @Description("Test log in to Update Virtual Product and Update Virtual Product with Regular Price (In Stock) Visible in Category Only<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/AdminUpdateVirtualProductWithRegularPriceInStockVisibleInCategoryOnlyTest.xml<br>")
 * @TestCaseId("MC-6495")
 * @group catalog
 * @group mtf_migrated
 */
class AdminUpdateVirtualProductWithRegularPriceInStockVisibleInCategoryOnlyTestCest
{
	...
	public function AdminUpdateVirtualProductWithRegularPriceInStockVisibleInCategoryOnlyTest(AcceptanceTester $I)
	{
		...
		$I->comment("Entering Action Group [fillVirtualProductSkuOnStorefrontPage] StorefrontCheckQuickSearchStringActionGroup");
		$I->fillField("#search", "virtual_sku" . msq("updateVirtualProductRegularPrice")); // stepKey: fillInputFillVirtualProductSkuOnStorefrontPage
		$I->submitForm("#search", []); // stepKey: submitQuickSearchFillVirtualProductSkuOnStorefrontPage
		$I->seeInCurrentUrl("/catalogsearch/result/"); // stepKey: checkUrlFillVirtualProductSkuOnStorefrontPage
		$I->dontSeeInCurrentUrl("form_key="); // stepKey: checkUrlFormKeyFillVirtualProductSkuOnStorefrontPage
		$I->seeInTitle("Search results for: 'virtual_sku" . msq("updateVirtualProductRegularPrice") . "'"); // stepKey: assertQuickSearchTitleFillVirtualProductSkuOnStorefrontPage
		$I->see("Search results for: 'virtual_sku" . msq("updateVirtualProductRegularPrice") . "'", ".page-title span"); // stepKey: assertQuickSearchNameFillVirtualProductSkuOnStorefrontPage
		$I->comment("Exiting Action Group [fillVirtualProductSkuOnStorefrontPage] StorefrontCheckQuickSearchStringActionGroup");
		...
		$I->dontSee("VirtualProduct" . msq("updateVirtualProductRegularPrice"), ".product-item-name"); // stepKey: dontSeeProductNameDontSeeVirtualProductName
