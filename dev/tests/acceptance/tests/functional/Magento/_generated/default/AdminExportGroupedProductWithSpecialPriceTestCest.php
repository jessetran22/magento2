...
class AdminExportGroupedProductWithSpecialPriceTestCest
{
	 ...
	 * @throws \Exception
	 */
	public function AdminExportGroupedProductWithSpecialPriceTest(AcceptanceTester $I)
	{
		...
		$I->comment('[assertExportFileContainsFirstSimpleProduct] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::assertFileContainsString()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->assertFileContainsString("var/export/{$grabNameFile}", $I->retrieveEntityField('createFirstSimpleProduct', 'name', 'test'), ''); // stepKey: assertExportFileContainsFirstSimpleProduct
		$I->comment('[assertExportFileContainsSecondSimpleProduct] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::assertFileContainsString()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->assertFileContainsString("var/export/{$grabNameFile}", $I->retrieveEntityField('createSecondSimpleProduct', 'name', 'test'), ''); // stepKey: assertExportFileContainsSecondSimpleProduct
		$I->comment('[assertExportFileContainsGroupedProduct] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::assertFileContainsString()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->assertFileContainsString("var/export/{$grabNameFile}", $I->retrieveEntityField('createGroupedProduct', 'name', 'test'), ''); // stepKey: assertExportFileContainsGroupedProduct
		$I->comment('[assertExportFileContainsFirstChildGroupedProduct] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::assertFileContainsString()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->assertFileContainsString("var/export/{$grabNameFile}", $I->retrieveEntityField('createFirstSimpleProduct', 'sku', 'test') . "=" . $I->retrieveEntityField('createFirstSimpleProduct', 'quantity', 'test'), ''); // stepKey: assertExportFileContainsFirstChildGroupedProduct
		$I->comment('[assertExportFileContainsSecondChildGroupedProduct] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::assertFileContainsString()');
