...
/**
 * @Title("MC-298: Tax for Virtual Product Quote should be recalculated in Shopping Cart for Guest Customer")
 * @Description("Tax for Virtual Product Quote should be recalculated in Shopping Cart for Guest Customer<h3>Test files</h3>app/code/Magento/Tax/Test/Mftf/Test/StorefrontTaxQuoteCartTest/StorefrontTaxQuoteCartGuestVirtualTest.xml<br>")
 * @TestCaseId("MC-298")
 * @group Tax
 */
class StorefrontTaxQuoteCartGuestVirtualTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function StorefrontTaxQuoteCartGuestVirtualTest(AcceptanceTester $I)
	{
