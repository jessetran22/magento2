...
/**
 * @Title("MAGETWO-94953: Admin should be able to set customer default shipping address")
 * @Description("Admin should be able to set customer default shipping address from customer addresses grid row actions<h3>Test files</h3>app/code/Magento/Customer/Test/Mftf/Test/AdminSetCustomerDefaultShippingAddressTest.xml<br>")
 * @TestCaseId("MAGETWO-94953")
 * @group customer
 */
class AdminSetCustomerDefaultShippingAddressTestCest
{
	/**
	...
	/**
	 * @Stories({"Set customer default shipping address"})
	 ...
	 * @throws \Exception
	 */
	public function AdminSetCustomerDefaultShippingAddressTest(AcceptanceTester $I)
	{
		$I->comment("-
		...
		$I->see("The customer does not have default shipping address", "//div[@class='customer-default-shipping-address-content']//address//span"); // stepKey: assertThatThereIsNoDefaultShippingAddress
		...
		$I->comment("Step4. Click *Set as default shipping*");
		$I->click("//tr[contains(@data-repeat-index, '0')]//a[contains(@data-action,'item-setDefaultShipping')]"); // stepKey: clickOnSetAddressAsDefaultShipping
		$I->waitForPageLoad(30); // stepKey: clickOnSetAddressAsDefaultShippingWaitForPageLoad
		$I->comment("Step5. Press *Ok* button on the pop-up");
		$I->click("aside.confirm .modal-footer button.action-accept"); // stepKey: confirmSetAddressAsDefaultShipping
		$I->waitForPageLoad(60); // stepKey: confirmSetAddressAsDefaultShippingWaitForPageLoad
		$I->seeElement("//div[@class='customer-default-shipping-address-content']//div[@class='address_details']"); // stepKey: seeDefaultShippingAddressSection
		$I->see("368 Broadway St.", "//div[@class='customer-default-shipping-address-content']//div[@class='address_details']"); // stepKey: assertDefaultShippingAddressIsSet
		$I->click("//button[@data-index='edit_shipping_address']"); // stepKey: clickEditDefaultShippingAddress
		$I->waitForPageLoad(30); // stepKey: waitForCustomerAddressAddUpdateFormLoad
		$I->assertElementContainsAttribute("//div[@class='admin__field-control']//input[@name='default_shipping']", "value", "1"); // stepKey: assertDefaultShippingCheckboxIsCheckedOnCustomerAddressAddUpdateForm
	}
}
