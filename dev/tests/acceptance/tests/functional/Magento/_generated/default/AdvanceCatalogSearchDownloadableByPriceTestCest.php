...
/**
 * @Title("MC-246: Guest customer should be able to advance search Downloadable product with product price")
 * @Description("Guest customer should be able to advance search Downloadable product with product price<h3>Test files</h3>app/code/Magento/Downloadable/Test/Mftf/Test/AdvanceCatalogSearchDownloadableProductTest/AdvanceCatalogSearchDownloadableByPriceTest.xml<br>")
 * @TestCaseId("MC-246")
 * @group Downloadable
 */
class AdvanceCatalogSearchDownloadableByPriceTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdvanceCatalogSearchDownloadableByPriceTest(AcceptanceTester $I)
	{
