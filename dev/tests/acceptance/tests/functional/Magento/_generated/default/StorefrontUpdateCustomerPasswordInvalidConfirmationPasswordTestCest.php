...
/**
 * @Title("MC-10918: Update Customer Password on Storefront, Invalid Confirmation Password")
 * @Description("Update Customer Password on Storefront, Invalid Confirmation Password<h3>Test files</h3>app/code/Magento/Customer/Test/Mftf/Test/StorefrontUpdateCustomerPasswordTest/StorefrontUpdateCustomerPasswordInvalidConfirmationPasswordTest.xml<br>")
 * @TestCaseId("MC-10918")
 * @group Customer
 * @group mtf_migrated
 */
class StorefrontUpdateCustomerPasswordInvalidConfirmationPasswordTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function StorefrontUpdateCustomerPasswordInvalidConfirmationPasswordTest(AcceptanceTester $I)
	{
		...
		$I->see("Please enter the same value again.", "#password-confirmation-error"); // stepKey: verifyMessage
