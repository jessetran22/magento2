 ...
 * @Description("Customer should only see cart price rule discount if condition subtotal equals or greater than<h3>Test files</h3>app/code/Magento/SalesRule/Test/Mftf/Test/StorefrontCartPriceRuleSubtotalTest.xml<br>")
 * @TestCaseId("MC-235")
 * @group SalesRule
 */
class StorefrontCartPriceRuleSubtotalTestCest
{
	...
	public function StorefrontCartPriceRuleSubtotalTest(AcceptanceTester $I)
	{
		...
		$I->see("-$0.01", "td[data-th='Discount']"); // stepKey: assertDiscountSeeDiscountTotal
