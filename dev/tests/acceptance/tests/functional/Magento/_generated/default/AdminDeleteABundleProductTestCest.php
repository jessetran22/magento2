 ...
 * @Description("Admin should be able to delete a bundle product<h3>Test files</h3>app/code/Magento/Bundle/Test/Mftf/Test/AdminDeleteABundleProductTest.xml<br>")
 * @TestCaseId("MC-216")
 * @group Bundle
 */
class AdminDeleteABundleProductTestCest
{
	...
	public function AdminDeleteABundleProductTest(AcceptanceTester $I)
	{
		...
		$I->comment("Entering Action Group [goToCatalogPage] AdminOpenCatalogProductPageActionGroup");
		$I->amOnPage((getenv("MAGENTO_BACKEND_BASE_URL") ? rtrim(getenv("MAGENTO_BACKEND_BASE_URL"), "/") : "") . "/" . getenv("MAGENTO_BACKEND_NAME") . "/catalog/product/"); // stepKey: openCatalogProductPageGoToCatalogPage
		$I->waitForPageLoad(30); // stepKey: waitForPageToLoadGoToCatalogPage
		$I->comment("Exiting Action Group [goToCatalogPage] AdminOpenCatalogProductPageActionGroup");
