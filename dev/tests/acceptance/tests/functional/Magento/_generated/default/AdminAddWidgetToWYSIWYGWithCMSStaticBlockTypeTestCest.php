 ...
 * @Description("Admin should be able to create a CMS page with widget type: CMS Static Block<h3>Test files</h3>app/code/Magento/Cms/Test/Mftf/Test/AdminAddWidgetToWYSIWYGWithCMSStaticBlockTypeTest.xml<br>")
