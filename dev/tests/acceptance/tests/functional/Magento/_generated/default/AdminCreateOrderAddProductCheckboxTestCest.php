 ...
 * @Description("Create order in Admin panel, add product by clicking checkbox, and verify it is checked<h3>Test files</h3>app/code/Magento/Sales/Test/Mftf/Test/AdminCreateOrderAddProductCheckboxTest.xml<br>")
 * @group Sales
 */
class AdminCreateOrderAddProductCheckboxTestCest
{
	...
	public function AdminCreateOrderAddProductCheckboxTest(AcceptanceTester $I)
	{
		...
		$I->comment("Entering Action Group [clickAddProducts] AdminAddSimpleProductToOrderAndCheckCheckboxActionGroup");
		$I->click("//section[@id='order-items']/div/div/button/span[text() = 'Add Products']"); // stepKey: clickAddProductsClickAddProducts
		$I->waitForPageLoad(30); // stepKey: clickAddProductsClickAddProductsWaitForPageLoad
		$I->fillField("#sales_order_create_search_grid_filter_sku", $I->retrieveEntityField('createSimpleProduct', 'sku', 'test')); // stepKey: fillSkuFilterClickAddProducts
		$I->click("#sales_order_create_search_grid [data-action='grid-filter-apply']"); // stepKey: clickSearchClickAddProducts
		$I->waitForPageLoad(30); // stepKey: clickSearchClickAddProductsWaitForPageLoad
		$I->scrollTo("#sales_order_create_search_grid_table > tbody tr:nth-of-type(1) td.col-select [type=checkbox]", 0, -100); // stepKey: scrollToCheckColumnClickAddProducts
		$I->checkOption("#sales_order_create_search_grid_table > tbody tr:nth-of-type(1) td.col-select [type=checkbox]"); // stepKey: selectProductClickAddProducts
		$I->seeCheckboxIsChecked("#sales_order_create_search_grid_table > tbody tr:nth-of-type(1) td.col-select [type=checkbox]"); // stepKey: verifyProductCheckedClickAddProducts
		$I->fillField("#sales_order_create_search_grid_table > tbody tr:nth-of-type(1) td.col-qty [name='qty']", "1"); // stepKey: fillProductQtyClickAddProducts
		$I->scrollTo("#order-search .admin__page-section-title .actions button.action-add", 0, -100); // stepKey: scrollToAddSelectedButtonClickAddProducts
		$I->waitForPageLoad(30); // stepKey: scrollToAddSelectedButtonClickAddProductsWaitForPageLoad
		$I->click("#order-search .admin__page-section-title .actions button.action-add"); // stepKey: clickAddSelectedProductsClickAddProducts
		$I->waitForPageLoad(30); // stepKey: clickAddSelectedProductsClickAddProductsWaitForPageLoad
		$I->waitForLoadingMaskToDisappear(); // stepKey: waitForOptionsToLoadClickAddProducts
		$I->comment("Exiting Action Group [clickAddProducts] AdminAddSimpleProductToOrderAndCheckCheckboxActionGroup");
