 ...
 * @Description("Customers can filter products using visual swatches<h3>Test files</h3>app/code/Magento/Swatches/Test/Mftf/Test/StorefrontFilterByVisualSwatchTest.xml<br>")
 * @TestCaseId("MC-3082")
 * @group Swatches
 */
