...
/**
 * @Title("MAGETWO-24729: Search product in advanced search by description")
 * @Description("Search product in advanced search by description<h3>Test files</h3>app/code/Magento/CatalogSearch/Test/Mftf/Test/StorefrontAdvancedSearchByDescriptionTest.xml<br>")
 * @TestCaseId("MAGETWO-24729")
 * @group searchFrontend
 * @group mtf_migrated
 */
class StorefrontAdvancedSearchByDescriptionTestCest
{
    /**
	...
	public function _before(AcceptanceTester $I)
	{
		...
		$I->createEntity("createProduct", "hook", "ABC_123_SimpleProduct", [], []); // stepKey: createProduct
	}
	 ...
	 * @throws \Exception
	 */
	public function StorefrontAdvancedSearchByDescriptionTest(AcceptanceTester $I)
	{
		...
		$I->fillField("#description", "dfj_full"); // stepKey: fillDescriptionSearch
