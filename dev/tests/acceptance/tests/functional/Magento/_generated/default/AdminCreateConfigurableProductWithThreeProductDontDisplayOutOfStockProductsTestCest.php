 ...
 * @Description("Admin should be able to create Configurable Product with one out of stock and several in stock options, don't display out of stock products<h3>Test files</h3>app/code/Magento/ConfigurableProduct/Test/Mftf/Test/AdminCreateConfigurableProductWithThreeProductDontDisplayOutOfStockProductsTest.xml<br>")
 * @TestCaseId("MC-13715")
 * @group mtf_migrated
 */
