...
/**
 * @Title("MC-40713: Exclude Website From Customer Group With Global Customer Account Sharing")
 * @Description("Exclude websites from Customer Group with Customer Accounts Sharing is Global<h3>Test files</h3>app/code/Magento/Customer/Test/Mftf/Test/ExcludeWebsiteFromCustomerGroupCustomerAccountSharingGlobalTest.xml<br>")
 * @TestCaseId("MC-40713")
 * @group customers
 */
class ExcludeWebsiteFromCustomerGroupCustomerAccountSharingGlobalTestCest
{
	/**
	...
	public function _before(AcceptanceTester $I)
	{
		...
		$I->comment("Set Customer Accounts Sharing to Global");
		$shareCustomerAccountsGlobal = $I->magentoCLI("config:set customer/account_share/scope 0", 60); // stepKey: shareCustomerAccountsGlobal
		$I->comment($shareCustomerAccountsGlobal);
	...
	public function _after(AcceptanceTester $I)
	{
		...
		$shareCustomerAccountsPerWebsite = $I->magentoCLI("config:set customer/account_share/scope 1", 60); // stepKey: shareCustomerAccountsPerWebsite
		$I->comment($shareCustomerAccountsPerWebsite);
	...
	/**
	 * @Features({"Customer"})
	 * @Stories({"Exclude Website From Customer Group With Global Customer Account Sharing"})
	 ...
	 * @throws \Exception
	 */
	public function ExcludeWebsiteFromCustomerGroupCustomerAccountSharingGlobalTest(AcceptanceTester $I)
	{
