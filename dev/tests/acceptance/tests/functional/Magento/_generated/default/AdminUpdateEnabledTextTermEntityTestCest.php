 ...
 * @Description("Admin should be able to update enabled Text checkout agreement<h3>Test files</h3>app/code/Magento/CheckoutAgreements/Test/Mftf/Test/AdminUpdateEnabledTextTermEntityTest.xml<br>")
 * @TestCaseId("MC-14666")
