 ...
 * @Description("Admin should be able to navigate to Reports > New<h3>Test files</h3>app/code/Magento/Reports/Test/Mftf/Test/AdminReportsNewNavigateMenuTest.xml<br>")
 * @TestCaseId("MC-14166")
 * @group menu
 * @group mtf_migrated
 */
