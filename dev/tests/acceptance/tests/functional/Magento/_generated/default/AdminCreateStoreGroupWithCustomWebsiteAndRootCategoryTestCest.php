...
/**
 * @Title("MC-14299: Create Store Group with Custom Website and Root Category")
 * @Description("Test log in to Stores and Create Store Group with Custom Website and Root Category Test<h3>Test files</h3>app/code/Magento/Store/Test/Mftf/Test/AdminCreateStoreGroupWithCustomWebsiteAndRootCategoryTest.xml<br>")
 * @TestCaseId("MC-14299")
 * @group store
 * @group mtf_migrated
 */
class AdminCreateStoreGroupWithCustomWebsiteAndRootCategoryTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateStoreGroupWithCustomWebsiteAndRootCategoryTest(AcceptanceTester $I)
	{
		$I->comment("Create custom store group with custom website and root category and verify AssertStoreGroupSuccessSaveMessage");
		...
		$I->selectOption("#group_root_category_id", $I->retrieveEntityField('rootCategory', 'name', 'test')); // stepKey: selectStoreStatusCreateCustomStoreGroup
		...
		$I->comment("Entering Action Group [seeCreatedStoreGroupInForm] AssertStoreGroupFormActionGroup");
		$I->comment("Admin creates new Store group");
		$I->click(".col-group_title>a"); // stepKey: clickEditExistingStoreRowSeeCreatedStoreGroupInForm
		$I->waitForPageLoad(30); // stepKey: waitTillAdminSystemStoreGroupPageSeeCreatedStoreGroupInForm
		$I->seeInField("#group_website_id", "Second Website" . msq("customWebsite")); // stepKey: seeAssertWebsiteSeeCreatedStoreGroupInForm
		$I->seeInField("#group_name", "store" . msq("customStoreGroup")); // stepKey: seeAssertStoreGroupNameSeeCreatedStoreGroupInForm
		$I->seeInField("#group_code", "store" . msq("customStoreGroup")); // stepKey: seeAssertStoreGroupCodeSeeCreatedStoreGroupInForm
		$I->seeInField("#group_root_category_id", $I->retrieveEntityField('rootCategory', 'name', 'test')); // stepKey: seeAssertRootCategorySeeCreatedStoreGroupInForm
		$I->comment("Exiting Action Group [seeCreatedStoreGroupInForm] AssertStoreGroupFormActionGroup");
	}
}
