 ...
 * @Description("'Reorder' button is not visible for customer if ordered item is out of stock<h3>Test files</h3>app/code/Magento/Sales/Test/Mftf/Test/AdminCreateOrderAndCheckTheReorderTest.xml<br>")
 * @TestCaseId("MC-22109")
 * @group Sales
 * @group mtf_migrated
 */
