 ...
 * @Description("Admin should be able to navigate to Stores > Product<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/AdminStoresProductNavigateMenuTest.xml<br>")
 * @TestCaseId("MC-14132")
 * @group menu
 * @group mtf_migrated
 */
