 ...
 * @Description("Test log in to Create Tax Rule and Create Defaults Tax Rule<h3>Test files</h3>app/code/Magento/Tax/Test/Mftf/Test/AdminCreateDefaultsTaxRuleTest.xml<br>")
 * @TestCaseId("MC-5323")
 * @group tax
 * @group mtf_migrated
 */
