 ...
 * @Description("Admin should be able to add image to a Category<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/AdminAddImageForCategoryTest.xml<br>")
 * @TestCaseId("MC-188")
 * @group Catalog
 */
