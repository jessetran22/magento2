...
/**
 * @Title("MAGETWO-24729: Search product in advanced search by partial short description")
 * @Description("Search product in advanced search by partial short description<h3>Test files</h3>app/code/Magento/CatalogSearch/Test/Mftf/Test/StorefrontAdvancedSearchByPartialShortDescriptionTest.xml<br>")
 * @TestCaseId("MAGETWO-24729")
 * @group searchFrontend
 * @group mtf_migrated
 */
class StorefrontAdvancedSearchByPartialShortDescriptionTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function StorefrontAdvancedSearchByPartialShortDescriptionTest(AcceptanceTester $I)
	{
