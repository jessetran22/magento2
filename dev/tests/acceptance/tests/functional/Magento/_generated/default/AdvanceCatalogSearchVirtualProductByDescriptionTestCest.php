...
/**
 * @Title("MC-163: Guest customer should be able to advance search virtual product with product description")
 * @Description("Guest customer should be able to advance search virtual product with product description<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/AdvanceCatalogSearchVirtualProductTest/AdvanceCatalogSearchVirtualProductByDescriptionTest.xml<br>")
 * @TestCaseId("MC-163")
 * @group Catalog
 */
class AdvanceCatalogSearchVirtualProductByDescriptionTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdvanceCatalogSearchVirtualProductByDescriptionTest(AcceptanceTester $I)
	{
