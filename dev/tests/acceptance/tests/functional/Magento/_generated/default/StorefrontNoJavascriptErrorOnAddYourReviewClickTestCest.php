 ...
 * @Description("Verify no javascript error occurs when customer clicks 'Add Your Review' link<h3>Test files</h3>app/code/Magento/Review/Test/Mftf/Test/StorefrontNoJavascriptErrorOnAddYourReviewClickTest.xml<br>")
 * @group review
 */
