...
/**
 * @Title("MC-14197: Admin reports by customers navigate menu test")
 * @Description("Admin should be able to navigate to Reports > By Customers<h3>Test files</h3>app/code/Magento/Review/Test/Mftf/Test/AdminReportsByCustomersNavigateMenuTest.xml<br>")
 * @TestCaseId("MC-14197")
 * @group menu
 * @group mtf_migrated
 */
class AdminReportsByCustomersNavigateMenuTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminReportsByCustomersNavigateMenuTest(AcceptanceTester $I)
	{
		...
		$I->see("Customer Reviews Report", ".page-title-wrapper h1"); // stepKey: assertPageTitleSeePageTitle
