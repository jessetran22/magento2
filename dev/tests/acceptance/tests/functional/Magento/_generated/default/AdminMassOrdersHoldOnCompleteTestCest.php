 ...
 * @Description("Try to put order in status Complete on Hold<h3>Test files</h3>app/code/Magento/Sales/Test/Mftf/Test/AdminMassOrdersHoldOnCompleteTest.xml<br>")
 * @TestCaseId("MC-16186")
 * @group sales
 * @group mtf_migrated
 */
class AdminMassOrdersHoldOnCompleteTestCest
{
	...
	public function AdminMassOrdersHoldOnCompleteTest(AcceptanceTester $I)
	{
		...
		$I->updateEntity("createCustomerCart", "test", "CustomerOrderPaymentMethod",["createCustomerCart"]); // stepKey: createFirstOrder
		...
		$I->comment("Comment is added to preserve the step key for backward compatibility");
		$I->createEntity("createShipment", "test", "Shipment", ["createCustomerCart"], []); // stepKey: createShipment
		...
		$I->checkOption("//td/div[text()='$grabOrderId']/../preceding-sibling::td//input"); // stepKey: selectOrderActionHold
