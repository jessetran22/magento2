 ...
 * @Description("Assign custom order status visible on storefront<h3>Test files</h3>app/code/Magento/Sales/Test/Mftf/Test/AssignCustomOrderStatusVisibleOnStorefrontTest.xml<br>")
 * @TestCaseId("MC-16054")
 * @group sales
 * @group mtf_migrated
 */
