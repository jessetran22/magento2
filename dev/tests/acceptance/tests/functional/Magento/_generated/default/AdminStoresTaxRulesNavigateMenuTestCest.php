 ...
 * @Description("Admin should be able to navigate to Stores > Tax Rules<h3>Test files</h3>app/code/Magento/Tax/Test/Mftf/Test/AdminStoresTaxRulesNavigateMenuTest.xml<br>")
 * @TestCaseId("MC-14175")
 * @group menu
 * @group mtf_migrated
 */
