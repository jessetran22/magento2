...
/**
 * @Title("MC-6505: Update Virtual Product with Special Price (Out of Stock) Visible in Category and Search")
 * @Description("Test log in to Update Virtual Product and Update Virtual Product with Special Price (Out of Stock) Visible in Category and Search<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/AdminUpdateVirtualProductWithSpecialPriceOutOfStockVisibleInCategoryAndSearchTest.xml<br>")
 * @TestCaseId("MC-6505")
 * @group catalog
 * @group mtf_migrated
 */
class UpdateVirtualProductWithSpecialPriceOutOfStockVisibleInCategoryAndSearchTestCest
{
    /**
	...
	public function _after(AcceptanceTester $I)
	{
		...
		$I->fillField("input.admin__control-text[name='sku']", "virtual_sku" . msq("updateVirtualProductSpecialPriceOutOfStock")); // stepKey: fillProductSkuFilterDeleteDefaultVirtualProduct
		...
		$I->see("virtual_sku" . msq("updateVirtualProductSpecialPriceOutOfStock"), "//tr[1]//td[count(//div[@data-role='grid-wrapper']//tr//th[normalize-space(.)='SKU']/preceding-sibling::th) +1 ]"); // stepKey: seeProductSkuInGridDeleteDefaultVirtualProduct
		...
		$I->waitForPageLoad(30); // stepKey: clickActionDropdownDeleteDefaultVirtualProductWaitForPageLoad
		...
		$I->waitForPageLoad(30); // stepKey: clickDeleteActionDeleteDefaultVirtualProductWaitForPageLoad
	 ...
	 * @throws \Exception
	 */
	public function UpdateVirtualProductWithSpecialPriceOutOfStockVisibleInCategoryAndSearchTest(AcceptanceTester $I)
	{
		...
		$I->comment("Update virtual product with special price(out of stock)");
		$I->fillField(".admin__field[data-index=name] input", "VirtualProduct" . msq("updateVirtualProductSpecialPriceOutOfStock")); // stepKey: fillProductName
		$I->fillField(".admin__field[data-index=sku] input", "virtual_sku" . msq("updateVirtualProductSpecialPriceOutOfStock")); // stepKey: fillProductSku
		...
		$I->fillField("input[name='product[url_key]']", "virtual-product" . msq("updateVirtualProductSpecialPriceOutOfStock")); // stepKey: fillUrlKey
		...
		$I->comment("Search updated virtual product with special price(out of stock) in the grid");
		...
		$I->fillField("input.admin__control-text[name='name']", "VirtualProduct" . msq("updateVirtualProductSpecialPriceOutOfStock")); // stepKey: fillVirtualProductNameInNameFilter
		$I->fillField("input.admin__control-text[name='sku']", "virtual_sku" . msq("updateVirtualProductSpecialPriceOutOfStock")); // stepKey: fillVirtualProductSku
		...
		$I->comment("Verify customer see updated virtual product with special price(out of stock) in the product form page");
		$I->seeInField(".admin__field[data-index=name] input", "VirtualProduct" . msq("updateVirtualProductSpecialPriceOutOfStock")); // stepKey: seeProductName
		$I->seeInField(".admin__field[data-index=sku] input", "virtual_sku" . msq("updateVirtualProductSpecialPriceOutOfStock")); // stepKey: seeProductSku
		...
		$I->see("Out of Stock", "select[name='product[quantity_and_stock_status][is_in_stock]']"); // stepKey: seeProductStockStatus
		...
		$I->seeInField("input[name='product[url_key]']", "virtual-product" . msq("updateVirtualProductSpecialPriceOutOfStock")); // stepKey: seeUrlKey
		$I->comment("Verify customer see updated virtual product with special price(out of stock) on product storefront page");
		$I->amOnPage("/virtual-product" . msq("updateVirtualProductSpecialPriceOutOfStock") . ".html"); // stepKey: goToProductPage
		$I->waitForPageLoad(30); // stepKey: waitForStorefrontProductPageLoad
		$I->see("VirtualProduct" . msq("updateVirtualProductSpecialPriceOutOfStock"), ".base"); // stepKey: seeVirtualProductNameOnStoreFrontPage
		...
		$I->see("virtual_sku" . msq("updateVirtualProductSpecialPriceOutOfStock"), ".product.attribute.sku>.value"); // stepKey: seeProductSkuSeeVirtualProductSku
		...
		$productPriceAmount = $I->grabTextFrom(".old-price span.price"); // stepKey: productPriceAmount
		$I->assertEquals("$99.99", $productPriceAmount); // stepKey: assertOldPriceTextOnProductPage
		$I->comment("Verify customer see virtual product with special price on the storefront page");
		...
		$I->amOnPage("/virtual-product" . msq("updateVirtualProductSpecialPriceOutOfStock") . ".html"); // stepKey: goToMagentoStorefrontPage
		$I->waitForPageLoad(30); // stepKey: waitForStoreFrontProductPageLoad
		$I->comment("Entering Action Group [fillVirtualProductName] StorefrontCheckQuickSearchStringActionGroup");
		$I->fillField("#search", "virtual_sku" . msq("updateVirtualProductSpecialPriceOutOfStock")); // stepKey: fillInputFillVirtualProductName
		...
		$I->seeInTitle("Search results for: 'virtual_sku" . msq("updateVirtualProductSpecialPriceOutOfStock") . "'"); // stepKey: assertQuickSearchTitleFillVirtualProductName
		$I->see("Search results for: 'virtual_sku" . msq("updateVirtualProductSpecialPriceOutOfStock") . "'", ".page-title span"); // stepKey: assertQuickSearchNameFillVirtualProductName
		...
		$I->comment("Comment is added to preserve the step key for backward compatibility");
		$I->comment("Comment is added to preserve the step key for backward compatibility");
		$I->comment("Entering Action Group [dontSeeVirtualProductNameOnStorefrontPage] AssertStorefrontProductNameIsNotOnProductMainPageActionGroup");
		$I->waitForPageLoad(30); // stepKey: waitForTheProductPageToLoadDontSeeVirtualProductNameOnStorefrontPage
		$I->dontSee("VirtualProduct" . msq("updateVirtualProductSpecialPriceOutOfStock"), ".product-item-name"); // stepKey: dontSeeProductNameDontSeeVirtualProductNameOnStorefrontPage
		$I->comment("Exiting Action Group [dontSeeVirtualProductNameOnStorefrontPage] AssertStorefrontProductNameIsNotOnProductMainPageActionGroup");
	}
}
