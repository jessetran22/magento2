...
/**
 * @Title("MC-7508: Update Virtual Product with Tier Price (In Stock) Visible in Category Only")
 * @Description("Test log in to Update Virtual Product and Update Virtual Product with Tier Price (In Stock) Visible in Category Only<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/AdminUpdateVirtualProductWithTierPriceInStockVisibleInCategoryOnlyTest.xml<br>")
 * @TestCaseId("MC-7508")
 * @group catalog
 * @group mtf_migrated
 */
class AdminUpdateVirtualProductWithTierPriceInStockVisibleInCategoryOnlyTestCest
{
    /**
	...
	public function _after(AcceptanceTester $I)
	{
		...
		$I->fillField("input.admin__control-text[name='sku']", "virtual_sku" . msq("updateVirtualProductWithTierPriceInStock")); // stepKey: fillProductSkuFilterDeleteVirtualProduct
		$I->fillField("input.admin__control-text[name='name']", "VirtualProduct" . msq("updateVirtualProductWithTierPriceInStock")); // stepKey: fillProductNameFilterDeleteVirtualProduct
		...
		$I->see("virtual_sku" . msq("updateVirtualProductWithTierPriceInStock"), "//tr[1]//td[count(//div[@data-role='grid-wrapper']//tr//th[normalize-space(.)='SKU']/preceding-sibling::th) +1 ]"); // stepKey: seeProductSkuInGridDeleteVirtualProduct
	 ...
	 * @throws \Exception
	 */
	public function AdminUpdateVirtualProductWithTierPriceInStockVisibleInCategoryOnlyTest(AcceptanceTester $I)
	{
		...
		$I->comment("Update virtual product with tier price(in stock)");
		$I->fillField(".admin__field[data-index=name] input", "VirtualProduct" . msq("updateVirtualProductWithTierPriceInStock")); // stepKey: fillProductName
		$I->fillField(".admin__field[data-index=sku] input", "virtual_sku" . msq("updateVirtualProductWithTierPriceInStock")); // stepKey: fillProductSku
		...
		$I->fillField("input[name='product[url_key]']", "virtual-product" . msq("updateVirtualProductWithTierPriceInStock")); // stepKey: fillUrlKey
		...
		$I->fillField("input.admin__control-text[name='name']", "VirtualProduct" . msq("updateVirtualProductWithTierPriceInStock")); // stepKey: fillVirtualProductNameInNameFilter
		$I->fillField("input.admin__control-text[name='sku']", "virtual_sku" . msq("updateVirtualProductWithTierPriceInStock")); // stepKey: fillVirtualProductSku
		...
		$I->seeInField(".admin__field[data-index=name] input", "VirtualProduct" . msq("updateVirtualProductWithTierPriceInStock")); // stepKey: seeProductName
		$I->seeInField(".admin__field[data-index=sku] input", "virtual_sku" . msq("updateVirtualProductWithTierPriceInStock")); // stepKey: seeProductSku
		...
		$I->seeInField("input[name='product[url_key]']", "virtual-product" . msq("updateVirtualProductWithTierPriceInStock")); // stepKey: seeUrlKey
		...
		$I->see("VirtualProduct" . msq("updateVirtualProductWithTierPriceInStock"), "a.product-item-link"); // stepKey: seeVirtualProductNameOnCategoryPage
		...
		$I->amOnPage("/virtual-product" . msq("updateVirtualProductWithTierPriceInStock") . ".html"); // stepKey: goToProductPage
		$I->waitForPageLoad(30); // stepKey: waitForStorefrontProductPageLoad
		$I->see("VirtualProduct" . msq("updateVirtualProductWithTierPriceInStock"), ".base"); // stepKey: seeVirtualProductNameOnStoreFrontPage
		...
		$I->see("virtual_sku" . msq("updateVirtualProductWithTierPriceInStock"), ".product.attribute.sku>.value"); // stepKey: seeProductSkuSeeVirtualProductSku
		...
		$I->amOnPage("/virtual-product" . msq("updateVirtualProductWithTierPriceInStock") . ".html"); // stepKey: goToMagentoStorefrontPage
		$I->waitForPageLoad(30); // stepKey: waitForStoreFrontProductPageLoad
		$I->comment("Entering Action Group [fillVirtualProductName] StorefrontCheckQuickSearchStringActionGroup");
		$I->fillField("#search", "virtual_sku" . msq("updateVirtualProductTierPriceInStock")); // stepKey: fillInputFillVirtualProductName
		...
		$I->seeInTitle("Search results for: 'virtual_sku" . msq("updateVirtualProductTierPriceInStock") . "'"); // stepKey: assertQuickSearchTitleFillVirtualProductName
		$I->see("Search results for: 'virtual_sku" . msq("updateVirtualProductTierPriceInStock") . "'", ".page-title span"); // stepKey: assertQuickSearchNameFillVirtualProductName
		...
		$I->dontSee("VirtualProduct" . msq("updateVirtualProductWithTierPriceInStock"), ".product-item-name"); // stepKey: dontSeeProductNameDontSeeVirtualProductName
