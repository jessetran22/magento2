...
/**
 * @Title("MC-14512: Create downloadable product without filling quantity and stock test")
 * @Description("Admin should be able to create downloadable product without filling quantity and stock<h3>Test files</h3>app/code/Magento/Downloadable/Test/Mftf/Test/AdminCreateDownloadableProductWithoutFillingQuantityAndStockTest.xml<br>")
 * @TestCaseId("MC-14512")
 * @group Downloadable
 * @group mtf_migrated
 */
class AdminCreateDownloadableProductWithoutFillingQuantityAndStockTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateDownloadableProductWithoutFillingQuantityAndStockTest(AcceptanceTester $I)
	{
		...
		$I->clearField(".admin__field[data-index=qty] input"); // stepKey: clearProductQty
		...
		$I->comment("See stock status");
		$I->seeOptionIsSelected("select[name='product[quantity_and_stock_status][is_in_stock]']", "Out of Stock"); // stepKey: seeStockStatus
		$I->waitForPageLoad(30); // stepKey: seeStockStatusWaitForPageLoad
