...
/**
 * @Title("MC-14667: Create active text checkout agreement")
 * @Description("Admin should be able to create active text checkout agreement<h3>Test files</h3>app/code/Magento/CheckoutAgreements/Test/Mftf/Test/AdminCreateActiveTextTermEntityTest.xml<br>")
 * @TestCaseId("MC-14667")
 * @group checkoutAgreements
 * @group mtf_migrated
 */
class AdminCreateActiveTextTermEntityTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateActiveTextTermEntityTest(AcceptanceTester $I)
	{
