 ...
 * @Description("Login as admin and create customer with Poland address<h3>Test files</h3>app/code/Magento/Customer/Test/Mftf/Test/AdminCreateCustomerWithCountryPolandTest.xml<br>")
 * @TestCaseId("MC-5311")
 * @group mtf_migrated
 */
