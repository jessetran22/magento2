...
/**
 * @Title("MC-5358: Update Category URL Rewrites, aspx request path")
 * @Description("Login as Admin, update category UrlRewrite, add aspx request path and Temporary redirect type<h3>Test files</h3>app/code/Magento/UrlRewrite/Test/Mftf/Test/AdminUpdateCategoryUrlRewriteAndAddAspxRequestPathTest.xml<br>")
 * @TestCaseId("MC-5358")
 * @group mtf_migrated
 */
class AdminUpdateCategoryUrlRewriteAndAddAspxRequestPathTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminUpdateCategoryUrlRewriteAndAddAspxRequestPathTest(AcceptanceTester $I)
	{
