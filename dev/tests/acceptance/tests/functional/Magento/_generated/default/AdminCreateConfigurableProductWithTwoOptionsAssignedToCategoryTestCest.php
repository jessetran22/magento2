...
/**
 * @Title("MC-13685: Create configurable product with two new options assigned to category with not visible child products")
 * @Description("Admin should be able to create configurable product with two new options, assigned to category, child products are not visible individually<h3>Test files</h3>app/code/Magento/ConfigurableProduct/Test/Mftf/Test/AdminCreateConfigurableProductWithTwoOptionsAssignedToCategoryTest.xml<br>")
 * @TestCaseId("MC-13685")
 * @group mtf_migrated
 */
class AdminCreateConfigurableProductWithTwoOptionsAssignedToCategoryTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateConfigurableProductWithTwoOptionsAssignedToCategoryTest(AcceptanceTester $I)
	{
		...
		$I->comment("Create new attribute with two options");
		...
		$I->see("$1.00", "//main//table[@id='shopping-cart-table']//tbody//tr[..//strong[contains(@class, 'product-item-name')]//a/text()='API Configurable Product" . msq("ApiConfigurableProduct") . "'][1]//td[contains(@class, 'price')]//span[@class='price']"); // stepKey: assertProductPriceStorefrontCheckCartConfigurableProductActionGroup
