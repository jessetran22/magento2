...
/**
 * @Title("MC-5321: Create tax rate, wider zip code range")
 * @Description("Test log in to Create Tax Rate and Create Wider Zip Code Range<h3>Test files</h3>app/code/Magento/Tax/Test/Mftf/Test/AdminCreateTaxRateWiderZipCodeRangeTest.xml<br>")
 * @TestCaseId("MC-5321")
 * @group tax
 * @group mtf_migrated
 */
class AdminCreateTaxRateWiderZipCodeRangeTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateTaxRateWiderZipCodeRangeTest(AcceptanceTester $I)
	{
		...
		$I->comment("Create a tax rate with range from 1-7800935 for zipCodes");
		...
		$I->selectOption("#tax_country_id", "United Kingdom"); // stepKey: selectCountry1
		$I->fillField("#rate", "7.75"); // stepKey: seeRate
		...
		$I->selectOption("#tax_rate_grid_filter_tax_country_id", "United Kingdom"); // stepKey: selectCountry2
		$I->fillField("#tax_rate_grid_filter_tax_postcode", "1-7800935"); // stepKey: seeTaxPostCode1
		...
		$I->seeInField("#zip_from", "1"); // stepKey: seeTaxPostCode2
		$I->seeInField("#zip_to", "7800935"); // stepKey: seeTaxPostCode3
