 ...
 * @Description("Tax information are updating/recalculating on fly in shopping cart for Customer with default addresses (physical quote)<h3>Test files</h3>app/code/Magento/Weee/Test/Mftf/Test/StorefrontFPTTaxInformationInShoppingCartForCustomerPhysicalQuoteTest.xml<br>")
 * @TestCaseId("MC-28586")
 * @group checkout
 * @group tax
 * @group weee
