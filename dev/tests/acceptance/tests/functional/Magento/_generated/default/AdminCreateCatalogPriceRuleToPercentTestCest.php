...
/**
 * @Title("MC-69: Admin should be able to create a catalog price rule adjust final price to this percentage (for simple product)")
 * @Description("Admin should be able to create a catalog price rule adjust final price to this percentage (for simple product)<h3>Test files</h3>app/code/Magento/CatalogRule/Test/Mftf/Test/AdminCreateCatalogPriceRuleTest/AdminCreateCatalogPriceRuleToPercentTest.xml<br>")
 * @TestCaseId("MC-69")
 * @group CatalogRule
 */
class AdminCreateCatalogPriceRuleToPercentTestCest
{
    /**
	...
	public function _before(AcceptanceTester $I)
	{
		...
		$I->fillField("[name='name']", "CatalogPriceRule" . msq("CatalogRuleToPercent")); // stepKey: fillNameCreateNewPriceRule
		...
		$I->fillField("[name='discount_amount']", "90"); // stepKey: fillDiscountValueCreateNewPriceRule
		$I->selectOption("[name='simple_action']", "to_percent"); // stepKey: discountTypeCreateNewPriceRule
	...
	public function _after(AcceptanceTester $I)
	{
		...
		$I->fillField(".col-name .admin__control-text", "CatalogPriceRule" . msq("CatalogRuleToPercent")); // stepKey: fillIdentifierDeletePriceRule
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateCatalogPriceRuleToPercentTest(AcceptanceTester $I)
	{
