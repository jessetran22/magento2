...
/**
 * @Title("MC-14722: Add 10 items to the cart and check cart and summary block display with default display limit")
 * @Description("Add 10 items to the cart and check cart and summary block display with default display limit<h3>Test files</h3>app/code/Magento/Checkout/Test/Mftf/Test/StorefrontCheckCartAndSummaryBlockItemDisplayWithDefaultDisplayLimitationTest.xml<br>")
 * @TestCaseId("MC-14722")
 * @group mtf_migrated
 */
class StorefrontCheckCartAndSummaryBlockItemDisplayWithDefaultDisplayLimitationTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function StorefrontCheckCartAndSummaryBlockItemDisplayWithDefaultDisplayLimitationTest(AcceptanceTester $I)
	{
		...
		$I->comment("Entering Action Group [AssertOrderSummary] StorefrontCheckoutAndAssertOrderSummaryDisplayActionGroup");
		$I->click("#top-cart-btn-checkout"); // stepKey: clickOnCheckOutButtonInMiniCartAssertOrderSummary
		$I->waitForPageLoad(30); // stepKey: clickOnCheckOutButtonInMiniCartAssertOrderSummaryWaitForPageLoad
		$I->waitForPageLoad(30); // stepKey: waitForPageToLoadAssertOrderSummary
		$I->see("10 Items in Cart", "div.items-in-cart div.title"); // stepKey: seeOrderSummaryTextAssertOrderSummary
		$I->waitForPageLoad(30); // stepKey: seeOrderSummaryTextAssertOrderSummaryWaitForPageLoad
		$I->seeElement(".title[role='tab']"); // stepKey: clickOnOrderSummaryTabAssertOrderSummary
		$I->waitForPageLoad(30); // stepKey: waitForPageToLoad1AssertOrderSummary
		$I->comment("Exiting Action Group [AssertOrderSummary] StorefrontCheckoutAndAssertOrderSummaryDisplayActionGroup");
		...
		$I->comment("Click on order summary tab");
		...
		$I->comment("Assert Product1 displayed in Order Summary");
		$I->comment("Entering Action Group [assertProduct1InOrderSummary] StorefrontAssertProductDetailsInOrderSummaryActionGroup");
		$I->see($I->retrieveEntityField('simpleProduct1', 'name', 'test'), ".product-item-name"); // stepKey: seeProductNameAssertProduct1InOrderSummary
		$I->see("1", ".value"); // stepKey: seeProductQtyAssertProduct1InOrderSummary
		$I->see("$10.00", ".price"); // stepKey: seeProductPriceAssertProduct1InOrderSummary
		$I->comment("Exiting Action Group [assertProduct1InOrderSummary] StorefrontAssertProductDetailsInOrderSummaryActionGroup");
		...
		$I->comment("Verify View and Edit Cart is not displayed in Order Summary");
		$I->dontSeeElement(".action.viewcart"); // stepKey: dontSeeViewAndEditLink
		$I->waitForPageLoad(30); // stepKey: dontSeeViewAndEditLinkWaitForPageLoad
	}
}
