 ...
 * @Description("Sitemap Entity Creation With Path Error<h3>Test files</h3>app/code/Magento/Sitemap/Test/Mftf/Test/AdminMarketingCreateSitemapPathErrorTest.xml<br>")
 * @TestCaseId("MC-14313")
 * @group sitemap
 * @group mtf_migrated
 */
