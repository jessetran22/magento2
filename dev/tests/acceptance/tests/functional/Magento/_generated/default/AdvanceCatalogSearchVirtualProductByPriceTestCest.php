...
/**
 * @Title("MC-165: Guest customer should be able to advance search virtual product with product price")
 * @Description("Guest customer should be able to advance search virtual product with product price<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/AdvanceCatalogSearchVirtualProductTest/AdvanceCatalogSearchVirtualProductByPriceTest.xml<br>")
 * @TestCaseId("MC-165")
 * @group Catalog
 */
class AdvanceCatalogSearchVirtualProductByPriceTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdvanceCatalogSearchVirtualProductByPriceTest(AcceptanceTester $I)
	{
