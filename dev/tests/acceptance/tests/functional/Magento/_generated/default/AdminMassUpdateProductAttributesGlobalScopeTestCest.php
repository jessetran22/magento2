 ...
 * @Description("Admin should be able to mass update product attributes in global scope<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/AdminMassUpdateProductAttributesGlobalScopeTest.xml<br>")
 * @TestCaseId("MC-56")
 * @group catalog
