...
/**
 * @Title("MC-135: Guest customer should be able to advance search simple product with product short description")
 * @Description("Guest customer should be able to advance search simple product with product short description<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/AdvanceCatalogSearchSimpleProductTest/AdvanceCatalogSearchSimpleProductByShortDescriptionTest.xml<br>app/code/Magento/CatalogSearch/Test/Mftf/Test/AdvanceCatalogSearchSimpleProductTest/AdvanceCatalogSearchSimpleProductByShortDescriptionTest.xml<br>")
 * @TestCaseId("MC-135")
 * @group Catalog
 * @group CatalogSearch
 */
class AdvanceCatalogSearchSimpleProductByShortDescriptionTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdvanceCatalogSearchSimpleProductByShortDescriptionTest(AcceptanceTester $I)
	{
