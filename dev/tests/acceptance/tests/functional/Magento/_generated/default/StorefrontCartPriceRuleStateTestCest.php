 ...
 * @Description("Customer should only see cart price rule discount if condition shipping state/province<h3>Test files</h3>app/code/Magento/SalesRule/Test/Mftf/Test/StorefrontCartPriceRuleStateTest.xml<br>")
 * @TestCaseId("MC-239")
 * @group SalesRule
 */
