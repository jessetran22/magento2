...
/**
 * @Title("MC-142: Guest customer should be able to advance search Downloadable product with product name")
 * @Description("Guest customer should be able to advance search Downloadable product with product name<h3>Test files</h3>app/code/Magento/Downloadable/Test/Mftf/Test/AdvanceCatalogSearchDownloadableProductTest/AdvanceCatalogSearchDownloadableByNameTest.xml<br>")
 * @TestCaseId("MC-142")
 * @group Downloadable
 */
class AdvanceCatalogSearchDownloadableByNameTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdvanceCatalogSearchDownloadableByNameTest(AcceptanceTester $I)
	{
