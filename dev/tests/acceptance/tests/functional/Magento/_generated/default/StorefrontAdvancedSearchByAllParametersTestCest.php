...
/**
 * @Title("MAGETWO-24729: Search product in advanced search by name, sku, description, short description, price from and price to")
 * @Description("Search product in advanced search by name, sku, description, short description, price from and price to<h3>Test files</h3>app/code/Magento/CatalogSearch/Test/Mftf/Test/StorefrontAdvancedSearchByAllParametersTest.xml<br>")
 * @TestCaseId("MAGETWO-24729")
 * @group searchFrontend
 * @group mtf_migrated
 */
class StorefrontAdvancedSearchByAllParametersTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function StorefrontAdvancedSearchByAllParametersTest(AcceptanceTester $I)
	{
		...
		$I->fillField("#price_to", "500"); // stepKey: fillPriceToSearch
