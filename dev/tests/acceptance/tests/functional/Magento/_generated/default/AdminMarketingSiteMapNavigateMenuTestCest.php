...
/**
 * @Title("MC-14204: Admin marketing site map navigate menu test")
 * @Description("Admin should be able to navigate to Marketing > Site Map<h3>Test files</h3>app/code/Magento/Sitemap/Test/Mftf/Test/AdminMarketingSiteMapNavigateMenuTest.xml<br>")
 * @TestCaseId("MC-14204")
 * @group menu
 * @group mtf_migrated
 */
class AdminMarketingSiteMapNavigateMenuTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminMarketingSiteMapNavigateMenuTest(AcceptanceTester $I)
	{
		...
		$I->see("Site Map", ".page-title-wrapper h1"); // stepKey: assertPageTitleSeePageTitle
