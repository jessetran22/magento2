...
/**
 * @Title("MC-10929: Admin should be able to switch a new product from downloadable to simple")
 * @Description("After selecting a downloadable product when adding Admin should be switch to simple implicitly<h3>Test files</h3>app/code/Magento/Downloadable/Test/Mftf/Test/AdminCreateDownloadableProductSwitchToSimpleTest.xml<br>")
 * @TestCaseId("MC-10929")
 * @group catalog
 * @group mtf_migrated
 */
class AdminCreateDownloadableProductSwitchToSimpleTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateDownloadableProductSwitchToSimpleTest(AcceptanceTester $I)
	{
