...
/**
 * @Title("[NO TESTCASEID]: Admin validate the shipping tracking number for an order")
 * @Description("Testing for a required tracking number when adding new shipping information<h3>Test files</h3>app/code/Magento/Shipping/Test/Mftf/Test/AdminValidateShippingTrackingNumberTest.xml<br>")
 * @group shipping
 */
class AdminValidateShippingTrackingNumberTestCest
{
    /**
	...
	/**
	 * @Stories({"Admin validate the shipping tracking number for an order"})
	 ...
	 * @throws \Exception
	 */
	public function AdminValidateShippingTrackingNumberTest(AcceptanceTester $I)
	{
		...
		$I->comment("Entering Action Group [addTrackingInformation] AdminAddTrackingNumberToShipmentActionGroup");
		$I->fillField("#tracking-shipping-form #tracking_title", ""); // stepKey: fillTrackingTitleAddTrackingInformation
		$I->fillField("#tracking-shipping-form #tracking_number", ""); // stepKey: fillTrackingNumberAddTrackingInformation
		$I->click("#tracking-shipping-form button.save"); // stepKey: clickAddTrackingNumberAddTrackingInformation
		$I->waitForPageLoad(30); // stepKey: waitForTrackingInformationAddTrackingInformation
		$I->comment("Exiting Action Group [addTrackingInformation] AdminAddTrackingNumberToShipmentActionGroup");
		$I->comment("Entering Action Group [assertValidateTrackingNumber] AdminAssertTrackingValidationErrorActionGroup");
		$I->see("This is a required field.", "#tracking-shipping-form #tracking_number-error"); // stepKey: seeTrackingInfoValidationErrorAssertValidateTrackingNumber
		$I->comment("Exiting Action Group [assertValidateTrackingNumber] AdminAssertTrackingValidationErrorActionGroup");
		...
		$I->comment("Entering Action Group [checkAddedTrackingNumber] AdminAssertExistingTrackingNumberActionGroup");
		$I->see("123123", "#shipment_tracking_info .col-number"); // stepKey: seeAvailableTrackingNumberCheckAddedTrackingNumber
		$I->comment("Exiting Action Group [checkAddedTrackingNumber] AdminAssertExistingTrackingNumberActionGroup");
	}
}
