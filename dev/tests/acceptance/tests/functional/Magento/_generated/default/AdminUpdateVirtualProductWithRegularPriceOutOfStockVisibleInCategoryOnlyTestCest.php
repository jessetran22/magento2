...
/**
 * @Title("MC-6503: Update Virtual Product with Regular Price (Out of Stock) Visible in Category Only")
 * @Description("Test log in to Update Virtual Product and Update Virtual Product with Regular Price (Out of Stock) Visible in Category Only<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/AdminUpdateVirtualProductWithRegularPriceOutOfStockVisibleInCategoryOnlyTest.xml<br>")
 * @TestCaseId("MC-6503")
 * @group catalog
 * @group mtf_migrated
 */
class AdminUpdateVirtualProductWithRegularPriceOutOfStockVisibleInCategoryOnlyTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminUpdateVirtualProductWithRegularPriceOutOfStockVisibleInCategoryOnlyTest(AcceptanceTester $I)
	{
		...
		$I->comment("Verify we see updated virtual product with regular price(from the above step) in the product form page");
		...
		$I->comment("Verify customer don't see updated virtual product link(from above step) on category page");
		...
		$I->dontSee("VirtualProduct" . msq("updateVirtualProductRegularPrice5OutOfStock"), "a.product-item-link"); // stepKey: dontseeVirtualProductNameOnCategoryPage
		$I->waitForPageLoad(30); // stepKey: dontseeVirtualProductNameOnCategoryPageWaitForPageLoad
		$I->comment("Verify customer see updated virtual product (from above step) on product storefront page");
		...
		$I->comment("Verify customer don't see updated virtual product link(from above step) on magento storefront page and is searchable by sku");
		$I->amOnPage("/virtual-product" . msq("updateVirtualProductRegularPrice5OutOfStock") . ".html"); // stepKey: goToMagentoStorefrontPage
		$I->waitForPageLoad(30); // stepKey: waitForStoreFrontProductPageLoad
		$I->comment("Entering Action Group [fillVirtualProductName] StorefrontCheckQuickSearchStringActionGroup");
		$I->fillField("#search", "virtual_sku" . msq("updateVirtualProductRegularPrice5OutOfStock")); // stepKey: fillInputFillVirtualProductName
		...
		$I->seeInTitle("Search results for: 'virtual_sku" . msq("updateVirtualProductRegularPrice5OutOfStock") . "'"); // stepKey: assertQuickSearchTitleFillVirtualProductName
		$I->see("Search results for: 'virtual_sku" . msq("updateVirtualProductRegularPrice5OutOfStock") . "'", ".page-title span"); // stepKey: assertQuickSearchNameFillVirtualProductName
		...
		$I->dontSee("VirtualProduct" . msq("updateVirtualProductRegularPrice5OutOfStock"), ".product-item-name"); // stepKey: dontSeeProductNameDontSeeVirtualProductName
