...
/**
 * @Title("MC-14669: Create disabled text checkout agreement")
 * @Description("Admin should be able to create disabled text checkout agreement<h3>Test files</h3>app/code/Magento/CheckoutAgreements/Test/Mftf/Test/AdminCreateDisabledTextTermEntityTest.xml<br>")
 * @TestCaseId("MC-14669")
 * @group checkoutAgreements
 * @group mtf_migrated
 */
class AdminCreateDisabledTextTermEntityTestCest
{
    /**
	...
	public function _after(AcceptanceTester $I)
	{
		...
		$I->fillField("#agreementGrid_filter_name", "name" . msq("disabledTextTerm")); // stepKey: fillTermNameFilterOpenTermToDelete
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateDisabledTextTermEntityTest(AcceptanceTester $I)
	{
		...
		$I->fillField("#agreementGrid_filter_name", "name" . msq("disabledTextTerm")); // stepKey: fillTermNameFilterAssertTermInGrid
		...
		$I->see("name" . msq("disabledTextTerm"), ".data-grid>tbody>tr>td.col-name"); // stepKey: assertTermInGridAssertTermInGrid
		...
		$I->dontSee("test_checkbox" . msq("disabledTextTerm"), "div.checkout-agreements-block > div > div > div > label > button > span"); // stepKey: seeTermInCheckoutAssertTermAbsentInCheckout
