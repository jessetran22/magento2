...
/**
 * @Title("MC-10806: Update Simple Product with Regular Price (Out of Stock)")
 * @Description("Test log in to Update Simple Product and Update Simple Product with Regular Price (Out of Stock)<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/AdminUpdateSimpleProductWithRegularPriceOutOfStockTest.xml<br>")
 * @TestCaseId("MC-10806")
 * @group catalog
 * @group mtf_migrated
 */
class AdminUpdateSimpleProductWithRegularPriceOutOfStockTestCest
{
    /**
	...
	public function _after(AcceptanceTester $I)
	{
		...
		$I->fillField("input.admin__control-text[name='sku']", "test_simple_product_sku" . msq("simpleProductRegularPrice32503OutOfStock")); // stepKey: fillProductSkuFilterDeleteCreatedProduct
		...
		$I->see("test_simple_product_sku" . msq("simpleProductRegularPrice32503OutOfStock"), "//tr[1]//td[count(//div[@data-role='grid-wrapper']//tr//th[normalize-space(.)='SKU']/preceding-sibling::th) +1 ]"); // stepKey: seeProductSkuInGridDeleteCreatedProduct
	 ...
	 * @throws \Exception
	 */
	public function AdminUpdateSimpleProductWithRegularPriceOutOfStockTest(AcceptanceTester $I)
	{
		...
		$I->comment("Comment is added to preserve the step key for backward compatibility");
		$I->comment("Comment is added to preserve the step key for backward compatibility");
		$I->comment("Update simple product with regular price(out of stock)");
		$I->comment("Entering Action Group [fillSimpleProductName] FillMainProductFormByStringActionGroup");
		$I->fillField(".admin__field[data-index=name] input", "TestSimpleProduct" . msq("simpleProductRegularPrice32503OutOfStock")); // stepKey: fillProductNameFillSimpleProductName
		$I->fillField(".admin__field[data-index=sku] input", "test_simple_product_sku" . msq("simpleProductRegularPrice32503OutOfStock")); // stepKey: fillProductSkuFillSimpleProductName
		$I->fillField(".admin__field[data-index=price] input", "325.03"); // stepKey: fillProductPriceFillSimpleProductName
		$I->fillField(".admin__field[data-index=qty] input", "25"); // stepKey: fillProductQtyFillSimpleProductName
		$I->selectOption("select[name='product[quantity_and_stock_status][is_in_stock]']", "Out of Stock"); // stepKey: selectStockStatusFillSimpleProductName
		...
		$I->fillField(".admin__field[data-index=weight] input", "125"); // stepKey: fillProductWeightFillSimpleProductName
		...
		$I->fillField("input[name='product[url_key]']", "test-simple-product" . msq("simpleProductRegularPrice32503OutOfStock")); // stepKey: fillUrlKeyFillUrlKey
		...
		$I->fillField("input.admin__control-text[name='sku']", "test_simple_product_sku" . msq("simpleProductRegularPrice32503OutOfStock")); // stepKey: fillProductSkuFilterClickApplyFiltersButton
		$I->fillField("input.admin__control-text[name='name']", "TestSimpleProduct" . msq("simpleProductRegularPrice32503OutOfStock")); // stepKey: fillProductNameFilterClickApplyFiltersButton
		...
		$I->seeInField(".admin__field[data-index=name] input", "TestSimpleProduct" . msq("simpleProductRegularPrice32503OutOfStock")); // stepKey: seeProductNameSeeSimpleProductName
		$I->seeInField(".admin__field[data-index=sku] input", "test_simple_product_sku" . msq("simpleProductRegularPrice32503OutOfStock")); // stepKey: seeProductSkuSeeSimpleProductName
		$I->seeInField(".admin__field[data-index=price] input", "325.03"); // stepKey: seeProductPriceSeeSimpleProductName
		$I->seeInField(".admin__field[data-index=qty] input", "25"); // stepKey: seeProductQuantitySeeSimpleProductName
		$I->seeInField("select[name='product[quantity_and_stock_status][is_in_stock]']", "Out of Stock"); // stepKey: seeProductStockStatusSeeSimpleProductName
		$I->waitForPageLoad(30); // stepKey: seeProductStockStatusSeeSimpleProductNameWaitForPageLoad
		$I->seeInField(".admin__field[data-index=weight] input", "125"); // stepKey: seeProductWeightSeeSimpleProductName
		$I->seeOptionIsSelected("//select[@name='product[visibility]']", "Catalog, Search"); // stepKey: seeProductVisibilitySeeSimpleProductName
		...
		$I->seeInField("input[name='product[url_key]']", "test-simple-product" . msq("simpleProductRegularPrice32503OutOfStock")); // stepKey: seeUrlKey
		...
		$I->comment("Comment is added to preserve the step key for backward compatibility");
		$I->dontSee("TestSimpleProduct" . msq("simpleProductRegularPrice32503OutOfStock"), "a.product-item-link"); // stepKey: dontSeeSimpleProductNameOnCategoryPage
		...
		$I->amOnPage("/test-simple-product" . msq("simpleProductRegularPrice32503OutOfStock") . ".html"); // stepKey: amOnProductPageGoToProductPage
		...
		$I->see("TestSimpleProduct" . msq("simpleProductRegularPrice32503OutOfStock"), ".base"); // stepKey: seeProductNameSeeSimpleProductNameOnStoreFrontPage
		...
		$I->see("325.03", ".product-info-main [data-price-type='finalPrice']"); // stepKey: seeProductPriceSeeSimpleProductPriceOnStoreFrontPage
		...
		$I->see("test_simple_product_sku" . msq("simpleProductRegularPrice32503OutOfStock"), ".product.attribute.sku>.value"); // stepKey: seeProductSkuSeeSimpleProductSkuOnStoreFrontPage
		...
		$I->see("OUT OF STOCK", ".stock[title=Availability]>span"); // stepKey: seeProductStockStatusAssertStockAvailableOnProductPage
		...
		$I->fillField("#search", "test_simple_product_sku" . msq("simpleProductRegularPrice32503OutOfStock")); // stepKey: fillInputFillSimpleProductSkuInSearchTextBox
		...
		$I->seeInTitle("Search results for: 'test_simple_product_sku" . msq("simpleProductRegularPrice32503OutOfStock") . "'"); // stepKey: assertQuickSearchTitleFillSimpleProductSkuInSearchTextBox
		$I->see("Search results for: 'test_simple_product_sku" . msq("simpleProductRegularPrice32503OutOfStock") . "'", ".page-title span"); // stepKey: assertQuickSearchNameFillSimpleProductSkuInSearchTextBox
		...
		$I->dontSee("TestSimpleProduct" . msq("simpleProductRegularPrice32503OutOfStock"), ".product-item-name"); // stepKey: dontSeeProductNameDontSeeProductName
