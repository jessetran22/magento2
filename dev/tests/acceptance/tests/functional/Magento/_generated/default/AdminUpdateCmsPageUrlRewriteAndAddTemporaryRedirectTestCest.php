...
/**
 * @Title(": Update Cms Page URL Rewrites, Temporary redirect type")
 * @Description("Login as Admin and update Cms Page Url Rewrite and add Temporary redirect type<h3>Test files</h3>app/code/Magento/UrlRewrite/Test/Mftf/Test/AdminUpdateCmsPageUrlRewriteAndAddTemporaryRedirectTest.xml<br>")
 * @TestCaseId("")
 * @group mtf_migrated
 */
class AdminUpdateCmsPageUrlRewriteAndAddTemporaryRedirectTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminUpdateCmsPageUrlRewriteAndAddTemporaryRedirectTest(AcceptanceTester $I)
	{
		...
		$I->click("//select[@id='redirect_type']//option[contains(., 'Temporary (302)')]"); // stepKey: selectRedirectTypeValueUpdateCmsPageUrlRewrite
