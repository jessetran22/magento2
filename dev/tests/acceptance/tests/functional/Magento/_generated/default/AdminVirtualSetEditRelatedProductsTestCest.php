...
/**
 * @Title("MC-25532: Admin should be able to set/edit Related Products information when editing a virtual product")
 * @Description("Admin should be able to set/edit Related Products information when editing a virtual product<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/AdminVirtualSetEditRelatedProductsTest.xml<br>")
 * @TestCaseId("MC-25532")
 * @group catalog
 */
class AdminVirtualSetEditRelatedProductsTestCest
{
	 ...
	 * @throws \Exception
	 */
	public function AdminVirtualSetEditRelatedProductsTest(AcceptanceTester $I)
	{
