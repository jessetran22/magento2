 ...
 * @Description("Test log in to Tax Rate and Update Decimal Tax Rate<h3>Test files</h3>app/code/Magento/Tax/Test/Mftf/Test/UpdateDecimalTaxRateEntityTest.xml<br>")
 * @TestCaseId("MC-5329")
 * @group tax
 * @group mtf_migrated
 */
class UpdateDecimalTaxRateEntityTestCest
{
	...
	public function UpdateDecimalTaxRateEntityTest(AcceptanceTester $I)
	{
		...
		$I->fillField("#tax_rate_grid_filter_code", "Tax Rate " . msq("defaultTaxRateWithZipRange")); // stepKey: fillNameFilterFillTaxIdentifierField3
