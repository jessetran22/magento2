...
/**
 * @Title("MC-14196: Admin marketing reviews navigate menu test")
 * @Description("Admin should be able to navigate to Marketing > Reviews<h3>Test files</h3>app/code/Magento/Review/Test/Mftf/Test/AdminMarketingReviewsNavigateMenuTest.xml<br>")
 * @TestCaseId("MC-14196")
 * @group menu
 * @group mtf_migrated
 */
class AdminMarketingReviewsNavigateMenuTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminMarketingReviewsNavigateMenuTest(AcceptanceTester $I)
	{
		...
		$I->click("li[data-ui-id='menu-magento-review-catalog-reviews-ratings-reviews-all']"); // stepKey: clickOnSubmenuItemNavigateToReportsViewsPage
		...
		$I->see("Reviews", ".page-title-wrapper h1"); // stepKey: assertPageTitleSeePageTitle
