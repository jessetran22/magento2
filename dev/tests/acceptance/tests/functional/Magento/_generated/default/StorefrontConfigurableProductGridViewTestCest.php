...
/**
 * @Title("MC-94: customer should see the configurable product in the category grid")
 * @Description("customer should see the configurable product in the category grid<h3>Test files</h3>app/code/Magento/ConfigurableProduct/Test/Mftf/Test/StorefrontConfigurableProductViewTest/StorefrontConfigurableProductGridViewTest.xml<br>")
 * @TestCaseId("MC-94")
 * @group ConfigurableProduct
 */
class StorefrontConfigurableProductGridViewTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function StorefrontConfigurableProductGridViewTest(AcceptanceTester $I)
	{
		$I->comment("Verify the storefront category grid view");
		...
		$I->seeElement("a.product-item-link[href$='testproductname" . msq("_defaultProduct") . ".html']"); // stepKey: seeNameLink
