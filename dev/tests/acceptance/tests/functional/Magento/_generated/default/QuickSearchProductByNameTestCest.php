...
/**
 * @Title("MC-14791: User should be able to use Quick Search to find products via Name")
 * @Description("Use Quick Search to find a product<h3>Test files</h3>app/code/Magento/CatalogSearch/Test/Mftf/Test/SearchEntityResultsTest/QuickSearchProductByNameTest.xml<br>")
 * @TestCaseId("MC-14791")
 * @group CatalogSearch
 * @group mtf_migrated
 */
class QuickSearchProductByNameTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function QuickSearchProductByNameTest(AcceptanceTester $I)
	{
