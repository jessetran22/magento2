...
/**
 * @Title("MC-5356: Update Category URL Rewrites, Temporary redirect type")
 * @Description("Login as Admin and update category UrlRewrite and add Temporary redirect type<h3>Test files</h3>app/code/Magento/UrlRewrite/Test/Mftf/Test/AdminUpdateCategoryUrlRewriteAndAddTemporaryRedirectTest.xml<br>")
 * @TestCaseId("MC-5356")
 * @group mtf_migrated
 */
class AdminUpdateCategoryUrlRewriteAndAddTemporaryRedirectTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminUpdateCategoryUrlRewriteAndAddTemporaryRedirectTest(AcceptanceTester $I)
	{
		...
		$I->fillField(".admin__data-grid-filters input[name='request_path']", msq("updateUrlRewrite") . "test-aspx-test.aspx"); // stepKey: fillRedirectPathFilterSearchByNewRequestPath
		...
		$I->see(msq("updateUrlRewrite") . "test-aspx-test.aspx", "//*[@data-role='grid']//tbody//tr[1+1]//td[count(//*[@data-role='grid']//th[contains(., 'Request Path')]/preceding-sibling::th)+1]"); // stepKey: seeTheRedirectPathForOldUrlSearchByNewRequestPath
		...
		$I->see("Temporary (302)", "//*[@data-role='grid']//tbody//tr[1+1]//td[count(//*[@data-role='grid']//th[contains(., 'Redirect Type')]/preceding-sibling::th)+1]"); // stepKey: seeTheRedirectTypeForOldUrlSearchByNewRequestPath
		...
		$I->amOnPage(msq("updateUrlRewrite") . "test-aspx-test.aspx"); // stepKey: openCategoryInStorefrontVerifyCategoryInStoreFront
