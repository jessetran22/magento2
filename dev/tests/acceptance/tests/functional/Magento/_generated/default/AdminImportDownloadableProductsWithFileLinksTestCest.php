...
/**
 * @Title("MC-38325: Import Downloadable Products with File Links")
 * @Description("Imports a .csv file containing a downloadable product with file links. Verifies that             products are imported successfully and that the files are attached to the products as expected.<h3>Test files</h3>app/code/Magento/DownloadableImportExport/Test/Mftf/Test/AdminImportDownloadableProductsWithFileLinksTest.xml<br>")
 * @TestCaseId("MC-38325")
 * @group importExport
 * @group Downloadable
 */
class AdminImportDownloadableProductsWithFileLinksTestCest
{
    /**
	...
	public function _before(AcceptanceTester $I)
	{
		...
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->createDirectory("var/import/images/import-product-downloadable-file-links", 511); // stepKey: createDirectoryForImportImages
		$I->comment('[copyBaseImage] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::copy()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->copy("dev/tests/acceptance/tests/_data/magento-logo.png", "var/import/images/import-product-downloadable-file-links/magento-logo.png"); // stepKey: copyBaseImage
		$I->comment('[copySmallImage] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::copy()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->copy("dev/tests/acceptance/tests/_data/m-logo.gif", "var/import/images/import-product-downloadable-file-links/m-logo.gif"); // stepKey: copySmallImage
		$I->comment('[copyThumbnailImage] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::copy()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->copy("dev/tests/acceptance/tests/_data/adobe-base.jpg", "var/import/images/import-product-downloadable-file-links/adobe-base.jpg"); // stepKey: copyThumbnailImage
	...
	public function _after(AcceptanceTester $I)
	{
		...
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->deleteDirectory("var/import/images/import-product-downloadable-file-links"); // stepKey: deleteProductImageDirectory
	 ...
	 * @throws \Exception
	 */
	public function AdminImportDownloadableProductsWithFileLinksTest(AcceptanceTester $I)
	{
