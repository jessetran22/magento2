...
/**
 * @Title("MAGETWO-24729: Search product in advanced search by price from and price to")
 * @Description("Search product in advanced search by price from and price to<h3>Test files</h3>app/code/Magento/CatalogSearch/Test/Mftf/Test/StorefrontAdvancedSearchByPriceFromAndPriceToTest.xml<br>")
 * @TestCaseId("MAGETWO-24729")
 * @group searchFrontend
 * @group mtf_migrated
 */
class StorefrontAdvancedSearchByPriceFromAndPriceToTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function StorefrontAdvancedSearchByPriceFromAndPriceToTest(AcceptanceTester $I)
	{
		...
		$I->fillField("#price", "50"); // stepKey: fillPriceFromSearch
