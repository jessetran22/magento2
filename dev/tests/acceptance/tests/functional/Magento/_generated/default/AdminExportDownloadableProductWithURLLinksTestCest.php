...
class AdminExportDownloadableProductWithURLLinksTestCest
{
	...
	{
		$I->comment("Add Downloadable Domain, Create Category, Create Downloadable Product");
		$addDownloadableDomain = $I->magentoCLI("downloadable:domains:add example.com", 60); // stepKey: addDownloadableDomain
		...
		$I->createEntity("addDownloadableSamples", "hook", "DownloadableSample", ["createProduct"], []); // stepKey: addDownloadableSamples
	...
	public function _after(AcceptanceTester $I)
	{
		...
		$removeDownloadableDomain = $I->magentoCLI("downloadable:domains:remove example.com", 60); // stepKey: removeDownloadableDomain
	 ...
	 * @throws \Exception
	 */
	public function AdminExportDownloadableProductWithURLLinksTest(AcceptanceTester $I)
	{
		...
		$I->comment('[assertExportFileContainsDownloadableProduct] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::assertFileContainsString()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->assertFileContainsString("var/export/{$grabNameFile}", $I->retrieveEntityField('createProduct', 'name', 'test'), ''); // stepKey: assertExportFileContainsDownloadableProduct
		$I->comment('[assertExportFileContainsDownloadableLink] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::assertFileContainsString()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->assertFileContainsString("var/export/{$grabNameFile}", "title=" . $I->retrieveEntityField('addDownloadableLink', 'link[title]', 'test') . ",sort_order=" . $I->retrieveEntityField('addDownloadableLink', 'link[sort_order]', 'test') . ",sample_type=" . $I->retrieveEntityField('addDownloadableLink', 'link[sample_type]', 'test') . ",sample_url=" . $I->retrieveEntityField('addDownloadableLink', 'link[sample_url]', 'test') . ",price=" . $I->retrieveEntityField('addDownloadableLink', 'link[price]', 'test') . "0000,number_of_downloads=" . $I->retrieveEntityField('addDownloadableLink', 'link[number_of_downloads]', 'test') . ",link_type=" . $I->retrieveEntityField('addDownloadableLink', 'link[link_type]', 'test') . ",link_url=" . $I->retrieveEntityField('addDownloadableLink', 'link[link_url]', 'test'), ''); // stepKey: assertExportFileContainsDownloadableLink
		$I->comment('[assertExportFileContainsDownloadableSampleLink] Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions::assertFileContainsString()');
		$this->helperContainer->get('Magento\Catalog\Test\Mftf\Helper\LocalFileAssertions')->assertFileContainsString("var/export/{$grabNameFile}", "title=" . $I->retrieveEntityField('addDownloadableSamples', 'sample[title]', 'test') . ",sort_order=" . $I->retrieveEntityField('addDownloadableSamples', 'sample[sort_order]', 'test') . ",sample_type=" . $I->retrieveEntityField('addDownloadableSamples', 'sample[sample_type]', 'test') . ",sample_url=" . $I->retrieveEntityField('addDownloadableSamples', 'sample[sample_url]', 'test'), ''); // stepKey: assertExportFileContainsDownloadableSampleLink
		...
		$this->helperContainer->get('\Magento\Backend\Test\Mftf\Helper\CurlHelpers')->assertCurlResponseContainsString($grabExportUrl, "title=" . $I->retrieveEntityField('addDownloadableLink', 'link[title]', 'test') . ",sort_order=" . $I->retrieveEntityField('addDownloadableLink', 'link[sort_order]', 'test') . ",sample_type=" . $I->retrieveEntityField('addDownloadableLink', 'link[sample_type]', 'test') . ",sample_url=" . $I->retrieveEntityField('addDownloadableLink', 'link[sample_url]', 'test') . ",price=" . $I->retrieveEntityField('addDownloadableLink', 'link[price]', 'test') . "0000,number_of_downloads=" . $I->retrieveEntityField('addDownloadableLink', 'link[number_of_downloads]', 'test') . ",link_type=" . $I->retrieveEntityField('addDownloadableLink', 'link[link_type]', 'test') . ",link_url=" . $I->retrieveEntityField('addDownloadableLink', 'link[link_url]', 'test'), NULL, 'admin', ''); // stepKey: assertDownloadFileContainsDownloadableLink
		...
		$this->helperContainer->get('\Magento\Backend\Test\Mftf\Helper\CurlHelpers')->assertCurlResponseContainsString($grabExportUrl, "title=" . $I->retrieveEntityField('addDownloadableSamples', 'sample[title]', 'test') . ",sort_order=" . $I->retrieveEntityField('addDownloadableSamples', 'sample[sort_order]', 'test') . ",sample_type=" . $I->retrieveEntityField('addDownloadableSamples', 'sample[sample_type]', 'test') . ",sample_url=" . $I->retrieveEntityField('addDownloadableSamples', 'sample[sample_url]', 'test'), NULL, 'admin', ''); // stepKey: assertDownloadFileContainsDownloadableSampleLink
