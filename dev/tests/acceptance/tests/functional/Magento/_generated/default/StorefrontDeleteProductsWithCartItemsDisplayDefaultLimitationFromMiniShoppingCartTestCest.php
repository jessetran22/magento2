...
/**
 * @Title("MC-14687: Storefront Delete Products With Cart Items Display Default Limitation From Mini Shopping Cart Test")
 * @Description("Test log in to Shopping Cart and Delete Products With Cart Items Display Default Limitation From Mini Shopping Cart Test<h3>Test files</h3>app/code/Magento/Checkout/Test/Mftf/Test/StorefrontDeleteProductsWithCartItemsDisplayDefaultLimitationFromMiniShoppingCartTest.xml<br>")
 * @TestCaseId("MC-14687")
 * @group Shopping Cart
 * @group mtf_migrated
 */
class StorefrontDeleteProductsWithCartItemsDisplayDefaultLimitationFromMiniShoppingCartTestCest
{
    /**
	...
	public function _before(AcceptanceTester $I)
	{
		...
		$I->comment("Create  10 simple products");
	...
	/**
	 * @Stories({"DeleteProductsWithCartItemsDisplayDefaultLimitation"})
	 ...
	 * @throws \Exception
	 */
	public function StorefrontDeleteProductsWithCartItemsDisplayDefaultLimitationFromMiniShoppingCartTest(AcceptanceTester $I)
	{
		...
		$I->comment("Assert Product Count in Mini Cart and verify AssertVisibleItemsQtyMessageInMiniShoppingCart");
		...
		$I->comment("Remove products from minicart");
		$I->comment("Entering Action Group [removeProduct1FromMiniCart] RemoveProductFromMiniCartActionGroup");
		$I->conditionalClick("a.showcart", "a.showcart.active", false); // stepKey: openMiniCartRemoveProduct1FromMiniCart
		$I->waitForElementVisible(".action.viewcart", 30); // stepKey: waitForMiniCartOpenRemoveProduct1FromMiniCart
		$I->waitForPageLoad(30); // stepKey: waitForMiniCartOpenRemoveProduct1FromMiniCartWaitForPageLoad
		$I->click("//ol[@id='mini-cart']//div[contains(., '" . $I->retrieveEntityField('simpleProduct10', 'name', 'test') . "')]//a[contains(@class, 'delete')]"); // stepKey: clickDeleteRemoveProduct1FromMiniCart
		$I->waitForElementVisible("aside.confirm div.modal-content", 30); // stepKey: waitForConfirmationModalRemoveProduct1FromMiniCart
		$I->see("Are you sure you would like to remove this item from the shopping cart?", "aside.confirm div.modal-content"); // stepKey: seeDeleteConfirmationMessageRemoveProduct1FromMiniCart
		$I->click("aside.confirm .modal-footer .action-primary"); // stepKey: confirmDeleteRemoveProduct1FromMiniCart
		$I->waitForPageLoad(30); // stepKey: waitForDeleteToFinishRemoveProduct1FromMiniCart
		$I->comment("Exiting Action Group [removeProduct1FromMiniCart] RemoveProductFromMiniCartActionGroup");
		$I->comment("Entering Action Group [removeProduct2FromMiniCart] RemoveProductFromMiniCartActionGroup");
		$I->conditionalClick("a.showcart", "a.showcart.active", false); // stepKey: openMiniCartRemoveProduct2FromMiniCart
		$I->waitForElementVisible(".action.viewcart", 30); // stepKey: waitForMiniCartOpenRemoveProduct2FromMiniCart
		$I->waitForPageLoad(30); // stepKey: waitForMiniCartOpenRemoveProduct2FromMiniCartWaitForPageLoad
		$I->click("//ol[@id='mini-cart']//div[contains(., '" . $I->retrieveEntityField('simpleProduct9', 'name', 'test') . "')]//a[contains(@class, 'delete')]"); // stepKey: clickDeleteRemoveProduct2FromMiniCart
		$I->waitForElementVisible("aside.confirm div.modal-content", 30); // stepKey: waitForConfirmationModalRemoveProduct2FromMiniCart
		$I->see("Are you sure you would like to remove this item from the shopping cart?", "aside.confirm div.modal-content"); // stepKey: seeDeleteConfirmationMessageRemoveProduct2FromMiniCart
		$I->click("aside.confirm .modal-footer .action-primary"); // stepKey: confirmDeleteRemoveProduct2FromMiniCart
		$I->waitForPageLoad(30); // stepKey: waitForDeleteToFinishRemoveProduct2FromMiniCart
		$I->comment("Exiting Action Group [removeProduct2FromMiniCart] RemoveProductFromMiniCartActionGroup");
		$I->comment("Entering Action Group [removeProduct3FromMiniCart] RemoveProductFromMiniCartActionGroup");
		$I->conditionalClick("a.showcart", "a.showcart.active", false); // stepKey: openMiniCartRemoveProduct3FromMiniCart
		$I->waitForElementVisible(".action.viewcart", 30); // stepKey: waitForMiniCartOpenRemoveProduct3FromMiniCart
		$I->waitForPageLoad(30); // stepKey: waitForMiniCartOpenRemoveProduct3FromMiniCartWaitForPageLoad
		$I->click("//ol[@id='mini-cart']//div[contains(., '" . $I->retrieveEntityField('simpleProduct8', 'name', 'test') . "')]//a[contains(@class, 'delete')]"); // stepKey: clickDeleteRemoveProduct3FromMiniCart
		$I->waitForElementVisible("aside.confirm div.modal-content", 30); // stepKey: waitForConfirmationModalRemoveProduct3FromMiniCart
		$I->see("Are you sure you would like to remove this item from the shopping cart?", "aside.confirm div.modal-content"); // stepKey: seeDeleteConfirmationMessageRemoveProduct3FromMiniCart
		$I->click("aside.confirm .modal-footer .action-primary"); // stepKey: confirmDeleteRemoveProduct3FromMiniCart
		$I->waitForPageLoad(30); // stepKey: waitForDeleteToFinishRemoveProduct3FromMiniCart
		$I->comment("Exiting Action Group [removeProduct3FromMiniCart] RemoveProductFromMiniCartActionGroup");
		$I->comment("Entering Action Group [removeProduct4FromMiniCart] RemoveProductFromMiniCartActionGroup");
		$I->conditionalClick("a.showcart", "a.showcart.active", false); // stepKey: openMiniCartRemoveProduct4FromMiniCart
		$I->waitForElementVisible(".action.viewcart", 30); // stepKey: waitForMiniCartOpenRemoveProduct4FromMiniCart
		$I->waitForPageLoad(30); // stepKey: waitForMiniCartOpenRemoveProduct4FromMiniCartWaitForPageLoad
		$I->click("//ol[@id='mini-cart']//div[contains(., '" . $I->retrieveEntityField('simpleProduct7', 'name', 'test') . "')]//a[contains(@class, 'delete')]"); // stepKey: clickDeleteRemoveProduct4FromMiniCart
		$I->waitForElementVisible("aside.confirm div.modal-content", 30); // stepKey: waitForConfirmationModalRemoveProduct4FromMiniCart
		$I->see("Are you sure you would like to remove this item from the shopping cart?", "aside.confirm div.modal-content"); // stepKey: seeDeleteConfirmationMessageRemoveProduct4FromMiniCart
		$I->click("aside.confirm .modal-footer .action-primary"); // stepKey: confirmDeleteRemoveProduct4FromMiniCart
		$I->waitForPageLoad(30); // stepKey: waitForDeleteToFinishRemoveProduct4FromMiniCart
		$I->comment("Exiting Action Group [removeProduct4FromMiniCart] RemoveProductFromMiniCartActionGroup");
		$I->comment("Entering Action Group [removeProduct5FromMiniCart] RemoveProductFromMiniCartActionGroup");
		$I->conditionalClick("a.showcart", "a.showcart.active", false); // stepKey: openMiniCartRemoveProduct5FromMiniCart
		$I->waitForElementVisible(".action.viewcart", 30); // stepKey: waitForMiniCartOpenRemoveProduct5FromMiniCart
		$I->waitForPageLoad(30); // stepKey: waitForMiniCartOpenRemoveProduct5FromMiniCartWaitForPageLoad
		$I->click("//ol[@id='mini-cart']//div[contains(., '" . $I->retrieveEntityField('simpleProduct6', 'name', 'test') . "')]//a[contains(@class, 'delete')]"); // stepKey: clickDeleteRemoveProduct5FromMiniCart
		$I->waitForElementVisible("aside.confirm div.modal-content", 30); // stepKey: waitForConfirmationModalRemoveProduct5FromMiniCart
		$I->see("Are you sure you would like to remove this item from the shopping cart?", "aside.confirm div.modal-content"); // stepKey: seeDeleteConfirmationMessageRemoveProduct5FromMiniCart
		$I->click("aside.confirm .modal-footer .action-primary"); // stepKey: confirmDeleteRemoveProduct5FromMiniCart
		$I->waitForPageLoad(30); // stepKey: waitForDeleteToFinishRemoveProduct5FromMiniCart
		$I->comment("Exiting Action Group [removeProduct5FromMiniCart] RemoveProductFromMiniCartActionGroup");
		$I->comment("Entering Action Group [removeProduct6FromMiniCart] RemoveProductFromMiniCartActionGroup");
		$I->conditionalClick("a.showcart", "a.showcart.active", false); // stepKey: openMiniCartRemoveProduct6FromMiniCart
		$I->waitForElementVisible(".action.viewcart", 30); // stepKey: waitForMiniCartOpenRemoveProduct6FromMiniCart
		$I->waitForPageLoad(30); // stepKey: waitForMiniCartOpenRemoveProduct6FromMiniCartWaitForPageLoad
		$I->click("//ol[@id='mini-cart']//div[contains(., '" . $I->retrieveEntityField('simpleProduct5', 'name', 'test') . "')]//a[contains(@class, 'delete')]"); // stepKey: clickDeleteRemoveProduct6FromMiniCart
		$I->waitForElementVisible("aside.confirm div.modal-content", 30); // stepKey: waitForConfirmationModalRemoveProduct6FromMiniCart
		$I->see("Are you sure you would like to remove this item from the shopping cart?", "aside.confirm div.modal-content"); // stepKey: seeDeleteConfirmationMessageRemoveProduct6FromMiniCart
		$I->click("aside.confirm .modal-footer .action-primary"); // stepKey: confirmDeleteRemoveProduct6FromMiniCart
		$I->waitForPageLoad(30); // stepKey: waitForDeleteToFinishRemoveProduct6FromMiniCart
		$I->comment("Exiting Action Group [removeProduct6FromMiniCart] RemoveProductFromMiniCartActionGroup");
		$I->comment("Entering Action Group [removeProduct7FromMiniCart] RemoveProductFromMiniCartActionGroup");
		$I->conditionalClick("a.showcart", "a.showcart.active", false); // stepKey: openMiniCartRemoveProduct7FromMiniCart
		$I->waitForElementVisible(".action.viewcart", 30); // stepKey: waitForMiniCartOpenRemoveProduct7FromMiniCart
		$I->waitForPageLoad(30); // stepKey: waitForMiniCartOpenRemoveProduct7FromMiniCartWaitForPageLoad
		$I->click("//ol[@id='mini-cart']//div[contains(., '" . $I->retrieveEntityField('simpleProduct4', 'name', 'test') . "')]//a[contains(@class, 'delete')]"); // stepKey: clickDeleteRemoveProduct7FromMiniCart
		$I->waitForElementVisible("aside.confirm div.modal-content", 30); // stepKey: waitForConfirmationModalRemoveProduct7FromMiniCart
		$I->see("Are you sure you would like to remove this item from the shopping cart?", "aside.confirm div.modal-content"); // stepKey: seeDeleteConfirmationMessageRemoveProduct7FromMiniCart
		$I->click("aside.confirm .modal-footer .action-primary"); // stepKey: confirmDeleteRemoveProduct7FromMiniCart
		$I->waitForPageLoad(30); // stepKey: waitForDeleteToFinishRemoveProduct7FromMiniCart
		$I->comment("Exiting Action Group [removeProduct7FromMiniCart] RemoveProductFromMiniCartActionGroup");
		$I->comment("Entering Action Group [removeProduct8FromMiniCart] RemoveProductFromMiniCartActionGroup");
		$I->conditionalClick("a.showcart", "a.showcart.active", false); // stepKey: openMiniCartRemoveProduct8FromMiniCart
		$I->waitForElementVisible(".action.viewcart", 30); // stepKey: waitForMiniCartOpenRemoveProduct8FromMiniCart
		$I->waitForPageLoad(30); // stepKey: waitForMiniCartOpenRemoveProduct8FromMiniCartWaitForPageLoad
		$I->click("//ol[@id='mini-cart']//div[contains(., '" . $I->retrieveEntityField('simpleProduct3', 'name', 'test') . "')]//a[contains(@class, 'delete')]"); // stepKey: clickDeleteRemoveProduct8FromMiniCart
		$I->waitForElementVisible("aside.confirm div.modal-content", 30); // stepKey: waitForConfirmationModalRemoveProduct8FromMiniCart
		$I->see("Are you sure you would like to remove this item from the shopping cart?", "aside.confirm div.modal-content"); // stepKey: seeDeleteConfirmationMessageRemoveProduct8FromMiniCart
		$I->click("aside.confirm .modal-footer .action-primary"); // stepKey: confirmDeleteRemoveProduct8FromMiniCart
		$I->waitForPageLoad(30); // stepKey: waitForDeleteToFinishRemoveProduct8FromMiniCart
		$I->comment("Exiting Action Group [removeProduct8FromMiniCart] RemoveProductFromMiniCartActionGroup");
		$I->comment("Entering Action Group [removeProduct9FromMiniCart] RemoveProductFromMiniCartActionGroup");
		$I->conditionalClick("a.showcart", "a.showcart.active", false); // stepKey: openMiniCartRemoveProduct9FromMiniCart
		$I->waitForElementVisible(".action.viewcart", 30); // stepKey: waitForMiniCartOpenRemoveProduct9FromMiniCart
		$I->waitForPageLoad(30); // stepKey: waitForMiniCartOpenRemoveProduct9FromMiniCartWaitForPageLoad
		$I->click("//ol[@id='mini-cart']//div[contains(., '" . $I->retrieveEntityField('simpleProduct2', 'name', 'test') . "')]//a[contains(@class, 'delete')]"); // stepKey: clickDeleteRemoveProduct9FromMiniCart
		$I->waitForElementVisible("aside.confirm div.modal-content", 30); // stepKey: waitForConfirmationModalRemoveProduct9FromMiniCart
		$I->see("Are you sure you would like to remove this item from the shopping cart?", "aside.confirm div.modal-content"); // stepKey: seeDeleteConfirmationMessageRemoveProduct9FromMiniCart
		$I->click("aside.confirm .modal-footer .action-primary"); // stepKey: confirmDeleteRemoveProduct9FromMiniCart
		$I->waitForPageLoad(30); // stepKey: waitForDeleteToFinishRemoveProduct9FromMiniCart
		$I->comment("Exiting Action Group [removeProduct9FromMiniCart] RemoveProductFromMiniCartActionGroup");
		$I->comment("Entering Action Group [removeProduct10FromMiniCart] RemoveProductFromMiniCartActionGroup");
		$I->conditionalClick("a.showcart", "a.showcart.active", false); // stepKey: openMiniCartRemoveProduct10FromMiniCart
		$I->waitForElementVisible(".action.viewcart", 30); // stepKey: waitForMiniCartOpenRemoveProduct10FromMiniCart
		$I->waitForPageLoad(30); // stepKey: waitForMiniCartOpenRemoveProduct10FromMiniCartWaitForPageLoad
		$I->click("//ol[@id='mini-cart']//div[contains(., '" . $I->retrieveEntityField('simpleProduct1', 'name', 'test') . "')]//a[contains(@class, 'delete')]"); // stepKey: clickDeleteRemoveProduct10FromMiniCart
		$I->waitForElementVisible("aside.confirm div.modal-content", 30); // stepKey: waitForConfirmationModalRemoveProduct10FromMiniCart
		$I->see("Are you sure you would like to remove this item from the shopping cart?", "aside.confirm div.modal-content"); // stepKey: seeDeleteConfirmationMessageRemoveProduct10FromMiniCart
		$I->click("aside.confirm .modal-footer .action-primary"); // stepKey: confirmDeleteRemoveProduct10FromMiniCart
		$I->waitForPageLoad(30); // stepKey: waitForDeleteToFinishRemoveProduct10FromMiniCart
		$I->comment("Exiting Action Group [removeProduct10FromMiniCart] RemoveProductFromMiniCartActionGroup");
		...
		$I->dontSee("//header//ol[@id='mini-cart']//div[@class='product-item-details']//a[contains(text(), '" . $I->retrieveEntityField('simpleProduct1', 'name', 'test') . "')]"); // stepKey: verifyAssertProduct1AbsentInMiniShoppingCart
		$I->dontSee("//header//ol[@id='mini-cart']//div[@class='product-item-details']//a[contains(text(), '" . $I->retrieveEntityField('simpleProduct2', 'name', 'test') . "')]"); // stepKey: verifyAssertProduct2AbsentInMiniShoppingCart
		$I->dontSee("//header//ol[@id='mini-cart']//div[@class='product-item-details']//a[contains(text(), '" . $I->retrieveEntityField('simpleProduct3', 'name', 'test') . "')]"); // stepKey: verifyAssertProduct3AbsentInMiniShoppingCart
		$I->dontSee("//header//ol[@id='mini-cart']//div[@class='product-item-details']//a[contains(text(), '" . $I->retrieveEntityField('simpleProduct4', 'name', 'test') . "')]"); // stepKey: verifyAssertProduct4AbsentInMiniShoppingCart
		$I->dontSee("//header//ol[@id='mini-cart']//div[@class='product-item-details']//a[contains(text(), '" . $I->retrieveEntityField('simpleProduct5', 'name', 'test') . "')]"); // stepKey: verifyAssertProduct5AbsentInMiniShoppingCart
		$I->dontSee("//header//ol[@id='mini-cart']//div[@class='product-item-details']//a[contains(text(), '" . $I->retrieveEntityField('simpleProduct6', 'name', 'test') . "')]"); // stepKey: verifyAssertProduct6AbsentInMiniShoppingCart
		$I->dontSee("//header//ol[@id='mini-cart']//div[@class='product-item-details']//a[contains(text(), '" . $I->retrieveEntityField('simpleProduct7', 'name', 'test') . "')]"); // stepKey: verifyAssertProduct7AbsentInMiniShoppingCart
		$I->dontSee("//header//ol[@id='mini-cart']//div[@class='product-item-details']//a[contains(text(), '" . $I->retrieveEntityField('simpleProduct8', 'name', 'test') . "')]"); // stepKey: verifyAssertProduct8AbsentInMiniShoppingCart
		$I->dontSee("//header//ol[@id='mini-cart']//div[@class='product-item-details']//a[contains(text(), '" . $I->retrieveEntityField('simpleProduct9', 'name', 'test') . "')]"); // stepKey: verifyAssertProduct9AbsentInMiniShoppingCart
		$I->dontSee("//header//ol[@id='mini-cart']//div[@class='product-item-details']//a[contains(text(), '" . $I->retrieveEntityField('simpleProduct10', 'name', 'test') . "')]"); // stepKey: verifyAssertProduct10AbsentInMiniShoppingCart
	}
}
