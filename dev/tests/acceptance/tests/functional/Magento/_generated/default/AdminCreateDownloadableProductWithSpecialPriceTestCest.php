...
/**
 * @Title("MC-14513: Create downloadable product with special price test")
 * @Description("Admin should be able to create downloadable product with special price<h3>Test files</h3>app/code/Magento/Downloadable/Test/Mftf/Test/AdminCreateDownloadableProductWithSpecialPriceTest.xml<br>")
 * @TestCaseId("MC-14513")
 * @group Downloadable
 * @group mtf_migrated
 */
class AdminCreateDownloadableProductWithSpecialPriceTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateDownloadableProductWithSpecialPriceTest(AcceptanceTester $I)
	{
		...
		$I->fillField("input[name='product[special_price]']", "99.99"); // stepKey: fillSpecialPriceSetSpecialPriceToCreatedProduct
		...
		$I->comment("Add special price to product");
		...
		$I->comment("Assert special price in storefront product page");
		$I->see("$99.99", "//span[@class='special-price']//span[@class='price']"); // stepKey: assertSpecialPrice
