...
/**
 * @Title("MC-16568: Url-rewrites for product in anchor categories")
 * @Description("For a product with category that has parent anchor categories, the rewrites is created when the category/product is saved.<h3>Test files</h3>app/code/Magento/UrlRewrite/Test/Mftf/Test/AdminUrlRewritesForProductInAnchorCategoriesTest/AdminUrlRewritesForProductInAnchorCategoriesTest.xml<br>")
 * @TestCaseId("MC-16568")
 * @group urlRewrite
 */
class AdminUrlRewritesForProductInAnchorCategoriesTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminUrlRewritesForProductInAnchorCategoriesTest(AcceptanceTester $I)
	{
		...
		$I->fillField("input[name='url_key']", $I->retrieveEntityField('simpleSubCategory1', 'custom_attributes[url_key]', 'test') . "new"); // stepKey: enterURLKeyChangeFirstCategoryUrlKey
