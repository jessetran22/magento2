...
/**
 * @Title("MC-60: Admin should be able to create a catalog price rule adjust final price to discount value (for simple product)")
 * @Description("Admin should be able to create a catalog price rule adjust final price to discount value (for simple product)<h3>Test files</h3>app/code/Magento/CatalogRule/Test/Mftf/Test/AdminCreateCatalogPriceRuleTest/AdminCreateCatalogPriceRuleToFixedTest.xml<br>")
 * @TestCaseId("MC-60")
 * @group CatalogRule
 */
class AdminCreateCatalogPriceRuleToFixedTestCest
{
    /**
	...
	public function _before(AcceptanceTester $I)
	{
		...
		$I->fillField("[name='name']", "CatalogPriceRule" . msq("CatalogRuleToFixed")); // stepKey: fillNameCreateNewPriceRule
		...
		$I->fillField("[name='discount_amount']", "110.7"); // stepKey: fillDiscountValueCreateNewPriceRule
		$I->selectOption("[name='simple_action']", "to_fixed"); // stepKey: discountTypeCreateNewPriceRule
	...
	public function _after(AcceptanceTester $I)
	{
		...
		$I->fillField(".col-name .admin__control-text", "CatalogPriceRule" . msq("CatalogRuleToFixed")); // stepKey: fillIdentifierDeletePriceRule
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateCatalogPriceRuleToFixedTest(AcceptanceTester $I)
	{
