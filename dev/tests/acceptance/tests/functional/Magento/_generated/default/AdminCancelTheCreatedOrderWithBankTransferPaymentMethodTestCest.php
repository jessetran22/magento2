 ...
 * @Description("Created an order with bank transfer payment method and cancel the order<h3>Test files</h3>app/code/Magento/Sales/Test/Mftf/Test/AdminCancelTheCreatedOrderWithBankTransferPaymentMethodTest.xml<br>")
 * @TestCaseId("MC-16068")
 */
