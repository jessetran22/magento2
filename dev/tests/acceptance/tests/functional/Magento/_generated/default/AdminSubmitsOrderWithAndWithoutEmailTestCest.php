...
/**
 * @Title("MAGETWO-92980: Email is required to create an order from Admin Panel")
 * @Description("Admin should not be able to submit orders without an email address<h3>Test files</h3>app/code/Magento/Sales/Test/Mftf/Test/AdminSubmitsOrderWithAndWithoutEmailTest.xml<br>")
 * @TestCaseId("MAGETWO-92980")
 * @group sales
 */
class AdminSubmitsOrderWithAndWithoutEmailTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminSubmitsOrderWithAndWithoutEmailTest(AcceptanceTester $I)
	{
