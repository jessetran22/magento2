...
/**
 * @Title("MC-97: Guest customer should be able to successfully add the product to the cart")
 * @Description("Guest customer should be able to successfully add the product to the cart<h3>Test files</h3>app/code/Magento/ConfigurableProduct/Test/Mftf/Test/StorefrontConfigurableProductDetailsTest/StorefrontConfigurableProductCanAddToCartTest.xml<br>")
 * @TestCaseId("MC-97")
 * @group ConfigurableProduct
 */
class StorefrontConfigurableProductCanAddToCartTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function StorefrontConfigurableProductCanAddToCartTest(AcceptanceTester $I)
	{
		$I->comment("Verify adding configurable product to cart after an option is selected in storefront product view");
