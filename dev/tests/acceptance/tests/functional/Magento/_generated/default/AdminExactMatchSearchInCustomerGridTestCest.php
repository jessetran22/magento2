...
/**
 * @Title("MC-16335: Admin customer grid exact match searching")
 * @Description("Admin customer grid exact match searching with quotes in keyword<h3>Test files</h3>app/code/Magento/Customer/Test/Mftf/Test/AdminExactMatchSearchInCustomerGridTest.xml<br>")
 * @TestCaseId("MC-16335")
 * @group customer
 */
class AdminExactMatchSearchInCustomerGridTestCest
{
	/**
	...
	public function _before(AcceptanceTester $I)
	{
		...
		$createSecondCustomerFields['firstname'] = "Jane Doe";
		$I->createEntity("createSecondCustomer", "hook", "Simple_US_Customer", [], $createSecondCustomerFields); // stepKey: createSecondCustomer
	 ...
	 * @throws \Exception
	 */
	public function AdminExactMatchSearchInCustomerGridTest(AcceptanceTester $I)
	{
		...
		$I->waitForPageLoad(30); // stepKey: waitForPageLoadOpenCustomersGridPage
		$I->comment("Exiting Action Group [openCustomersGridPage] AdminOpenCustomersGridActionGroup");
		$I->comment("Step 2: On Customers grid page search customer by keyword with quotes");
		...
		$I->fillField(".admin__data-grid-header[data-bind='afterRender: \$data.setToolbarNode'] input[placeholder='Search by keyword']", $I->retrieveEntityField('createSecondCustomer', 'firstname', 'test')); // stepKey: fillKeywordSearchFieldSearchCustomer
		...
		$I->see($I->retrieveEntityField('createSecondCustomer', 'fullname', 'test'), "//*[@data-role='sticky-el-root']/parent::div/parent::div/following-sibling::div//tbody//*[@class='data-row'][1]"); // stepKey: seeCustomerInGridCheckCustomerInGrid
