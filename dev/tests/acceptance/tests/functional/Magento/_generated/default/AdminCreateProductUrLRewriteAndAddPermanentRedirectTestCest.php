...
/**
 * @Title("MC-5341: Create product URL rewrite, with permanent redirect")
 * @Description("Login as admin, create product UrlRewrite and add Permanent redirect<h3>Test files</h3>app/code/Magento/UrlRewrite/Test/Mftf/Test/AdminCreateProductUrLRewriteAndAddPermanentRedirectTest.xml<br>")
 * @TestCaseId("MC-5341")
 * @group mtf_migrated
 */
class AdminCreateProductUrLRewriteAndAddPermanentRedirectTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateProductUrLRewriteAndAddPermanentRedirectTest(AcceptanceTester $I)
	{
