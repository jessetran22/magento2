...
class AdminDeleteCatalogPriceRuleTestCest
{
	...
	public function AdminDeleteCatalogPriceRuleTest(AcceptanceTester $I)
	{
		...
		$I->amOnPage($I->retrieveEntityField('createCategory', 'custom_attributes[url_key]', 'test') . ".html"); // stepKey: goToCategoryPage1
		...
		$I->amOnPage("testproductname" . msq("_defaultProduct") . ".html"); // stepKey: goToConfigurableProductPage1
		...
		$I->amOnPage($I->retrieveEntityField('createCategory', 'custom_attributes[url_key]', 'test') . ".html"); // stepKey: goToCategoryPage2
		...
		$I->amOnPage("testproductname" . msq("_defaultProduct") . ".html"); // stepKey: goToConfigurableProductPage2
