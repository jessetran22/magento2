 ...
 * @Description("Admin should be able to create a CMS page with widget type: Recently Compared Products<h3>Test files</h3>app/code/Magento/Cms/Test/Mftf/Test/AdminAddWidgetToWYSIWYGWithRecentlyComparedProductsTypeTest.xml<br>")
...
class AdminAddWidgetToWYSIWYGWithRecentlyComparedProductsTypeTestCest
{
	...
	public function AdminAddWidgetToWYSIWYGWithRecentlyComparedProductsTypeTest(AcceptanceTester $I)
	{
		...
		$I->amOnPage($I->retrieveEntityField('createPreReqCategory', 'custom_attributes[url_key]', 'test') . ".html"); // stepKey: amOnCatalogPage
