...
/**
 * @Title("MC-296: Tax for Virtual Product Quote should be recalculated in Shopping Cart for Logged in Customer with Default Address")
 * @Description("Tax for Virtual Product Quote should be recalculated in Shopping Cart for Logged in Customer with Default Address<h3>Test files</h3>app/code/Magento/Tax/Test/Mftf/Test/StorefrontTaxQuoteCartTest/StorefrontTaxQuoteCartLoggedInVirtualTest.xml<br>")
 * @TestCaseId("MC-296")
 * @group Tax
 */
class StorefrontTaxQuoteCartLoggedInVirtualTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function StorefrontTaxQuoteCartLoggedInVirtualTest(AcceptanceTester $I)
	{
		...
		$I->see("$" . $I->retrieveEntityField('virtualProduct1', 'price', 'test'), "//tr[@class='grand totals incl']//span[@class='price']"); // stepKey: seeTotalIncl2
		...
		$I->selectOption("select[name='region_id']", "California"); // stepKey: selectStateProvinceChangeAddress2
		...
		$I->see("$8.25", "[data-th='Tax'] span"); // stepKey: seeTax3
		...
		$I->see("$108.24", "//tr[@class='grand totals incl']//span[@class='price']"); // stepKey: seeTotalIncl3
		$I->see($I->retrieveEntityField('virtualProduct1', 'price', 'test'), "//tr[@class='grand totals excl']//span[@class='price']"); // stepKey: seeTotalExcl3
	}
}
