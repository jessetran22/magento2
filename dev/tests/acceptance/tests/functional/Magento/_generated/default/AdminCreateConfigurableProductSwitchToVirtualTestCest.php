...
/**
 * @Title("MC-10927: Admin should be able to switch a new product from configurable to virtual")
 * @Description("After selecting a configurable product when adding Admin should be switch to virtual implicitly<h3>Test files</h3>app/code/Magento/ConfigurableProduct/Test/Mftf/Test/AdminCreateAndSwitchProductType/AdminCreateConfigurableProductSwitchToVirtualTest.xml<br>")
 * @TestCaseId("MC-10927")
 * @group catalog
 * @group mtf_migrated
 */
class AdminCreateConfigurableProductSwitchToVirtualTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateConfigurableProductSwitchToVirtualTest(AcceptanceTester $I)
	{
