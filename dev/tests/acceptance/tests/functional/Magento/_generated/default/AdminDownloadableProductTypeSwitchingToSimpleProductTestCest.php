 ...
 * @Description("Downloadable product type switching on editing to Simple product<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/AdminProductTypeSwitchingOnEditingTest/AdminDownloadableProductTypeSwitchingToSimpleProductTest.xml<br>")
 * @TestCaseId("MC-17955")
 * @group catalog
 */
class AdminDownloadableProductTypeSwitchingToSimpleProductTestCest
{
	...
	public function AdminDownloadableProductTypeSwitchingToSimpleProductTest(AcceptanceTester $I)
	{
		...
		$I->dontSee(".message-warning"); // stepKey: dontSeeWarningMessageSaveDownloadableProductForm
		...
		$I->comment("Assert downloadable product on storefront");
		$I->amOnPage("/" . $I->retrieveEntityField('createProduct', 'custom_attributes[url_key]', 'test') . ".html"); // stepKey: openDownloadableProductPage
		...
		$I->comment("Entering Action Group [goToCatalogSimpleProductPage] AdminOpenCatalogProductPageActionGroup");
		$I->amOnPage((getenv("MAGENTO_BACKEND_BASE_URL") ? rtrim(getenv("MAGENTO_BACKEND_BASE_URL"), "/") : "") . "/" . getenv("MAGENTO_BACKEND_NAME") . "/catalog/product/"); // stepKey: openCatalogProductPageGoToCatalogSimpleProductPage
		$I->waitForPageLoad(30); // stepKey: waitForPageToLoadGoToCatalogSimpleProductPage
		$I->comment("Exiting Action Group [goToCatalogSimpleProductPage] AdminOpenCatalogProductPageActionGroup");
		...
		$I->comment("Assert simple product on storefront");
		$I->amOnPage("/" . $I->retrieveEntityField('createProduct', 'custom_attributes[url_key]', 'test') . ".html"); // stepKey: openSimpleProductPage
