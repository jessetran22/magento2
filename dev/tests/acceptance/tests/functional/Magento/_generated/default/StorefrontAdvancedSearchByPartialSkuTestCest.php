...
/**
 * @Title("MAGETWO-24729: Search product in advanced search by partial sku")
 * @Description("Search product in advanced search by partial sku<h3>Test files</h3>app/code/Magento/CatalogSearch/Test/Mftf/Test/StorefrontAdvancedSearchByPartialSkuTest.xml<br>")
 * @TestCaseId("MAGETWO-24729")
 * @group searchFrontend
 * @group mtf_migrated
 */
class StorefrontAdvancedSearchByPartialSkuTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function StorefrontAdvancedSearchByPartialSkuTest(AcceptanceTester $I)
	{
