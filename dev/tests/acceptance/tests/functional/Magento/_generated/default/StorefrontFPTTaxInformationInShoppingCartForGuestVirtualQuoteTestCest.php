 ...
 * @Description("Tax information are updating/recalculating on fly in shopping cart for Guest (virtual quote)<h3>Test files</h3>app/code/Magento/Weee/Test/Mftf/Test/StorefrontFPTTaxInformationInShoppingCartForGuestVirtualQuoteTest.xml<br>")
 * @TestCaseId("MC-26557")
 * @group checkout
 * @group tax
 * @group weee
