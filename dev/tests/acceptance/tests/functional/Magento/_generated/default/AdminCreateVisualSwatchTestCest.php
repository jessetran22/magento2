...
/**
 * @Title("MC-3080: Admin can create product attribute with picked color swatch")
 * @Description("Admin can create product attribute with picked color swatch<h3>Test files</h3>app/code/Magento/Swatches/Test/Mftf/Test/AdminCreateVisualSwatchTest.xml<br>")
 * @TestCaseId("MC-3080")
 * @group Swatches
 */
class AdminCreateVisualSwatchTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateVisualSwatchTest(AcceptanceTester $I)
	{
		...
		$I->comment("Entering Action Group [clickOnAddConfigurableProduct] AdminClickAddProductToggleAndSelectProductTypeActionGroup");
		$I->click(".action-toggle.primary.add"); // stepKey: clickAddProductDropdownClickOnAddConfigurableProduct
		$I->waitForPageLoad(30); // stepKey: clickAddProductDropdownClickOnAddConfigurableProductWaitForPageLoad
		$I->click(".item[data-ui-id='products-list-add-new-product-button-item-configurable']"); // stepKey: clickAddProductClickOnAddConfigurableProduct
		$I->waitForPageLoad(30); // stepKey: waitForFormToLoadClickOnAddConfigurableProduct
		$I->comment("Exiting Action Group [clickOnAddConfigurableProduct] AdminClickAddProductToggleAndSelectProductTypeActionGroup");
		...
		$I->fillField("input[name='product[url_key]']", "testproductname" . msq("_defaultProduct")); // stepKey: fillUrlKey
		...
		$I->amOnPage("testproductname" . msq("_defaultProduct") . ".html"); // stepKey: amOnProductPage
		$I->waitForPageLoad(30); // stepKey: waitForProductPage
		$I->comment("Verify that the storefront shows the swatches too");
		$I->comment("Entering Action Group [assertSwatch4] AssertStorefrontSwatchColorActionGroup");
		$grabStyle1AssertSwatch4 = $I->grabAttributeFrom("div.swatch-option:nth-of-type(1)", "style"); // stepKey: grabStyle1AssertSwatch4
		$I->assertEquals("background: center center no-repeat rgb(231, 77, 60);", $grabStyle1AssertSwatch4); // stepKey: assertStyle1AssertSwatch4
		$I->comment("Exiting Action Group [assertSwatch4] AssertStorefrontSwatchColorActionGroup");
		$I->comment("Entering Action Group [assertSwatch5] AssertStorefrontSwatchColorActionGroup");
		$grabStyle1AssertSwatch5 = $I->grabAttributeFrom("div.swatch-option:nth-of-type(2)", "style"); // stepKey: grabStyle1AssertSwatch5
		$I->assertEquals("background: center center no-repeat rgb(46, 204, 112);", $grabStyle1AssertSwatch5); // stepKey: assertStyle1AssertSwatch5
		$I->comment("Exiting Action Group [assertSwatch5] AssertStorefrontSwatchColorActionGroup");
		$I->comment("Entering Action Group [assertSwatch6] AssertStorefrontSwatchColorActionGroup");
		$grabStyle1AssertSwatch6 = $I->grabAttributeFrom("div.swatch-option:nth-of-type(3)", "style"); // stepKey: grabStyle1AssertSwatch6
		$I->assertEquals("background: center center no-repeat rgb(52, 152, 219);", $grabStyle1AssertSwatch6); // stepKey: assertStyle1AssertSwatch6
		$I->comment("Exiting Action Group [assertSwatch6] AssertStorefrontSwatchColorActionGroup");
	}
}
