...
/**
 * @Title("MAGETWO-24729: Search product in advanced search by price to")
 * @Description("Search product in advanced search by price to<h3>Test files</h3>app/code/Magento/CatalogSearch/Test/Mftf/Test/StorefrontAdvancedSearchByPriceToTest.xml<br>")
 * @TestCaseId("MAGETWO-24729")
 * @group searchFrontend
 * @group mtf_migrated
 */
class StorefrontAdvancedSearchByPriceToTestCest
{
    /**
	...
	public function _before(AcceptanceTester $I)
	{
		...
		$I->createEntity("createProduct2", "hook", "ABC_123_SimpleProduct", [], []); // stepKey: createProduct2
	}
	 ...
	 * @throws \Exception
	 */
	public function StorefrontAdvancedSearchByPriceToTest(AcceptanceTester $I)
	{
		...
		$I->fillField("#price_to", "100"); // stepKey: fillPriceToSearch
		$I->scrollTo("//*[@id='form-validate']//button[@type='submit']"); // stepKey: scrollToSubmitButtonSearch
		...
		$I->see("items", ".search.found>strong"); // stepKey: see
		$I->see($I->retrieveEntityField('createProduct', 'name', 'test'), ".product.name.product-item-name>a"); // stepKey: seeProductName
		$I->see($I->retrieveEntityField('createProduct2', 'name', 'test'), ".product.name.product-item-name>a"); // stepKey: seeProduct2Name
		$I->comment("See that some items were found, other products may exist besides our test products");
	}
}
