...
/**
 * @Title("MC-14150: Admin stores currency rates navigate menu test")
 * @Description("Admin should be able to navigate to Stores > Currency Rates<h3>Test files</h3>app/code/Magento/CurrencySymbol/Test/Mftf/Test/AdminStoresCurrencyRatesNavigateMenuTest.xml<br>")
 * @TestCaseId("MC-14150")
 * @group menu
 * @group mtf_migrated
 */
class AdminStoresCurrencyRatesNavigateMenuTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdminStoresCurrencyRatesNavigateMenuTest(AcceptanceTester $I)
	{
		...
		$I->see("Currency Rates", ".page-title-wrapper h1"); // stepKey: assertPageTitleSeePageTitle
