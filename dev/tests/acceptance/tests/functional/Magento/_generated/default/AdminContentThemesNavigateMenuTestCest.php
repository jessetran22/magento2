...
/**
 * @Title("MC-14112: Admin content themes navigate menu test")
 * @Description("Admin should be able to navigate to Content > Themes<h3>Test files</h3>app/code/Magento/Theme/Test/Mftf/Test/AdminContentThemesNavigateMenuTest.xml<br>")
 * @TestCaseId("MC-14112")
 * @group menu
 * @group mtf_migrated
 */
class AdminContentThemesNavigateMenuTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function AdminContentThemesNavigateMenuTest(AcceptanceTester $I)
	{
