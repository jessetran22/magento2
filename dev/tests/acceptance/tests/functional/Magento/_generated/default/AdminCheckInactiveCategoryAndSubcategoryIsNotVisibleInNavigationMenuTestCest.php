...
/**
 * @Title("MC-13637: Inactive Category and subcategory are not visible on navigation menu, Include in Menu = Yes")
 * @Description("Login as admin and verify inactive category and subcategory is not visible in navigation menu<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/AdminCheckInactiveCategoryAndSubcategoryIsNotVisibleInNavigationMenuTest.xml<br>")
 * @TestCaseId("MC-13637")
 * @group mtf_migrated
 */
class AdminCheckInactiveCategoryAndSubcategoryIsNotVisibleInNavigationMenuTestCest
{
    /**
	...
	public function _before(AcceptanceTester $I)
	{
		...
		$I->comment("Create Parent Inactive Category");
	 ...
	 * @throws \Exception
	 */
	public function AdminCheckInactiveCategoryAndSubcategoryIsNotVisibleInNavigationMenuTest(AcceptanceTester $I)
	{
