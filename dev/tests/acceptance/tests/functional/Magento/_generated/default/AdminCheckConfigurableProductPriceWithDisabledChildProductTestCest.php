 ...
 * @Description("Login as admin and check the configurable product price when one child product is disabled<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/AdminCheckConfigurableProductPriceWithDisabledChildProductTest.xml<br>")
 * @TestCaseId("MC-13749")
 * @group mtf_migrated
 */
