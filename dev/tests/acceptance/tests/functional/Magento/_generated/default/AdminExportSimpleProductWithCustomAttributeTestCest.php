 ...
 * @Description("Admin should be able to export Simple Product with custom attribute<h3>Test files</h3>app/code/Magento/CatalogImportExport/Test/Mftf/Test/AdminExportSimpleProductWithCustomAttributeTest.xml<br>")
 * @TestCaseId("MC-14007")
