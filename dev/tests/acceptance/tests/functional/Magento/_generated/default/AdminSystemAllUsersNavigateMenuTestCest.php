 ...
 * @Description("Admin should be able to navigate to System > All Users<h3>Test files</h3>app/code/Magento/User/Test/Mftf/Test/AdminSystemAllUsersNavigateMenuTest.xml<br>")
 * @TestCaseId("MC-14123")
 * @group menu
 * @group mtf_migrated
 */
