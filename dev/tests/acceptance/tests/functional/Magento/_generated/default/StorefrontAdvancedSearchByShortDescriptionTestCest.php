...
/**
 * @Title("MAGETWO-24729: Search product in advanced search by short description")
 * @Description("Search product in advanced search by short description<h3>Test files</h3>app/code/Magento/CatalogSearch/Test/Mftf/Test/StorefrontAdvancedSearchByShortDescriptionTest.xml<br>")
 * @TestCaseId("MAGETWO-24729")
 * @group searchFrontend
 * @group mtf_migrated
 */
class StorefrontAdvancedSearchByShortDescriptionTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function StorefrontAdvancedSearchByShortDescriptionTest(AcceptanceTester $I)
	{
		...
		$I->fillField("#short_description", "dfj_short"); // stepKey: fillShortDescriptionSearch
		...
		$I->see("We can't find any items matching these search criteria. Modify your search.", "div .message"); // stepKey: see
	}
}
