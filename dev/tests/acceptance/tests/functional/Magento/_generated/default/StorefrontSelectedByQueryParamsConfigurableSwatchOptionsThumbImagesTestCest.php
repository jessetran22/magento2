...
/**
 * @Title("[NO TESTCASEID]: Check thumbnail images and active image for Configurable Product with swatch attribute                 with predefined by query params options")
 * @Description("Login as admin, create swatch attribute with two options, configurable product with two                 associated simple products. Add few images for products, check the fotorama thumbnail images                 (visible and active) for each option for the configurable product using product URL with params                 to selected needed option.<h3>Test files</h3>app/code/Magento/Swatches/Test/Mftf/Test/StorefrontSelectedByQueryParamsConfigurableSwatchOptionsThumbImagesTest.xml<br>")
 * @group swatches
 */
class StorefrontSelectedByQueryParamsConfigurableSwatchOptionsThumbImagesTestCest
{
    /**
	...
	public function _before(AcceptanceTester $I)
	{
		...
		$I->fillField("#attributeGrid_filter_frontend_label", $I->retrieveEntityField('createConfigProductAttribute', 'default_frontend_label', 'hook')); // stepKey: navigateToAttributeEditPage1NavigateToSkuProductAttribute
		...
		$I->comment("Entering Action Group [selectSwatchVisualInputType] AdminUpdateAttributeInputTypeActionGroup");
		$I->selectOption("#frontend_input", "swatch_visual"); // stepKey: setInputTypeSelectSwatchVisualInputType
		$I->comment("Exiting Action Group [selectSwatchVisualInputType] AdminUpdateAttributeInputTypeActionGroup");
		...
		$I->dontSee(".message-warning"); // stepKey: dontSeeWarningMessageSaveConfigProductProduct
		...
		$I->dontSee(".message-warning"); // stepKey: dontSeeWarningMessageSaveChildProduct1Product
		...
		$I->dontSee(".message-warning"); // stepKey: dontSeeWarningMessageSaveChildProduct2Product
		...
		$I->comment("Go to created attribute (attribute page)");
		$I->comment("Set 'swatch_visual' value for option \"Catalog Input Type for Store Owner\"");
		$I->comment("Set 'yes' value for option \"Update Product Preview Image\"");
	 ...
	 * @throws \Exception
	 */
	public function StorefrontSelectedByQueryParamsConfigurableSwatchOptionsThumbImagesTest(AcceptanceTester $I)
	{
		$I->comment("Open ConfigProduct in Store Front Page");
		$I->amOnPage($I->retrieveEntityField('createConfigProduct', 'custom_attributes[url_key]', 'test') . ".html"); // stepKey: openProductInStoreFront
		...
		$I->waitForPageLoad(30); // stepKey: seeActiveImageDefaultSeeMagento3ForNoOptionWaitForPageLoad
		...
		$I->waitForPageLoad(30); // stepKey: seeActiveImageDefaultSeeActiveTestImageAdobeForNoOptionWaitForPageLoad
		...
		$I->amOnPage($I->retrieveEntityField('createConfigProduct', 'sku', 'test') . ".html#" . $I->retrieveEntityField('createConfigProductAttribute', 'attribute_id', 'test') . "=" . $I->retrieveEntityField('getConfigAttributeOption1', 'value', 'test')); // stepKey: selectFirstOptionValue
		$I->reloadPage(); // stepKey: selectFirstOptionValueRefreshPage
		$I->waitForPageLoad(30); // stepKey: waitForProductWithSelectedFirstOptionToLoad
		...
		$I->waitForPageLoad(30); // stepKey: seeActiveImageDefaultSeeMagento3ForFirstOptionWaitForPageLoad
		...
		$I->waitForPageLoad(30); // stepKey: seeActiveImageDefaultSeeTestImageAdobeForFirstOptionWaitForPageLoad
		...
		$I->waitForPageLoad(30); // stepKey: seeActiveImageDefaultSeeProductImageForFirstOptionWaitForPageLoad
		...
		$I->amOnPage($I->retrieveEntityField('createConfigProduct', 'sku', 'test') . ".html#" . $I->retrieveEntityField('createConfigProductAttribute', 'attribute_id', 'test') . "=" . $I->retrieveEntityField('getConfigAttributeOption2', 'value', 'test')); // stepKey: selectSecondOptionValue
		$I->reloadPage(); // stepKey: selectSecondOptionValueRefreshPage
		$I->waitForPageLoad(30); // stepKey: waitForProductWithSelectedSecondOptionToLoad
		...
		$I->waitForPageLoad(30); // stepKey: seeActiveImageDefaultSeeMagento3ForSecondOptionWaitForPageLoad
		...
		$I->waitForPageLoad(30); // stepKey: seeActiveImageDefaultSeeTestImageAdobeForSecondOptionWaitForPageLoad
		...
		$I->comment("Select first option using product query params URL");
		$I->comment("Select second option using product query params URL");
	}
}
