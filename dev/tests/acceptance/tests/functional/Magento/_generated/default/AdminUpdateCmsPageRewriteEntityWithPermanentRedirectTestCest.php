...
/**
 * @Title("[NO TESTCASEID]: Update CMS Page URL Redirect With Permanent Redirect")
 * @Description("Login as Admin and tried to update the created URL Rewrite for CMS page<h3>Test files</h3>app/code/Magento/UrlRewrite/Test/Mftf/Test/AdminUpdateCmsPageRewriteEntityWithPermanentReirectTest.xml<br>")
 * @group cMSContent
 * @group mtf_migrated
 */
class AdminUpdateCmsPageRewriteEntityWithPermanentRedirectTestCest
{
    /**
	...
	/**
	 * @Stories({"Update CMS Page URL Redirect With Permanent Redirect"})
	 ...
	 * @throws \Exception
	 */
	public function AdminUpdateCmsPageRewriteEntityWithPermanentRedirectTest(AcceptanceTester $I)
	{
		...
		$I->click("//select[@id='redirect_type']//option[contains(., 'No')]"); // stepKey: selectRedirectTypeValueAddCustomUrlRewrite
		...
		$I->comment("Entering Action Group [updateUrlRewrite] AdminUpdateUrlRewriteActionGroup");
		...
		$I->fillField("//input[@id='request_path']", "permanentrequestpath.htm"); // stepKey: fillRequestPathUpdateUrlRewrite
		$I->click("//select[@id='redirect_type']"); // stepKey: selectRedirectTypeUpdateUrlRewrite
		$I->click("//select[@id='redirect_type']//option[contains(., 'Permanent (301)')]"); // stepKey: selectRedirectTypeValueUpdateUrlRewrite
		$I->fillField("#description", "test_description_301"); // stepKey: fillDescriptionUpdateUrlRewrite
		...
		$I->comment("Exiting Action Group [updateUrlRewrite] AdminUpdateUrlRewriteActionGroup");
		...
		$I->amOnPage("permanentrequestpath.htm"); // stepKey: goToStorefrontNavigateToTheStoreFront
		...
		$I->fillField(".admin__data-grid-filters input[name='request_path']", "permanentrequestpath.htm"); // stepKey: fillRedirectPathFilterDeleteCustomUrlRewrite
