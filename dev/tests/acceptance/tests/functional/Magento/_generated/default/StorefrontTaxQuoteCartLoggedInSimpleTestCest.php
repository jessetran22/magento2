...
/**
 * @Title("MC-295: Tax for Simple Product Quote should be recalculated in Shopping Cart for Logged in Customer with Default Address")
 * @Description("Tax for Simple Product Quote should be recalculated in Shopping Cart for Logged in Customer with Default Address<h3>Test files</h3>app/code/Magento/Tax/Test/Mftf/Test/StorefrontTaxQuoteCartTest/StorefrontTaxQuoteCartLoggedInSimpleTest.xml<br>")
 * @TestCaseId("MC-295")
 * @group Tax
 */
class StorefrontTaxQuoteCartLoggedInSimpleTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function StorefrontTaxQuoteCartLoggedInSimpleTest(AcceptanceTester $I)
	{
		...
		$I->waitForText("$5.00", 30, "//tr[@class='totals shipping excl']//span[@class='price']"); // stepKey: waitForCorrectShippingAmount
