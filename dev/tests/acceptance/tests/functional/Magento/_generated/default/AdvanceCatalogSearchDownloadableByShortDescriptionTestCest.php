...
/**
 * @Title("MC-245: Guest customer should be able to advance search Downloadable product with product short description")
 * @Description("Guest customer should be able to advance search Downloadable product with product short description<h3>Test files</h3>app/code/Magento/Downloadable/Test/Mftf/Test/AdvanceCatalogSearchDownloadableProductTest/AdvanceCatalogSearchDownloadableByShortDescriptionTest.xml<br>")
 * @TestCaseId("MC-245")
 * @group Downloadable
 */
class AdvanceCatalogSearchDownloadableByShortDescriptionTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdvanceCatalogSearchDownloadableByShortDescriptionTest(AcceptanceTester $I)
	{
