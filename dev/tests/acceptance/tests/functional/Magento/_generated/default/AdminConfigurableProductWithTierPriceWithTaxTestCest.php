...
/**
 * @Title("MC-37863: Create configurable product with tier price and check excluding tax item price")
 * @Description("Create configurable product with tier price and check excluding tax item price<h3>Test files</h3>app/code/Magento/ConfigurableProduct/Test/Mftf/Test/AdminConfigurableProductWithTierPriceWithTaxTest.xml<br>")
 * @TestCaseId("MC-37863")
 * @group ConfigurableProduct
 */
class AdminConfigurableProductWithTierPriceWithTaxTestCest
{
    /**
	...
	public function _before(AcceptanceTester $I)
	{
		...
		$enableShowIncludingExcludingTax = $I->magentoCLI("config:set tax/display/type 3", 60); // stepKey: enableShowIncludingExcludingTax
		$I->comment($enableShowIncludingExcludingTax);
	...
	public function _after(AcceptanceTester $I)
	{
		...
		$disableShowIncludingExcludingTax = $I->magentoCLI("config:set tax/display/type 0", 60); // stepKey: disableShowIncludingExcludingTax
		$I->comment($disableShowIncludingExcludingTax);
	 ...
	 * @throws \Exception
	 */
	public function AdminConfigurableProductWithTierPriceWithTaxTest(AcceptanceTester $I)
	{
		...
		$I->selectOption("#product-options-wrapper .super-attribute-select", $I->retrieveEntityField('createConfigProductAttributeOptionOne', 'option[store_labels][1][label]', 'test')); // stepKey: selectOption
		$I->comment("Assert tier price excluding including price item");
		$I->comment("Entering Action Group [assertProductTierPriceExcludingIncludingTax] AssertStorefrontProductDetailPageTierPriceActionGroup");
		$tierPriceTextAssertProductTierPriceExcludingIncludingTax = $I->grabTextFrom(".prices-tier li[class='item']"); // stepKey: tierPriceTextAssertProductTierPriceExcludingIncludingTax
		$I->assertEquals("Buy 2 for $97.43  $90.00 each and save 27%", $tierPriceTextAssertProductTierPriceExcludingIncludingTax); // stepKey: assertTierPriceTextOnProductPageAssertProductTierPriceExcludingIncludingTax
		$I->comment("Exiting Action Group [assertProductTierPriceExcludingIncludingTax] AssertStorefrontProductDetailPageTierPriceActionGroup");
		$I->comment("Entering Action Group [assertTierPriceExcludingPrice] StorefrontAssertExcludingTierPriceActionGroup");
		$tierPriceExcludingAssertTierPriceExcludingPrice = $I->grabTextFrom(".item [data-label='Excl. Tax']"); // stepKey: tierPriceExcludingAssertTierPriceExcludingPrice
		$I->assertStringContainsString("$90.00", $tierPriceExcludingAssertTierPriceExcludingPrice); // stepKey: assertTierPriceTextOnProductPageAssertTierPriceExcludingPrice
		$I->comment("Exiting Action Group [assertTierPriceExcludingPrice] StorefrontAssertExcludingTierPriceActionGroup");
	}
}
