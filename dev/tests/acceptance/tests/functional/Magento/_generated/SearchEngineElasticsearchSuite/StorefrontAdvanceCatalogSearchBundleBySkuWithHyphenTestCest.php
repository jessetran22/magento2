...
/**
 * @Title("MC-28812: Guest customer should be able to advance search Bundle product with product sku that contains hyphen")
 * @Description("Guest customer should be able to advance search Bundle product with product sku that contains hyphen<h3>Test files</h3>app/code/Magento/Bundle/Test/Mftf/Test/StorefrontAdvanceCatalogSearchBundleBySkuWithHyphenTest.xml<br>")
 * @TestCaseId("MC-28812")
 * @group Bundle
 * @group SearchEngineElasticsearch
 */
class StorefrontAdvanceCatalogSearchBundleBySkuWithHyphenTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function StorefrontAdvanceCatalogSearchBundleBySkuWithHyphenTest(AcceptanceTester $I)
	{
