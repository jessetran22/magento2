...
/**
 * @Title("MC-29383: Product quick search doesn't throw exception after ES is chosen as search engine with selected page out of range")
 * @Description("Verify no elastic search exception is thrown when try to get page with selected page out of range.<h3>Test files</h3>app/code/Magento/Elasticsearch6/Test/Mftf/Test/StorefrontProductQuickSearchUsingElasticSearchWithNotAvailablePageTest.xml<br>")
 * @TestCaseId("MC-29383")
 * @group catalog
 * @group elasticsearch
 ...
 */
class StorefrontProductQuickSearchUsingElasticSearchWithNotAvailablePageTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function StorefrontProductQuickSearchUsingElasticSearchWithNotAvailablePageTest(AcceptanceTester $I)
	{
		...
		$I->comment("Entering Action Group [navigateToUnavailableCatalogSearchResultPage] StorefrontQuickSearchWithPaginationActionGroup");
		$I->amOnPage("/catalogsearch/result/?q=AAA&p=999"); // stepKey: navigateToCatalogSearchPageWithPreparedRequestNavigateToUnavailableCatalogSearchResultPage
		$I->waitForPageLoad(30); // stepKey: waitForCatalogSearchPageLoadNavigateToUnavailableCatalogSearchResultPage
		$I->comment("Exiting Action Group [navigateToUnavailableCatalogSearchResultPage] StorefrontQuickSearchWithPaginationActionGroup");
