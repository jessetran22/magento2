...
/**
 * @Title("MC-28817: Guest customer should be able to advance search configurable product with product sku that contains hyphen")
 * @Description("Guest customer should be able to advance search configurable product with product sku that contains hyphen<h3>Test files</h3>app/code/Magento/ConfigurableProduct/Test/Mftf/Test/StorefrontAdvanceCatalogSearchConfigurableBySkuWithHyphenTest.xml<br>")
 * @TestCaseId("MC-28817")
 * @group ConfigurableProduct
 * @group SearchEngineElasticsearch
 */
class StorefrontAdvanceCatalogSearchConfigurableBySkuWithHyphenTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function StorefrontAdvanceCatalogSearchConfigurableBySkuWithHyphenTest(AcceptanceTester $I)
	{
