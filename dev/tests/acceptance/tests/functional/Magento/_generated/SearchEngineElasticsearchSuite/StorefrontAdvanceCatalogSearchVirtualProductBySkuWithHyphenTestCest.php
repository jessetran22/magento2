...
/**
 * @Title("MC-28816: Guest customer should be able to advance search virtual product with product sku that contains hyphen")
 * @Description("Guest customer should be able to advance search virtual product with product sku that contains hyphen<h3>Test files</h3>app/code/Magento/Catalog/Test/Mftf/Test/StorefrontAdvanceCatalogSearchVirtualProductBySkuWithHyphenTest.xml<br>")
 * @TestCaseId("MC-28816")
 * @group catalog
 * @group SearchEngineElasticsearch
 */
class StorefrontAdvanceCatalogSearchVirtualProductBySkuWithHyphenTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function StorefrontAdvanceCatalogSearchVirtualProductBySkuWithHyphenTest(AcceptanceTester $I)
	{
