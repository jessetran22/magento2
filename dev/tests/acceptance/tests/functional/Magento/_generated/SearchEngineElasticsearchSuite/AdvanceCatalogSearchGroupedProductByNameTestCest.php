...
/**
 * @Title("MC-25344: Guest customer should be able to advance search Grouped product with product name")
 * @Description("Guest customer should be able to advance search Grouped product with product name<h3>Test files</h3>app/code/Magento/GroupedProduct/Test/Mftf/Test/AdvanceCatalogSearchGroupedProductTest/AdvanceCatalogSearchGroupedProductByNameTest.xml<br>")
 * @TestCaseId("MC-25344")
 * @group groupedProduct
 * @group SearchEngineElasticsearch
 */
class AdvanceCatalogSearchGroupedProductByNameTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdvanceCatalogSearchGroupedProductByNameTest(AcceptanceTester $I)
	{
