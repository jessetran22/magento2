...
/**
 * @Title("MC-40416: Search product in advanced search by partial name")
 * @Description("Search product in advanced search by partial name<h3>Test files</h3>app/code/Magento/CatalogSearch/Test/Mftf/Test/StorefrontAdvancedSearchByPartialNameTest.xml<br>")
 * @TestCaseId("MC-40416")
 * @group searchFrontend
 * @group mtf_migrated
 * @group SearchEngineElasticsearch
 */
class StorefrontAdvancedSearchByPartialNameTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function StorefrontAdvancedSearchByPartialNameTest(AcceptanceTester $I)
	{
		...
		$I->fillField("#name", "abc"); // stepKey: fillNameSearch
