...
/**
 * @Title("MC-28832: Guest customer should be able to advance search Grouped product with product sku that in camelCase format")
 * @Description("Guest customer should be able to advance search Grouped product with product sku that in camelCase format<h3>Test files</h3>app/code/Magento/GroupedProduct/Test/Mftf/Test/StorefrontAdvanceCatalogSearchGroupedProductBySkuWithHyphenTest.xml<br>")
 * @TestCaseId("MC-28832")
 * @group GroupedProduct
 * @group SearchEngineElasticsearch
 */
class StorefrontAdvanceCatalogSearchGroupedProductBySkuWithHyphenTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function StorefrontAdvanceCatalogSearchGroupedProductBySkuWithHyphenTest(AcceptanceTester $I)
	{
		$I->comment("Entering Action Group [reindex] CliIndexerReindexActionGroup");
