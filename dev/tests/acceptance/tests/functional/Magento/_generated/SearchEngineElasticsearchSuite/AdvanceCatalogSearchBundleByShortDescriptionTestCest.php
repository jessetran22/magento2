...
/**
 * @Title("MC-25434: Guest customer should be able to advance search Bundle product with product short description")
 * @Description("Guest customer should be able to advance search Bundle product with product short description<h3>Test files</h3>app/code/Magento/Bundle/Test/Mftf/Test/AdvanceCatalogSearchBundleByShortDescriptionTest.xml<br>")
 * @TestCaseId("MC-25434")
 * @group bundle
 * @group SearchEngineElasticsearch
 */
class AdvanceCatalogSearchBundleByShortDescriptionTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdvanceCatalogSearchBundleByShortDescriptionTest(AcceptanceTester $I)
	{
