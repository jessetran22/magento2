...
/**
 * @Title("MC-25445: Guest customer should be able to advance search Grouped product with product price")
 * @Description("Guest customer should be able to advance search Grouped product with product price<h3>Test files</h3>app/code/Magento/GroupedProduct/Test/Mftf/Test/AdvanceCatalogSearchGroupedProductTest/AdvanceCatalogSearchGroupedProductByPriceTest.xml<br>")
 * @TestCaseId("MC-25445")
 * @group groupedProduct
 * @group SearchEngineElasticsearch
 */
class AdvanceCatalogSearchGroupedProductByPriceTestCest
{
    /**
	...
	public function _before(AcceptanceTester $I)
	{
		...
		$I->getEntity("arg1", "hook", "GetProduct3", ["product"], null); // stepKey: arg1
		$I->getEntity("arg2", "hook", "GetProduct", ["simple1"], null); // stepKey: arg2
		$I->getEntity("arg3", "hook", "GetProduct", ["simple2"], null); // stepKey: arg3
	 ...
	 * @throws \Exception
	 */
	public function AdvanceCatalogSearchGroupedProductByPriceTest(AcceptanceTester $I)
	{
