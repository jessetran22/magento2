...
/**
 * @Title("MC-25427: Guest customer should be able to advance search Bundle product with product description")
 * @Description("Guest customer should be able to advance search Bundle product with product description<h3>Test files</h3>app/code/Magento/Bundle/Test/Mftf/Test/AdvanceCatalogSearchBundleByDescriptionTest.xml<br>")
 * @TestCaseId("MC-25427")
 * @group bundle
 * @group SearchEngineElasticsearch
 */
class AdvanceCatalogSearchBundleByDescriptionTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdvanceCatalogSearchBundleByDescriptionTest(AcceptanceTester $I)
	{
