...
/**
 * @Title("MC-25435: Guest customer should be able to advance search Bundle product with product price")
 * @Description("Guest customer should be able to advance search Bundle product with product price<h3>Test files</h3>app/code/Magento/Bundle/Test/Mftf/Test/AdvanceCatalogSearchBundleByPriceTest.xml<br>")
 * @TestCaseId("MC-25435")
 * @group bundle
 * @group SearchEngineElasticsearch
 */
class AdvanceCatalogSearchBundleByPriceTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdvanceCatalogSearchBundleByPriceTest(AcceptanceTester $I)
	{
