...
/**
 * @Title("MC-14797: Quick Search should sort products with the different weight appropriately")
 * @Description("Use Quick Search to find a two products with the different weight<h3>Test files</h3>app/code/Magento/CatalogSearch/Test/Mftf/Test/SearchEntityResultsTest/QuickSearchTwoProductsWithDifferentWeightTest.xml<br>")
 * @TestCaseId("MC-14797")
 * @group CatalogSearch
 * @group SearchEngineElasticsearch
 * @group mtf_migrated
 */
class QuickSearchTwoProductsWithDifferentWeightTestCest
{
    /**
	...
	public function _before(AcceptanceTester $I)
	{
		...
		$I->selectOption("select[name='search_weight']", "5"); // stepKey: selectWeightCreateProduct1Attribute
	 ...
	 * @throws \Exception
	 */
	public function QuickSearchTwoProductsWithDifferentWeightTest(AcceptanceTester $I)
	{
