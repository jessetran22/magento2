...
/**
 * @Title("MC-25342: Guest customer should be able to advance search Bundle product with product name")
 * @Description("Guest customer should be able to advance search Bundle product with product name<h3>Test files</h3>app/code/Magento/Bundle/Test/Mftf/Test/AdvanceCatalogSearchBundleProductTest.xml<br>")
 * @TestCaseId("MC-25342")
 * @group bundle
 * @group SearchEngineElasticsearch
 */
class AdvanceCatalogSearchBundleByNameTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AdvanceCatalogSearchBundleByNameTest(AcceptanceTester $I)
	{
