...
/**
 * @Title("MC-15584: Verify Secure URLs For Storefront Newsletter Pages")
 * @Description("Verify that the Secure URL configuration applies to the Newsletter pages on the Storefront<h3>Test files</h3>app/code/Magento/Newsletter/Test/Mftf/Test/StorefrontVerifySecureURLRedirectNewsletterTest.xml<br>")
 * @TestCaseId("MC-15584")
 * @group newsletter
 * @group configuration
 * @group secure_storefront_url
 */
class StorefrontVerifySecureURLRedirectNewsletterTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function StorefrontVerifySecureURLRedirectNewsletterTest(AcceptanceTester $I)
	{
		$hostname = $I->executeJS("return window.location.host"); // stepKey: hostname
		$I->amOnUrl("http://{$hostname}/newsletter/manage"); // stepKey: goToUnsecureNewsletterManageURL
		$I->seeCurrentUrlEquals("https://{$hostname}/newsletter/manage"); // stepKey: seeSecureNewsletterManageURL
	}
}
