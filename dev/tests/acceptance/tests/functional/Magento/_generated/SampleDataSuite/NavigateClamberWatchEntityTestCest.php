...
/**
 * @Title("MC-11069: Should be able to see Clamber Watch Product")
 * @Description("Should be able to see Clamber Watch Product created by CatalogSampleData module<h3>Test files</h3>Users/jessetran/Documents/magento2-sample-data/app/code/Magento/CatalogSampleData/Test/Mftf/Test/NavigateClamberWatchEntityTest.xml<br>")
 * @TestCaseId("MC-11069")
 * @group sampleData
 */
class NavigateClamberWatchEntityTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function NavigateClamberWatchEntityTest(AcceptanceTester $I)
	{
		$I->comment("Entering Action Group [openProductPage] StorefrontOpenProductPageActionGroup");
		$I->amOnPage("/clamber-watch.html"); // stepKey: openProductPageOpenProductPage
		...
		$I->see("Clamber Watch", ".base"); // stepKey: seeProductNameAssertProductName
		...
		$I->see("24-WG03", ".product.attribute.sku>.value"); // stepKey: seeProductSkuAssertProductSku
		...
		$I->seeElement("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'wg03-gr-0.jpg') and not(contains(@class, 'full'))]"); // stepKey: seeProductImageAssertProductImage
		$I->click("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'wg03-gr-0.jpg') and not(contains(@class, 'full'))]"); // stepKey: openFullscreenImageAssertProductImage
		$I->waitForPageLoad(30); // stepKey: waitForGalleryLoadedAssertProductImage
		$I->seeElement("//*[@data-gallery-role='gallery' and contains(@class, 'fullscreen')]//img[contains(@src, 'wg03-gr-0.jpg') and contains(@class, 'full')]"); // stepKey: seeFullscreenProductImageAssertProductImage
