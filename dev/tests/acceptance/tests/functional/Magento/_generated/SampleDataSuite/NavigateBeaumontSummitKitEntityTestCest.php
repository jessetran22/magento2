...
/**
 * @Title("MC-11820: Should be able to see Beaumont Summit Kit Product")
 * @Description("Should be able to see Beaumont Summit Kit Product created by CatalogSampleData module<h3>Test files</h3>Users/jessetran/Documents/magento2-sample-data/app/code/Magento/ConfigurableSampleData/Test/Mftf/Test/NavigateBeaumontSummitKitEntityTest.xml<br>")
 * @TestCaseId("MC-11820")
 * @group sampleData
 */
class NavigateBeaumontSummitKitEntityTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function NavigateBeaumontSummitKitEntityTest(AcceptanceTester $I)
	{
		$I->comment("Entering Action Group [openProductPage] StorefrontOpenProductPageActionGroup");
		$I->amOnPage("/beaumont-summit-kit.html"); // stepKey: openProductPageOpenProductPage
		...
		$I->see("Beaumont Summit Kit", ".base"); // stepKey: seeProductNameAssertProductName
		...
		$I->see("MJ01", ".product.attribute.sku>.value"); // stepKey: seeProductSkuAssertProductSku
		...
		$I->seeElement("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'mj01-yellow_main_1.jpg') and not(contains(@class, 'full'))]"); // stepKey: seeProductImageAssertProductImage
		$I->click("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'mj01-yellow_main_1.jpg') and not(contains(@class, 'full'))]"); // stepKey: openFullscreenImageAssertProductImage
		$I->waitForPageLoad(30); // stepKey: waitForGalleryLoadedAssertProductImage
		$I->seeElement("//*[@data-gallery-role='gallery' and contains(@class, 'fullscreen')]//img[contains(@src, 'mj01-yellow_main_1.jpg') and contains(@class, 'full')]"); // stepKey: seeFullscreenProductImageAssertProductImage
