...
/**
 * @Title("MC-11831: Should be able to see Stark Fundamental Hoodie Product")
 * @Description("Should be able to see Stark Fundamental Hoodie Product created by CatalogSampleData module<h3>Test files</h3>Users/jessetran/Documents/magento2-sample-data/app/code/Magento/ConfigurableSampleData/Test/Mftf/Test/NavigateStarkFundamentalHoodieEntityTest.xml<br>")
 * @TestCaseId("MC-11831")
 * @group sampleData
 */
class NavigateStarkFundamentalHoodieEntityTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function NavigateStarkFundamentalHoodieEntityTest(AcceptanceTester $I)
	{
		$I->comment("Entering Action Group [openProductPage] StorefrontOpenProductPageActionGroup");
		$I->amOnPage("/stark-fundamental-hoodie.html"); // stepKey: openProductPageOpenProductPage
		...
		$I->see("Stark Fundamental Hoodie", ".base"); // stepKey: seeProductNameAssertProductName
		...
		$I->see("MH06", ".product.attribute.sku>.value"); // stepKey: seeProductSkuAssertProductSku
		...
		$I->see("$42.00", ".product-info-main [data-price-type='finalPrice']"); // stepKey: seeProductPriceAssertProductPrice
		...
		$I->seeElement("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'mh06-blue_main_1.jpg') and not(contains(@class, 'full'))]"); // stepKey: seeProductImageAssertProductImage
		$I->click("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'mh06-blue_main_1.jpg') and not(contains(@class, 'full'))]"); // stepKey: openFullscreenImageAssertProductImage
		$I->waitForPageLoad(30); // stepKey: waitForGalleryLoadedAssertProductImage
		$I->seeElement("//*[@data-gallery-role='gallery' and contains(@class, 'fullscreen')]//img[contains(@src, 'mh06-blue_main_1.jpg') and contains(@class, 'full')]"); // stepKey: seeFullscreenProductImageAssertProductImage
