...
/**
 * @Title("MC-11817: Should be able to see Abominable Hoodie Product")
 * @Description("Should be able to see Abominable Hoodie Product created by CatalogSampleData module<h3>Test files</h3>Users/jessetran/Documents/magento2-sample-data/app/code/Magento/ConfigurableSampleData/Test/Mftf/Test/NavigateAbominableHoodieEntityTest.xml<br>")
 * @TestCaseId("MC-11817")
 * @group sampleData
 */
class NavigateAbominableHoodieEntityTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function NavigateAbominableHoodieEntityTest(AcceptanceTester $I)
	{
		$I->comment("Entering Action Group [openProductPage] StorefrontOpenProductPageActionGroup");
		$I->amOnPage("/abominable-hoodie.html"); // stepKey: openProductPageOpenProductPage
		...
		$I->see("Abominable Hoodie", ".base"); // stepKey: seeProductNameAssertProductName
		...
		$I->see("MH09", ".product.attribute.sku>.value"); // stepKey: seeProductSkuAssertProductSku
		...
		$I->see("$69.00", ".product-info-main [data-price-type='finalPrice']"); // stepKey: seeProductPriceAssertProductPrice
		...
		$I->seeElement("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'mh09-blue_main_1.jpg') and not(contains(@class, 'full'))]"); // stepKey: seeProductImageAssertProductImage
		$I->click("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'mh09-blue_main_1.jpg') and not(contains(@class, 'full'))]"); // stepKey: openFullscreenImageAssertProductImage
		$I->waitForPageLoad(30); // stepKey: waitForGalleryLoadedAssertProductImage
		$I->seeElement("//*[@data-gallery-role='gallery' and contains(@class, 'fullscreen')]//img[contains(@src, 'mh09-blue_main_1.jpg') and contains(@class, 'full')]"); // stepKey: seeFullscreenProductImageAssertProductImage
