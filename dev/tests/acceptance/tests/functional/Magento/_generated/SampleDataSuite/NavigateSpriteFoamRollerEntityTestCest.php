...
/**
 * @Title("MC-11794: Should be able to see Sprite Foam Roller Product")
 * @Description("Should be able to see Sprite Foam Roller Product created by CatalogSampleData module<h3>Test files</h3>Users/jessetran/Documents/magento2-sample-data/app/code/Magento/CatalogSampleData/Test/Mftf/Test/NavigateSpriteFoamRollerEntityTest.xml<br>")
 * @TestCaseId("MC-11794")
 * @group sampleData
 */
class NavigateSpriteFoamRollerEntityTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function NavigateSpriteFoamRollerEntityTest(AcceptanceTester $I)
	{
		$I->comment("Entering Action Group [openProductPage] StorefrontOpenProductPageActionGroup");
		$I->amOnPage("/sprite-foam-roller.html"); // stepKey: openProductPageOpenProductPage
		...
		$I->see("Sprite Foam Roller", ".base"); // stepKey: seeProductNameAssertProductName
		...
		$I->see("24-WG088", ".product.attribute.sku>.value"); // stepKey: seeProductSkuAssertProductSku
		...
		$I->see("$19.00", ".product-info-main [data-price-type='finalPrice']"); // stepKey: seeProductPriceAssertProductPrice
		...
		$I->seeElement("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'luma-foam-roller.jpg') and not(contains(@class, 'full'))]"); // stepKey: seeProductImageAssertProductImage
		$I->click("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'luma-foam-roller.jpg') and not(contains(@class, 'full'))]"); // stepKey: openFullscreenImageAssertProductImage
		$I->waitForPageLoad(30); // stepKey: waitForGalleryLoadedAssertProductImage
		$I->seeElement("//*[@data-gallery-role='gallery' and contains(@class, 'fullscreen')]//img[contains(@src, 'luma-foam-roller.jpg') and contains(@class, 'full')]"); // stepKey: seeFullscreenProductImageAssertProductImage
