...
/**
 * @Title("MC-11830: Should be able to see Karmen Yoga Pant Product")
 * @Description("Should be able to see Karmen Yoga Pant Product created by CatalogSampleData module<h3>Test files</h3>Users/jessetran/Documents/magento2-sample-data/app/code/Magento/ConfigurableSampleData/Test/Mftf/Test/NavigateKarmenYogaPantEntityTest.xml<br>")
 * @TestCaseId("MC-11830")
 * @group sampleData
 */
class NavigateKarmenYogaPantEntityTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function NavigateKarmenYogaPantEntityTest(AcceptanceTester $I)
	{
		$I->comment("Entering Action Group [openProductPage] StorefrontOpenProductPageActionGroup");
		$I->amOnPage("/karmen-yoga-pant.html"); // stepKey: openProductPageOpenProductPage
		...
		$I->see("Karmen Yoga Pant", ".base"); // stepKey: seeProductNameAssertProductName
		...
		$I->see("WP01", ".product.attribute.sku>.value"); // stepKey: seeProductSkuAssertProductSku
		...
		$I->see("$31.20", ".product-info-main [data-price-type='finalPrice']"); // stepKey: seeProductPriceAssertProductPrice
		...
		$I->seeElement("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'wp01-gray_main_1.jpg') and not(contains(@class, 'full'))]"); // stepKey: seeProductImageAssertProductImage
		$I->click("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'wp01-gray_main_1.jpg') and not(contains(@class, 'full'))]"); // stepKey: openFullscreenImageAssertProductImage
		$I->waitForPageLoad(30); // stepKey: waitForGalleryLoadedAssertProductImage
		$I->seeElement("//*[@data-gallery-role='gallery' and contains(@class, 'fullscreen')]//img[contains(@src, 'wp01-gray_main_1.jpg') and contains(@class, 'full')]"); // stepKey: seeFullscreenProductImageAssertProductImage
