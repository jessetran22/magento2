...
/**
 * @Title("MC-11683: Should be able to see Joust Duffle Bag Product")
 * @Description("Should be able to see Joust Duffle Bag Product created by CatalogSampleData module<h3>Test files</h3>Users/jessetran/Documents/magento2-sample-data/app/code/Magento/CatalogSampleData/Test/Mftf/Test/NavigateJoustDuffleBagEntityTest.xml<br>")
 * @TestCaseId("MC-11683")
 * @group sampleData
 */
class NavigateJoustDuffleBagEntityTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function NavigateJoustDuffleBagEntityTest(AcceptanceTester $I)
	{
		$I->comment("Entering Action Group [openProductPage] StorefrontOpenProductPageActionGroup");
		$I->amOnPage("/joust-duffle-bag.html"); // stepKey: openProductPageOpenProductPage
		...
		$I->see("Joust Duffle Bag", ".base"); // stepKey: seeProductNameAssertProductName
		...
		$I->see("24-MB01", ".product.attribute.sku>.value"); // stepKey: seeProductSkuAssertProductSku
		...
		$I->see("$34.00", ".product-info-main [data-price-type='finalPrice']"); // stepKey: seeProductPriceAssertProductPrice
		...
		$I->seeElement("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'mb01-blue-0.jpg') and not(contains(@class, 'full'))]"); // stepKey: seeProductImageAssertProductImage
		$I->click("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'mb01-blue-0.jpg') and not(contains(@class, 'full'))]"); // stepKey: openFullscreenImageAssertProductImage
		$I->waitForPageLoad(30); // stepKey: waitForGalleryLoadedAssertProductImage
		$I->seeElement("//*[@data-gallery-role='gallery' and contains(@class, 'fullscreen')]//img[contains(@src, 'mb01-blue-0.jpg') and contains(@class, 'full')]"); // stepKey: seeFullscreenProductImageAssertProductImage
