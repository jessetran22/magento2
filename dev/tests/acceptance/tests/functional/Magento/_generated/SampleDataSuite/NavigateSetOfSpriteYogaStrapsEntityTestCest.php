...
/**
 * @Title("MC-11960: Should be able to see Set of Sprite Yoga Straps Product")
 * @Description("Should be able to see Set of Sprite Yoga Straps Product created by GroupedSampleData module<h3>Test files</h3>Users/jessetran/Documents/magento2-sample-data/app/code/Magento/GroupedProductSampleData/Test/Mftf/Test/NavigateSetOfSpriteYogaStrapsEntityTest.xml<br>")
 * @TestCaseId("MC-11960")
 * @group sampleData
 */
class NavigateSetOfSpriteYogaStrapsEntityTestCest
{
	/**
	 * @Features({"GroupedProductSampleData"})
	 * @Stories({"Sample data"})
	 ...
	 * @throws \Exception
	 */
	public function NavigateSetOfSpriteYogaStrapsEntityTest(AcceptanceTester $I)
	{
		$I->comment("Entering Action Group [openProductPage] StorefrontOpenProductPageActionGroup");
		$I->amOnPage("/set-of-sprite-yoga-straps.html"); // stepKey: openProductPageOpenProductPage
		...
		$I->see("Set of Sprite Yoga Straps", ".base"); // stepKey: seeProductNameAssertProductName
		...
		$I->see("24-WG085_Group", ".product.attribute.sku>.value"); // stepKey: seeProductSkuAssertProductSku
		...
		$I->seeElement("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'luma-yoga-strap-set.jpg') and not(contains(@class, 'full'))]"); // stepKey: seeProductImageAssertProductImage
		$I->click("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'luma-yoga-strap-set.jpg') and not(contains(@class, 'full'))]"); // stepKey: openFullscreenImageAssertProductImage
		$I->waitForPageLoad(30); // stepKey: waitForGalleryLoadedAssertProductImage
		$I->seeElement("//*[@data-gallery-role='gallery' and contains(@class, 'fullscreen')]//img[contains(@src, 'luma-yoga-strap-set.jpg') and contains(@class, 'full')]"); // stepKey: seeFullscreenProductImageAssertProductImage
