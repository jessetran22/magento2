...
/**
 * @Title("MC-11822: Should be able to see Caesar Warm Up Pant Product")
 * @Description("Should be able to see Caesar Warm Up Pant Product created by CatalogSampleData module<h3>Test files</h3>Users/jessetran/Documents/magento2-sample-data/app/code/Magento/ConfigurableSampleData/Test/Mftf/Test/NavigateCaesarWarmUpPantEntityTest.xml<br>")
 * @TestCaseId("MC-11822")
 * @group sampleData
 */
class NavigateCaesarWarmUpPantEntityTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function NavigateCaesarWarmUpPantEntityTest(AcceptanceTester $I)
	{
		$I->comment("Entering Action Group [openProductPage] StorefrontOpenProductPageActionGroup");
		$I->amOnPage("/caesar-warm-up-pant.html"); // stepKey: openProductPageOpenProductPage
		...
		$I->see("Caesar Warm-Up Pant", ".base"); // stepKey: seeProductNameAssertProductName
		...
		$I->see("MP01", ".product.attribute.sku>.value"); // stepKey: seeProductSkuAssertProductSku
		...
		$I->seeElement("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'mp01-gray_main_1.jpg') and not(contains(@class, 'full'))]"); // stepKey: seeProductImageAssertProductImage
		$I->click("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'mp01-gray_main_1.jpg') and not(contains(@class, 'full'))]"); // stepKey: openFullscreenImageAssertProductImage
		$I->waitForPageLoad(30); // stepKey: waitForGalleryLoadedAssertProductImage
		$I->seeElement("//*[@data-gallery-role='gallery' and contains(@class, 'fullscreen')]//img[contains(@src, 'mp01-gray_main_1.jpg') and contains(@class, 'full')]"); // stepKey: seeFullscreenProductImageAssertProductImage
