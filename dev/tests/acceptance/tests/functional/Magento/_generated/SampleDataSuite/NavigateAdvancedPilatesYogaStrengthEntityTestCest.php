...
/**
 * @Title("MC-11835: Should be able to see Advanced Pilates Yoga Strength Product")
 * @Description("Should be able to see Advanced Pilates Yoga Strength Product created by DownloadableSampleData module<h3>Test files</h3>Users/jessetran/Documents/magento2-sample-data/app/code/Magento/DownloadableSampleData/Test/Mftf/Test/NavigateAdvancedPilatesYogaStrengthEntityTest.xml<br>")
 * @TestCaseId("MC-11835")
 * @group sampleData
 */
class NavigateAdvancedPilatesYogaStrengthEntityTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function NavigateAdvancedPilatesYogaStrengthEntityTest(AcceptanceTester $I)
	{
		$I->comment("Entering Action Group [openProductPage] StorefrontOpenProductPageActionGroup");
		$I->amOnPage("/advanced-pilates-yoga-strength.html"); // stepKey: openProductPageOpenProductPage
		...
		$I->see("Advanced Pilates & Yoga (Strength)", ".base"); // stepKey: seeProductNameAssertProductName
		...
		$I->see("240-LV08", ".product.attribute.sku>.value"); // stepKey: seeProductSkuAssertProductSku
		...
		$I->see("$18.00", ".product-info-main [data-price-type='finalPrice']"); // stepKey: seeProductPriceAssertProductPrice
		...
		$I->seeElement("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'lt05.jpg') and not(contains(@class, 'full'))]"); // stepKey: seeProductImageAssertProductImage
		$I->click("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'lt05.jpg') and not(contains(@class, 'full'))]"); // stepKey: openFullscreenImageAssertProductImage
		$I->waitForPageLoad(30); // stepKey: waitForGalleryLoadedAssertProductImage
		$I->seeElement("//*[@data-gallery-role='gallery' and contains(@class, 'fullscreen')]//img[contains(@src, 'lt05.jpg') and contains(@class, 'full')]"); // stepKey: seeFullscreenProductImageAssertProductImage
