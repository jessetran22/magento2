...
/**
 * @Title("MC-11819: Should be able to see Atlas Fitness Tank Product")
 * @Description("Should be able to see Atlas Fitness Tank Product created by CatalogSampleData module<h3>Test files</h3>Users/jessetran/Documents/magento2-sample-data/app/code/Magento/ConfigurableSampleData/Test/Mftf/Test/NavigateAtlasFitnessTankEntityTest.xml<br>")
 * @TestCaseId("MC-11819")
 * @group sampleData
 */
class NavigateAtlasFitnessTankEntityTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function NavigateAtlasFitnessTankEntityTest(AcceptanceTester $I)
	{
		$I->comment("Entering Action Group [openProductPage] StorefrontOpenProductPageActionGroup");
		$I->amOnPage("/atlas-fitness-tank.html"); // stepKey: openProductPageOpenProductPage
		...
		$I->see("Atlas Fitness Tank", ".base"); // stepKey: seeProductNameAssertProductName
		...
		$I->see("MT11", ".product.attribute.sku>.value"); // stepKey: seeProductSkuAssertProductSku
		...
		$I->seeElement("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'mt11-blue_main_1.jpg') and not(contains(@class, 'full'))]"); // stepKey: seeProductImageAssertProductImage
		$I->click("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'mt11-blue_main_1.jpg') and not(contains(@class, 'full'))]"); // stepKey: openFullscreenImageAssertProductImage
		$I->waitForPageLoad(30); // stepKey: waitForGalleryLoadedAssertProductImage
		$I->seeElement("//*[@data-gallery-role='gallery' and contains(@class, 'fullscreen')]//img[contains(@src, 'mt11-blue_main_1.jpg') and contains(@class, 'full')]"); // stepKey: seeFullscreenProductImageAssertProductImage
