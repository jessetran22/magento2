...
/**
 * @Title("MC-11068: Should be able to see Sprite Yoga Companion Kit Product")
 * @Description("Should be able to see Sprite Yoga Companion Kit Product created by BundleSampleData module<h3>Test files</h3>Users/jessetran/Documents/magento2-sample-data/app/code/Magento/BundleSampleData/Test/Mftf/Test/NavigateSpriteYogaCompanionKitEntityTest.xml<br>")
 * @TestCaseId("MC-11068")
 * @group sampleData
 */
class NavigateSpriteYogaCompanionKitEntityTestCest
{
	/**
	 * @Features({"BundleSampleData"})
	 * @Stories({"Sample data"})
	 ...
	 * @throws \Exception
	 */
	public function NavigateSpriteYogaCompanionKitEntityTest(AcceptanceTester $I)
	{
		$I->comment("Entering Action Group [openProductPage] StorefrontOpenProductPageActionGroup");
		$I->amOnPage("/sprite-yoga-companion-kit.html"); // stepKey: openProductPageOpenProductPage
		...
		$I->see("Sprite Yoga Companion Kit", ".base"); // stepKey: seeProductNameAssertProductName
		...
		$I->see("24-WG080", ".product.attribute.sku>.value"); // stepKey: seeProductSkuAssertProductSku
		...
		$I->seeElement("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'luma-yoga-kit-2.jpg') and not(contains(@class, 'full'))]"); // stepKey: seeProductImageAssertProductImage
		$I->click("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'luma-yoga-kit-2.jpg') and not(contains(@class, 'full'))]"); // stepKey: openFullscreenImageAssertProductImage
		$I->waitForPageLoad(30); // stepKey: waitForGalleryLoadedAssertProductImage
		$I->seeElement("//*[@data-gallery-role='gallery' and contains(@class, 'fullscreen')]//img[contains(@src, 'luma-yoga-kit-2.jpg') and contains(@class, 'full')]"); // stepKey: seeFullscreenProductImageAssertProductImage
