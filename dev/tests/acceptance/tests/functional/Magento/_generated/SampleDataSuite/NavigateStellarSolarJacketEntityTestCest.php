...
/**
 * @Title("MC-11832: Should be able to see Stellar Solar Jacket Product")
 * @Description("Should be able to see Stellar Solar Jacket Product created by CatalogSampleData module<h3>Test files</h3>Users/jessetran/Documents/magento2-sample-data/app/code/Magento/ConfigurableSampleData/Test/Mftf/Test/NavigateStellarSolarJacketEntityTest.xml<br>")
 * @TestCaseId("MC-11832")
 * @group sampleData
 */
class NavigateStellarSolarJacketEntityTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function NavigateStellarSolarJacketEntityTest(AcceptanceTester $I)
	{
		$I->comment("Entering Action Group [openProductPage] StorefrontOpenProductPageActionGroup");
		$I->amOnPage("/stellar-solar-jacket.html"); // stepKey: openProductPageOpenProductPage
		...
		$I->see("Stellar Solar Jacket", ".base"); // stepKey: seeProductNameAssertProductName
		...
		$I->see("WJ01", ".product.attribute.sku>.value"); // stepKey: seeProductSkuAssertProductSku
		...
		$I->see("$75.00", ".product-info-main [data-price-type='finalPrice']"); // stepKey: seeProductPriceAssertProductPrice
		...
		$I->seeElement("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'wj01-red_main_1.jpg') and not(contains(@class, 'full'))]"); // stepKey: seeProductImageAssertProductImage
		$I->click("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'wj01-red_main_1.jpg') and not(contains(@class, 'full'))]"); // stepKey: openFullscreenImageAssertProductImage
		$I->waitForPageLoad(30); // stepKey: waitForGalleryLoadedAssertProductImage
		$I->seeElement("//*[@data-gallery-role='gallery' and contains(@class, 'fullscreen')]//img[contains(@src, 'wj01-red_main_1.jpg') and contains(@class, 'full')]"); // stepKey: seeFullscreenProductImageAssertProductImage
