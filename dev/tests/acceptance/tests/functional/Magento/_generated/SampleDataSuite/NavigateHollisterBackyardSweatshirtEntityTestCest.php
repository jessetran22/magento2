...
/**
 * @Title("MC-11829: Should be able to see Hollister Backyard Sweatshirt Product")
 * @Description("Should be able to see Hollister Backyard Sweatshirt Product created by CatalogSampleData module<h3>Test files</h3>Users/jessetran/Documents/magento2-sample-data/app/code/Magento/ConfigurableSampleData/Test/Mftf/Test/NavigateHollisterBackyardSweatshirtEntityTest.xml<br>")
 * @TestCaseId("MC-11829")
 * @group sampleData
 */
class NavigateHollisterBackyardSweatshirtEntityTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function NavigateHollisterBackyardSweatshirtEntityTest(AcceptanceTester $I)
	{
		$I->comment("Entering Action Group [openProductPage] StorefrontOpenProductPageActionGroup");
		$I->amOnPage("/hollister-backyard-sweatshirt.html"); // stepKey: openProductPageOpenProductPage
		...
		$I->see("Hollister Backyard Sweatshirt", ".base"); // stepKey: seeProductNameAssertProductName
		...
		$I->see("MH05", ".product.attribute.sku>.value"); // stepKey: seeProductSkuAssertProductSku
		...
		$I->seeElement("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'mh05-white_main_1.jpg') and not(contains(@class, 'full'))]"); // stepKey: seeProductImageAssertProductImage
		$I->click("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'mh05-white_main_1.jpg') and not(contains(@class, 'full'))]"); // stepKey: openFullscreenImageAssertProductImage
		$I->waitForPageLoad(30); // stepKey: waitForGalleryLoadedAssertProductImage
		$I->seeElement("//*[@data-gallery-role='gallery' and contains(@class, 'fullscreen')]//img[contains(@src, 'mh05-white_main_1.jpg') and contains(@class, 'full')]"); // stepKey: seeFullscreenProductImageAssertProductImage
