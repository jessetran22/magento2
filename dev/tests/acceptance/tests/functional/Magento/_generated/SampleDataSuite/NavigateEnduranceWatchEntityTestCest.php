...
/**
 * @Title("MC-11520: Should be able to see Endurance Watch Product")
 * @Description("Should be able to see Endurance Watch Product created by CatalogSampleData module<h3>Test files</h3>Users/jessetran/Documents/magento2-sample-data/app/code/Magento/CatalogSampleData/Test/Mftf/Test/NavigateEnduranceWatchEntityTest.xml<br>")
 * @TestCaseId("MC-11520")
 * @group sampleData
 */
class NavigateEnduranceWatchEntityTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function NavigateEnduranceWatchEntityTest(AcceptanceTester $I)
	{
		$I->comment("Entering Action Group [openProductPage] StorefrontOpenProductPageActionGroup");
		$I->amOnPage("/endurance-watch.html"); // stepKey: openProductPageOpenProductPage
		...
		$I->see("Endurance Watch", ".base"); // stepKey: seeProductNameAssertProductName
		...
		$I->see("24-MG01", ".product.attribute.sku>.value"); // stepKey: seeProductSkuAssertProductSku
		...
		$I->see("$49.00", ".product-info-main [data-price-type='finalPrice']"); // stepKey: seeProductPriceAssertProductPrice
		...
		$I->seeElement("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'mg01-bk-0.jpg') and not(contains(@class, 'full'))]"); // stepKey: seeProductImageAssertProductImage
		$I->click("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'mg01-bk-0.jpg') and not(contains(@class, 'full'))]"); // stepKey: openFullscreenImageAssertProductImage
		$I->waitForPageLoad(30); // stepKey: waitForGalleryLoadedAssertProductImage
		$I->seeElement("//*[@data-gallery-role='gallery' and contains(@class, 'fullscreen')]//img[contains(@src, 'mg01-bk-0.jpg') and contains(@class, 'full')]"); // stepKey: seeFullscreenProductImageAssertProductImage
