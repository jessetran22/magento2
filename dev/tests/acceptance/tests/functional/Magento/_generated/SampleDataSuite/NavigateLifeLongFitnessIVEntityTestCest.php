...
/**
 * @Title("MC-11956: Should be able to see Life Long Fitness IV Product")
 * @Description("Should be able to see Life Long Fitness IV Product created by DownloadableSampleData module<h3>Test files</h3>Users/jessetran/Documents/magento2-sample-data/app/code/Magento/DownloadableSampleData/Test/Mftf/Test/NavigateLifeLongFitnessIVEntityTest.xml<br>")
 * @TestCaseId("MC-11956")
 * @group sampleData
 */
class NavigateLifeLongFitnessIVEntityTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function NavigateLifeLongFitnessIVEntityTest(AcceptanceTester $I)
	{
		$I->comment("Entering Action Group [openProductPage] StorefrontOpenProductPageActionGroup");
		$I->amOnPage("/lifelong-fitness-iv.html"); // stepKey: openProductPageOpenProductPage
		...
		$I->see("LifeLong Fitness IV", ".base"); // stepKey: seeProductNameAssertProductName
		...
		$I->see("240-LV05", ".product.attribute.sku>.value"); // stepKey: seeProductSkuAssertProductSku
		...
		$I->see("$14.00", ".product-info-main [data-price-type='finalPrice']"); // stepKey: seeProductPriceAssertProductPrice
		...
		$I->seeElement("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'lt02.jpg') and not(contains(@class, 'full'))]"); // stepKey: seeProductImageAssertProductImage
		$I->click("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'lt02.jpg') and not(contains(@class, 'full'))]"); // stepKey: openFullscreenImageAssertProductImage
		$I->waitForPageLoad(30); // stepKey: waitForGalleryLoadedAssertProductImage
		$I->seeElement("//*[@data-gallery-role='gallery' and contains(@class, 'fullscreen')]//img[contains(@src, 'lt02.jpg') and contains(@class, 'full')]"); // stepKey: seeFullscreenProductImageAssertProductImage
