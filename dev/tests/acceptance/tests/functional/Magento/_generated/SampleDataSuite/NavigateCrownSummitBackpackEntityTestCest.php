...
/**
 * @Title("MC-11070: Should be able to see Crown Summit Backpack Product")
 * @Description("Should be able to see Crown Summit Backpack Product created by CatalogSampleData module<h3>Test files</h3>Users/jessetran/Documents/magento2-sample-data/app/code/Magento/CatalogSampleData/Test/Mftf/Test/NavigateCrownSummitBackpackEntityTest.xml<br>")
 * @TestCaseId("MC-11070")
 * @group sampleData
 */
class NavigateCrownSummitBackpackEntityTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function NavigateCrownSummitBackpackEntityTest(AcceptanceTester $I)
	{
		$I->comment("Entering Action Group [openProductPage] StorefrontOpenProductPageActionGroup");
		$I->amOnPage("/crown-summit-backpack.html"); // stepKey: openProductPageOpenProductPage
		...
		$I->see("Crown Summit Backpack", ".base"); // stepKey: seeProductNameAssertProductName
		...
		$I->see("24-MB03", ".product.attribute.sku>.value"); // stepKey: seeProductSkuAssertProductSku
		...
		$I->see("$38.00", ".product-info-main [data-price-type='finalPrice']"); // stepKey: seeProductPriceAssertProductPrice
		...
		$I->seeElement("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'mb03-black-0.jpg') and not(contains(@class, 'full'))]"); // stepKey: seeProductImageAssertProductImage
		$I->click("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'mb03-black-0.jpg') and not(contains(@class, 'full'))]"); // stepKey: openFullscreenImageAssertProductImage
		$I->waitForPageLoad(30); // stepKey: waitForGalleryLoadedAssertProductImage
		$I->seeElement("//*[@data-gallery-role='gallery' and contains(@class, 'fullscreen')]//img[contains(@src, 'mb03-black-0.jpg') and contains(@class, 'full')]"); // stepKey: seeFullscreenProductImageAssertProductImage
