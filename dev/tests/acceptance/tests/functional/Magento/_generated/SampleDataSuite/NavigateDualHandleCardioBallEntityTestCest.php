...
/**
 * @Title("MC-11182: Should be able to see Dual Handle Cardio Ball Product")
 * @Description("Should be able to see Dual Handle Cardio Ball Product created by CatalogSampleData module<h3>Test files</h3>Users/jessetran/Documents/magento2-sample-data/app/code/Magento/CatalogSampleData/Test/Mftf/Test/NavigateDualHandleCardioBallEntityTest.xml<br>")
 * @TestCaseId("MC-11182")
 * @group sampleData
 */
class NavigateDualHandleCardioBallEntityTestCest
{
	/**
	 * @Features({"CatalogSampleData"})
	 * @Stories({"Sample data"})
	 ...
	 * @throws \Exception
	 */
	public function NavigateDualHandleCardioBallEntityTest(AcceptanceTester $I)
	{
		$I->comment("Entering Action Group [openProductPage] StorefrontOpenProductPageActionGroup");
		$I->amOnPage("/dual-handle-cardio-ball.html"); // stepKey: openProductPageOpenProductPage
		...
		$I->see("Dual Handle Cardio Ball", ".base"); // stepKey: seeProductNameAssertProductName
		...
		$I->see("24-UG07", ".product.attribute.sku>.value"); // stepKey: seeProductSkuAssertProductSku
		...
		$I->see("$12.00", ".product-info-main [data-price-type='finalPrice']"); // stepKey: seeProductPriceAssertProductPrice
		...
		$I->seeElement("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'ug07-bk-0.jpg') and not(contains(@class, 'full'))]"); // stepKey: seeProductImageAssertProductImage
		$I->click("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'ug07-bk-0.jpg') and not(contains(@class, 'full'))]"); // stepKey: openFullscreenImageAssertProductImage
		$I->waitForPageLoad(30); // stepKey: waitForGalleryLoadedAssertProductImage
		$I->seeElement("//*[@data-gallery-role='gallery' and contains(@class, 'fullscreen')]//img[contains(@src, 'ug07-bk-0.jpg') and contains(@class, 'full')]"); // stepKey: seeFullscreenProductImageAssertProductImage
