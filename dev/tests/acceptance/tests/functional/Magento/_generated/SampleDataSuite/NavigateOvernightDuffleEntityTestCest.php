...
/**
 * @Title("MC-11744: Should be able to see Overnight Duffle Product")
 * @Description("Should be able to see Overnight Duffle Product created by CatalogSampleData module<h3>Test files</h3>Users/jessetran/Documents/magento2-sample-data/app/code/Magento/CatalogSampleData/Test/Mftf/Test/NavigateOvernightDuffleEntityTest.xml<br>")
 * @TestCaseId("MC-11744")
 * @group sampleData
 */
class NavigateOvernightDuffleEntityTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function NavigateOvernightDuffleEntityTest(AcceptanceTester $I)
	{
		$I->comment("Entering Action Group [openProductPage] StorefrontOpenProductPageActionGroup");
		$I->amOnPage("/overnight-duffle.html"); // stepKey: openProductPageOpenProductPage
		...
		$I->see("Overnight Duffle", ".base"); // stepKey: seeProductNameAssertProductName
		...
		$I->see("24-WB07", ".product.attribute.sku>.value"); // stepKey: seeProductSkuAssertProductSku
		...
		$I->see("$45.00", ".product-info-main [data-price-type='finalPrice']"); // stepKey: seeProductPriceAssertProductPrice
		...
		$I->seeElement("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'wb07-brown-0.jpg') and not(contains(@class, 'full'))]"); // stepKey: seeProductImageAssertProductImage
		$I->click("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'wb07-brown-0.jpg') and not(contains(@class, 'full'))]"); // stepKey: openFullscreenImageAssertProductImage
		$I->waitForPageLoad(30); // stepKey: waitForGalleryLoadedAssertProductImage
		$I->seeElement("//*[@data-gallery-role='gallery' and contains(@class, 'fullscreen')]//img[contains(@src, 'wb07-brown-0.jpg') and contains(@class, 'full')]"); // stepKey: seeFullscreenProductImageAssertProductImage
