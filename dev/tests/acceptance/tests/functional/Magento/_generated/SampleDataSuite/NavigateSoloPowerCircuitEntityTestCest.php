...
/**
 * @Title("MC-11958: Should be able to see Solo Power Circuit Product")
 * @Description("Should be able to see Solo Power Circuit Product created by DownloadableSampleData module<h3>Test files</h3>Users/jessetran/Documents/magento2-sample-data/app/code/Magento/DownloadableSampleData/Test/Mftf/Test/NavigateSoloPowerCircuitEntityTest.xml<br>")
 * @TestCaseId("MC-11958")
 * @group sampleData
 */
class NavigateSoloPowerCircuitEntityTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function NavigateSoloPowerCircuitEntityTest(AcceptanceTester $I)
	{
		$I->comment("Entering Action Group [openProductPage] StorefrontOpenProductPageActionGroup");
		$I->amOnPage("/solo-power-circuit.html"); // stepKey: openProductPageOpenProductPage
		...
		$I->see("Solo Power Circuit", ".base"); // stepKey: seeProductNameAssertProductName
		...
		$I->see("240-LV07", ".product.attribute.sku>.value"); // stepKey: seeProductSkuAssertProductSku
		...
		$I->seeElement("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'lt04.jpg') and not(contains(@class, 'full'))]"); // stepKey: seeProductImageAssertProductImage
		$I->click("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'lt04.jpg') and not(contains(@class, 'full'))]"); // stepKey: openFullscreenImageAssertProductImage
		$I->waitForPageLoad(30); // stepKey: waitForGalleryLoadedAssertProductImage
		$I->seeElement("//*[@data-gallery-role='gallery' and contains(@class, 'fullscreen')]//img[contains(@src, 'lt04.jpg') and contains(@class, 'full')]"); // stepKey: seeFullscreenProductImageAssertProductImage
