...
/**
 * @Title("MC-11826: Should be able to see Eos V-Neck Hoodie Product")
 * @Description("Should be able to see Eos V-Neck Hoodie Product created by CatalogSampleData module<h3>Test files</h3>Users/jessetran/Documents/magento2-sample-data/app/code/Magento/ConfigurableSampleData/Test/Mftf/Test/NavigateEosVNeckHoodieEntityTest.xml<br>")
 * @TestCaseId("MC-11826")
 * @group sampleData
 */
class NavigateEosVNeckHoodieEntityTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function NavigateEosVNeckHoodieEntityTest(AcceptanceTester $I)
	{
		$I->comment("Entering Action Group [openProductPage] StorefrontOpenProductPageActionGroup");
		$I->amOnPage("/eos-v-neck-hoodie.html"); // stepKey: openProductPageOpenProductPage
		...
		$I->see("Eos V-Neck Hoodie", ".base"); // stepKey: seeProductNameAssertProductName
		...
		$I->see("WH11", ".product.attribute.sku>.value"); // stepKey: seeProductSkuAssertProductSku
		...
		$I->see("$54.00", ".product-info-main [data-price-type='finalPrice']"); // stepKey: seeProductPriceAssertProductPrice
		...
		$I->seeElement("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'wh11-blue_main_1.jpg') and not(contains(@class, 'full'))]"); // stepKey: seeProductImageAssertProductImage
		$I->click("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'wh11-blue_main_1.jpg') and not(contains(@class, 'full'))]"); // stepKey: openFullscreenImageAssertProductImage
		$I->waitForPageLoad(30); // stepKey: waitForGalleryLoadedAssertProductImage
		$I->seeElement("//*[@data-gallery-role='gallery' and contains(@class, 'fullscreen')]//img[contains(@src, 'wh11-blue_main_1.jpg') and contains(@class, 'full')]"); // stepKey: seeFullscreenProductImageAssertProductImage
