...
/**
 * @Title("MC-11824: Should be able to see Chloe Compete Tank Product")
 * @Description("Should be able to see Chloe Compete Tank Product created by CatalogSampleData module<h3>Test files</h3>Users/jessetran/Documents/magento2-sample-data/app/code/Magento/ConfigurableSampleData/Test/Mftf/Test/NavigateChloeCompeteTankEntityTest.xml<br>")
 * @TestCaseId("MC-11824")
 * @group sampleData
 */
class NavigateChloeCompeteTankEntityTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function NavigateChloeCompeteTankEntityTest(AcceptanceTester $I)
	{
		$I->comment("Entering Action Group [openProductPage] StorefrontOpenProductPageActionGroup");
		$I->amOnPage("/chloe-compete-tank.html"); // stepKey: openProductPageOpenProductPage
		...
		$I->see("Chloe Compete Tank", ".base"); // stepKey: seeProductNameAssertProductName
		...
		$I->see("WT06", ".product.attribute.sku>.value"); // stepKey: seeProductSkuAssertProductSku
		...
		$I->seeElement("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'wt06-blue_main_1.jpg') and not(contains(@class, 'full'))]"); // stepKey: seeProductImageAssertProductImage
		$I->click("//*[@data-gallery-role='gallery' and not(contains(@class, 'fullscreen'))]//img[contains(@src, 'wt06-blue_main_1.jpg') and not(contains(@class, 'full'))]"); // stepKey: openFullscreenImageAssertProductImage
		$I->waitForPageLoad(30); // stepKey: waitForGalleryLoadedAssertProductImage
		$I->seeElement("//*[@data-gallery-role='gallery' and contains(@class, 'fullscreen')]//img[contains(@src, 'wt06-blue_main_1.jpg') and contains(@class, 'full')]"); // stepKey: seeFullscreenProductImageAssertProductImage
