...
/**
 * @Title("MC-39491: AWS S3 Captcha customer login page test")
 * @Description("Check CAPTCHA on Storefront Login Page.<h3>Test files</h3>app/code/Magento/AwsS3/Test/Mftf/Test/AwsS3StorefrontCaptchaOnCustomerLoginTest.xml<br>")
 * @TestCaseId("MC-39491")
 * @group remote_storage_aws_s3
 */
class AwsS3StorefrontCaptchaOnCustomerLoginTestCest
{
	/**
	 ...
	 * @throws \Exception
	 */
	public function AwsS3StorefrontCaptchaOnCustomerLoginTest(AcceptanceTester $I)
	{
