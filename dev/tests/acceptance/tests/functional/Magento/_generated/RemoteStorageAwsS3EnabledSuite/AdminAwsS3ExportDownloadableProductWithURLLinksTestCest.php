...
class AdminAwsS3ExportDownloadableProductWithURLLinksTestCest
{
	 ...
	 * @throws \Exception
	 */
	public function AdminAwsS3ExportDownloadableProductWithURLLinksTest(AcceptanceTester $I)
	{
		...
		$this->helperContainer->get('Magento\AwsS3\Test\Mftf\Helper\S3FileAssertions')->assertFileContainsString("import_export/export/{$grabNameFile}", "title=" . $I->retrieveEntityField('addDownloadableLink', 'link[title]', 'test') . ",sort_order=" . $I->retrieveEntityField('addDownloadableLink', 'link[sort_order]', 'test') . ",sample_type=" . $I->retrieveEntityField('addDownloadableLink', 'link[sample_type]', 'test') . ",sample_url=" . $I->retrieveEntityField('addDownloadableLink', 'link[sample_url]', 'test') . ",price=" . $I->retrieveEntityField('addDownloadableLink', 'link[price]', 'test') . "0000,number_of_downloads=" . $I->retrieveEntityField('addDownloadableLink', 'link[number_of_downloads]', 'test') . ",link_type=" . $I->retrieveEntityField('addDownloadableLink', 'link[link_type]', 'test') . ",link_url=" . $I->retrieveEntityField('addDownloadableLink', 'link[link_url]', 'test'), ''); // stepKey: assertExportFileContainsDownloadableLink
