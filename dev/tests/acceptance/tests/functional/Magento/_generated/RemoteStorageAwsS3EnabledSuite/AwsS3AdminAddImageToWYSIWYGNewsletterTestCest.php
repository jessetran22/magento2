 ...
 * @Title("MC-38716: AWS S3 Admin should be able to add image to WYSIWYG content of Newsletter")
 * @Description("Admin should be able to add image to WYSIWYG content Newsletter<h3>Test files</h3>app/code/Magento/AwsS3/Test/Mftf/Test/AwsS3AdminAddImageToWYSIWYGNewsletterTest.xml<br>")
 * @TestCaseId("MC-38716")
 */
class AwsS3AdminAddImageToWYSIWYGNewsletterTestCest
{
    /**
	...
	/**
	 * @Features({"AwsS3"})
	 * @Stories({"Apply new WYSIWYG in Newsletter"})
	 ...
	 * @throws \Exception
	 */
	public function AwsS3AdminAddImageToWYSIWYGNewsletterTest(AcceptanceTester $I)
	{
