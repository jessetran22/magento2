...
/**
 * @Title("MC-38302: AWS S3 Admin should be able to add image to WYSIWYG content of Block with remote filesystem enabled")
 * @Description("Admin should be able to add image to WYSIWYG content of Block<h3>Test files</h3>app/code/Magento/AwsS3/Test/Mftf/Test/AwsS3AdminAddImageToWYSIWYGBlockTest.xml<br>")
 * @TestCaseId("MC-38302")
 * @group remote_storage_aws_s3
 */
class AwsS3AdminAddImageToWYSIWYGBlockTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AwsS3AdminAddImageToWYSIWYGBlockTest(AcceptanceTester $I)
	{
		...
		$I->waitForElementVisible(".tox-tinymce", 30); // stepKey: waitForTinyMCEAssignBlockToCMSPage
		$I->seeElement("button[aria-label='Insert Widget']"); // stepKey: seeWidgetIconAssignBlockToCMSPage
		$I->waitForPageLoad(30); // stepKey: seeWidgetIconAssignBlockToCMSPageWaitForPageLoad
		$I->click("button[aria-label='Insert Widget']"); // stepKey: clickInsertWidgetIconAssignBlockToCMSPage
		$I->waitForPageLoad(30); // stepKey: clickInsertWidgetIconAssignBlockToCMSPageWaitForPageLoad
