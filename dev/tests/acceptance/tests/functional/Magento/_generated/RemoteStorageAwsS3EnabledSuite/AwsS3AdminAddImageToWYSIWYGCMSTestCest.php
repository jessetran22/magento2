...
/**
 * @Title("MC-38295: AWS S3 Admin should be able to add image to WYSIWYG content of CMS Page with remote filesystem enabled")
 * @Description("Admin should be able to add image to WYSIWYG content of CMS Page<h3>Test files</h3>app/code/Magento/AwsS3/Test/Mftf/Test/AwsS3AdminAddImageToWYSIWYGCMSTest.xml<br>")
 * @TestCaseId("MC-38295")
 * @group remote_storage_aws_s3
 */
class AwsS3AdminAddImageToWYSIWYGCMSTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AwsS3AdminAddImageToWYSIWYGCMSTest(AcceptanceTester $I)
	{
