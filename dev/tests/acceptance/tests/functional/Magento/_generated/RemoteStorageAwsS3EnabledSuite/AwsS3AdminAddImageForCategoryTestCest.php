...
/**
 * @Title("MC-38688: AWS S3 Admin should be able to add image to a Category")
 * @Description("Admin should be able to add image to a Category<h3>Test files</h3>app/code/Magento/AwsS3/Test/Mftf/Test/AwsS3AdminAddImageForCategoryTest.xml<br>")
 * @TestCaseId("MC-38688")
 * @group remote_storage_aws_s3
 */
class AwsS3AdminAddImageForCategoryTestCest
{
    /**
	 ...
	 * @throws \Exception
	 */
	public function AwsS3AdminAddImageForCategoryTest(AcceptanceTester $I)
	{
