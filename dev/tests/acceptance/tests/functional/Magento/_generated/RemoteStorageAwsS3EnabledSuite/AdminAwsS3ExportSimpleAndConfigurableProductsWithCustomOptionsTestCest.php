...
class AdminAwsS3ExportSimpleAndConfigurableProductsWithCustomOptionsTestCest
{
	 ...
	 * @throws \Exception
	 */
	public function AdminAwsS3ExportSimpleAndConfigurableProductsWithCustomOptionsTest(AcceptanceTester $I)
	{
		...
		$I->comment("Validate Export File on S3: Product with Custom Options");
		$I->comment("Delete Export File");
	}
}
